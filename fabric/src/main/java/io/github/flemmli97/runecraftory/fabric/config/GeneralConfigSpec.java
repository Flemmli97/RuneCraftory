...
public class GeneralConfigSpec {
    ...
    private GeneralConfigSpec(CommentedJsonConfig.Builder builder) {
        ...
        this.defenceSystem = builder.comment("How the defence stat in from this mod should be handled",
                ...
                .define("Defence System", GeneralConfig.DEFENCE_SYSTEM);
        ...
        this.recipeSystem = builder.comment("The recipe system to use.",
                ...
                .define("Recipe System", GeneralConfig.RECIPE_SYSTEM);
        ...
        this.maxLevel = builder.defineInRange("Max Level", GeneralConfig.MAX_LEVEL, 1, 1000);
        ...
        this.allowMoveOnAttack = builder.comment("Whether to allow moving during a normal melee attack. Synced to clients. Will look janky as the animation will not match player movements!").define("Allow Move On Attack", GeneralConfig.ALLOW_MOVE_ON_ATTACK.get());
        builder.pop();
        builder.pop();
