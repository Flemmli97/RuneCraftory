...
public class BiomeTagGen extends TagsProvider<Biome> {
    ...
    public BiomeTagGen(PackOutput packOutput, ExistingFileHelper fileHelper) {
    ...
    protected void addTags() {
        ...
        this.addedTags.forEach(tag -> this.tag(tag).addOptionalTag(ResourceLocation.fromNamespaceAndPath("byg", tag.location().getPath())));
        this.addedTags.forEach(tag -> this.tag(tag).addOptionalTag(ResourceLocation.fromNamespaceAndPath("forge", tag.location().getPath())));
    }
