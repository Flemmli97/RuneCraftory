...
//                Ingredient.of(Items.BOOK), Ingredient.of(Items.SHORT_GRASS), Ingredient.of(Items.STONE)));
        ...
        ShapelessRecipeBuilder.shapeless(RecipeCategory.MISC, Items.MUSHROOM_STEW, 2)
        ...
        ShapedRecipeBuilder.shaped(RecipeCategory.MISC, ModItems.SHIPPING_BIN.get())
                ...
                .save(output);
        ShapedRecipeBuilder.shaped(RecipeCategory.MISC, ModItems.ITEM_BLOCK_FORGE.get())
                .pattern("ccc")
                .pattern("ibi")
                .pattern("clc")
                ...
                .save(output);
        ShapedRecipeBuilder.shaped(RecipeCategory.MISC, ModItems.ITEM_BLOCK_ACCESS.get())
                .pattern(" s ")
                .pattern("aaa")
                .pattern("lcl")
                ...
                .save(output);
        ShapedRecipeBuilder.shaped(RecipeCategory.MISC, ModItems.ITEM_BLOCK_CHEM.get())
                .pattern("b s")
                .pattern("qqq")
                .pattern("ccc")
                ...
                .save(output);
        ShapedRecipeBuilder.shaped(RecipeCategory.MISC, ModItems.ITEM_BLOCK_COOKING.get())
                .pattern("   ")
                .pattern("qwq")
                .pattern("lsl")
                .define('q', Items.QUARTZ_BLOCK)
