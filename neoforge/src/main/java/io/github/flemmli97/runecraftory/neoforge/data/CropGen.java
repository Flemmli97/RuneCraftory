...
public class CropGen extends CropProvider {
    ...
    protected void add(HolderLookup.Provider provider) {
        this.addStat(Items.WHEAT_SEEDS, new CropProperties.Builder(5, 3, true).addGoodSeason(EnumSeason.AUTUMN));
        this.addStat(Items.CARROT, new CropProperties.Builder(4, 4, false).addGoodSeason(EnumSeason.AUTUMN)
        ...
        this.addStat(ModItems.MOONDROP_SEEDS.get(), new CropProperties.Builder(7, 4, false)
                .addGoodSeason(EnumSeason.SPRING).addGoodSeason(EnumSeason.AUTUMN).addBadSeason(EnumSeason.WINTER)
        ...
        this.addStat(ModItems.CHARM_BLUE_SEEDS.get(), new CropProperties.Builder(8, 3, false)
                .addGoodSeason(EnumSeason.AUTUMN).addBadSeason(EnumSeason.WINTER)
        ...
        this.addStat(ModItems.BLUE_CRYSTAL_SEEDS.get(), new CropProperties.Builder(55, 3, false)
                .addGoodSeason(EnumSeason.SPRING).addBadSeason(EnumSeason.SUMMER).addBadSeason(EnumSeason.AUTUMN).addBadSeason(EnumSeason.WINTER)
        ...
        this.addStat(ModItems.FOUR_LEAF_CLOVER_SEEDS.get(), new CropProperties.Builder(28, 3, false)
                .addGoodSeason(EnumSeason.SPRING).addGoodSeason(EnumSeason.AUTUMN).addBadSeason(EnumSeason.SUMMER)
        ...
        this.addStat(ModItems.GREEN_CRYSTAL_SEEDS.get(), new CropProperties.Builder(70, 3, false)
                .addGoodSeason(EnumSeason.SUMMER).addBadSeason(EnumSeason.SPRING).addBadSeason(EnumSeason.AUTUMN).addBadSeason(EnumSeason.WINTER)
        ...
        this.addStat(ModItems.RED_CRYSTAL_SEEDS.get(), new CropProperties.Builder(80, 3, false)
                .addGoodSeason(EnumSeason.AUTUMN).addBadSeason(EnumSeason.SPRING).addBadSeason(EnumSeason.SUMMER).addBadSeason(EnumSeason.WINTER)
        ...
        this.addStat(ModItems.WHITE_CRYSTAL_SEEDS.get(), new CropProperties.Builder(90, 3, false)
                .addGoodSeason(EnumSeason.WINTER).addBadSeason(EnumSeason.SPRING).addBadSeason(EnumSeason.SUMMER).addBadSeason(EnumSeason.AUTUMN)
        ...
        this.addStat(ModItems.TURNIP_SEEDS.get(), new CropProperties.Builder(4, 3, false)
                .addGoodSeason(EnumSeason.SUMMER).addGoodSeason(EnumSeason.AUTUMN)
        ...
        this.addStat(ModItems.BOK_CHOY_SEEDS.get(), new CropProperties.Builder(5, 4, false)
                .addGoodSeason(EnumSeason.AUTUMN).addBadSeason(EnumSeason.SUMMER)
        ...
        this.addStat(ModItems.SPINACH_SEEDS.get(), new CropProperties.Builder(2, 2, false)
                .addGoodSeason(EnumSeason.AUTUMN)
                .withGiantVersion(ModBlocks.SPINACH_GIANT.get()));
        this.addStat(ModItems.YAM_SEEDS.get(), new CropProperties.Builder(9, 5, false)
                .addGoodSeason(EnumSeason.SUMMER).addGoodSeason(EnumSeason.AUTUMN).addBadSeason(EnumSeason.WINTER)
