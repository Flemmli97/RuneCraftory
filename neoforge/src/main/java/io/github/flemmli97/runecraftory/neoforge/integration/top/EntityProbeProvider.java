...
//    @Override
//    public String getID() {
//        returnString.format("%s/%s", ID.getNamespace(), ID.getPath());
//    }
//
//    @Override
...
//                            .prefix(Component.translatable("runecraftory.tooltip.item.level", mob.xpLevel().getLevel()))
...
//                if (username == null) {
//                    probeInfo.text(CompoundText.create().warning(Component.translatable("runecraftory.dependency.tooltips.owner.none")));
//                } else {
//                    probeInfo.text(CompoundText.create().style(TextStyleClass.HIGHLIGHTED).text(Component.translatable("runecraftory.dependency.tooltips.owner", username)));
//                }
//                if (player.getUUID().equals(monster.getOwnerUUID())) {
//                    withText(probeInfo, "runecraftory.dependency.tooltips.friendpoints", Component.literal("" + monster.getFriendlyPoints().getLevel()), ChatFormatting.YELLOW);
//                    BarnData barn = monster.getAssignedBarn();
//                    if (barn != null) {
//                        withText(probeInfo, "runecraftory.dependency.tooltips.barn", Component.literal(String.format("[%s, %s, %s]", barn.pos.pos().getX(), barn.pos.pos().getY(), barn.pos.pos().getZ())), ChatFormatting.GREEN);
//                    } else {
//                        probeInfo.text(CompoundText.create().style(TextStyleClass.ERROR).text(Component.translatable("runecraftory.dependency.tooltips.barn.no")));
//                    }
//                    withText(probeInfo, "runecraftory.dependency.tooltips.behaviour", Component.literal("" + monster.behaviourState()), ChatFormatting.YELLOW);
//                }
//            }
//        }
...
//            }
//            withText(probeInfo, "runecraftory.dependency.tooltips.friendpoints", Component.literal("" + npc.friendPoints(player)), ChatFormatting.YELLOW);
//        }
//    }
//
//    private static void withText(IProbeInfo info, String main, Component other, ChatFormatting formatting) {
//        info.text(CompoundText.create().info(Component.translatable(main, Component.literal("§" + formatting.getChar()).append(other))));
//    }
//}
