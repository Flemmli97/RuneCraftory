...
public class ModAttachments {
    ...
    public static final DeferredHolder<AttachmentType<?>, AttachmentType<EntityDataAttachment>> ENTITY_DATA = ATTACHMENT_TYPES.register("entity_data", () -> AttachmentType.builder(EntityDataAttachment::new).build());
