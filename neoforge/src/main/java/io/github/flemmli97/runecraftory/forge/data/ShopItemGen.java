...
public class ShopItemGen extends ShopItemProvider {
    ...
    public ShopItemGen(PackOutput packOutput) {
        super(gen);
    }
    ...
    protected void add() {
        ...
        this.addItem(ModNPCJobs.FLOWER.getSecond(), ModItems.LAMP_GRASS_SEEDS.get());
        this.addItem(ModNPCJobs.FLOWER.getSecond(), ModItems.CHERRY_GRASS_SEEDS.get());
        this.addItem(ModNPCJobs.FLOWER.getSecond(), ModItems.POM_POM_GRASS_SEEDS.get());
        this.addItem(ModNPCJobs.FLOWER.getSecond(), ModItems.AUTUMN_GRASS_SEEDS.get());
        this.addItem(ModNPCJobs.FLOWER.getSecond(), ModItems.NOEL_GRASS_SEEDS.get());
        this.addItem(ModNPCJobs.FLOWER.getSecond(), ModItems.FIREFLOWER_SEEDS.get());
        this.addItem(ModNPCJobs.FLOWER.getSecond(), ModItems.FOUR_LEAF_CLOVER_SEEDS.get());
        this.addItem(ModNPCJobs.FLOWER.getSecond(), ModItems.IRONLEAF_SEEDS.get());
        this.addItem(ModNPCJobs.FLOWER.getSecond(), ModItems.WHITE_CRYSTAL_SEEDS.get());
        this.addItem(ModNPCJobs.FLOWER.getSecond(), ModItems.RED_CRYSTAL_SEEDS.get());
        this.addItem(ModNPCJobs.FLOWER.getSecond(), ModItems.GREEN_CRYSTAL_SEEDS.get());
        this.addItem(ModNPCJobs.FLOWER.getSecond(), ModItems.BLUE_CRYSTAL_SEEDS.get());
        this.addItem(ModNPCJobs.FLOWER.getSecond(), ModItems.EMERY_FLOWER_SEEDS.get());
