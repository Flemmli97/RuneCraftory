...
//                .setSortnum(category++)
//
//                .addEntry("entry.runepoints", "runecraftory.patchouli.entry.runepoints", new ItemStack(ModItems.MYSTERY_POTION.get()))
//                .setSortnum(sort++)
//                .addSimpleTextPage("runecraftory.patchouli.entry.runepoints.1")
//                .build()
//
//                .addEntry("entry.calendar", "runecraftory.patchouli.entry.calendar", new ItemStack(ModItems.RED_GRASS.get()))
//                .setSortnum(sort++)
//                .addSimpleTextPage("runecraftory.patchouli.entry.calendar.1")
//                .build()
//
...
//                .addCraftingPage(RuneCraftory.modRes("shipping_bin"))
//                .build()
//                .build()
//
...
//                .build()
//
//                .addEntry("entry.gate", "runecraftory.patchouli.entry.gate", new ItemStack(ModItems.CRYSTAL_LOVE.get()))
//                .setSortnum(sort++)
//                .addSimpleTextPage("runecraftory.patchouli.entry.gate.1")
//                .build()
//
...
//                .addSimpleTextPage("runecraftory.patchouli.entry.farming.4")
//                .build()
//
//                .addEntry("entry.trees", "runecraftory.patchouli.entry.trees", new ItemStack(ModItems.APPLE_SAPLING.get()))
//                .setSortnum(sort++)
//                .addSimpleTextPage("runecraftory.patchouli.entry.trees.1")
//                .build()
//
...
//                .addCraftingPage(RuneCraftory.modRes("fireball"))
//                .setRecipe2(RuneCraftory.modRes("teleport"))
//                .build()
...
//                .addSimpleTextPage("runecraftory.patchouli.entry.npc.3")
//                .setSortnum(sort++)
//                .build()
//
//                .addEntry("entry.npc.jobs", "runecraftory.patchouli.entry.npc.jobs", new ItemStack(ModItems.CASH_REGISTER.get()))
//                .setSortnum(sort++)
...
//                .build()
//
//                .addEntry("entry.npc.quests", "runecraftory.patchouli.entry.quests", new ItemStack(ModItems.QUEST_BOARD.get()))
//                .setSortnum(sort++)
//                .addSimpleTextPage("runecraftory.patchouli.entry.quests.1")
//                .addCraftingPage(RuneCraftory.modRes("quest_board"))
//                .build()
//                .build();
//
