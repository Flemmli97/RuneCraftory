...
public class AdvancementGen implements DataProvider {
    ...
    public void advancements(Consumer<Advancement> cons) {
        Advancement root = Advancement.Builder.advancement().display(ModItems.MEDICINAL_HERB.get(), Component.translatable("runecraftory.advancements.root.title"), Component.translatable("runecraftory.advancements.root.description"), new ResourceLocation("textures/block/dirt.png"), FrameType.TASK, false, false, false).addCriterion("crafting_table", InventoryChangeTrigger.TriggerInstance.hasItems(Blocks.CRAFTING_TABLE)).save(cons, LibAdvancements.ROOT.toString());
        Advancement tameFirst = Advancement.Builder.advancement().parent(root).display(SpawnEgg.fromType(ModEntities.WOOLY.get()).get(), Component.translatable("runecraftory.advancements.tame.first.title"), Component.translatable("runecraftory.advancements.tame.first.description"), null, FrameType.TASK, true, true, false).addCriterion("tame_monster", TameMonsterTrigger.TriggerInstance.of(1)).save(cons, LibAdvancements.TAME_FIRST.toString());
        Advancement tameTen = TameMonsterTrigger.TriggerInstance.amountOfSteps(Advancement.Builder.advancement().parent(tameFirst).display(ModItems.MONSTER_BARN.get(), Component.translatable("runecraftory.advancements.tame.ten.title"), Component.translatable("runecraftory.advancements.tame.ten.description"), null, FrameType.GOAL, true, true, false), "tame_monster", 10, false).save(cons, LibAdvancements.TAME_TEN.toString());
        Advancement tameBoss = Advancement.Builder.advancement().parent(tameFirst).display(ModItems.AMBROSIAS_THORNS.get(), Component.translatable("runecraftory.advancements.tame.boss.title"), Component.translatable("runecraftory.advancements.tame.boss.description"), null, FrameType.TASK, true, true, false).addCriterion("tame_boss_monster", TameMonsterTrigger.TriggerInstance.bossOf(1)).save(cons, LibAdvancements.TAME_BOSS_FIRST.toString());
        Advancement tameBossFive = TameMonsterTrigger.TriggerInstance.amountOfSteps(Advancement.Builder.advancement().parent(tameBoss).display(glowing(SpawnEgg.fromType(ModEntities.AMBROSIA.get()).get()), Component.translatable("runecraftory.advancements.tame.boss.five.title"), Component.translatable("runecraftory.advancements.tame.boss.five.description"), null, FrameType.GOAL, true, true, false), "tame_bosses", 5, true).save(cons, LibAdvancements.TAME_BOSS_FIVE.toString());
        Advancement tameBossAll = allBosses(Advancement.Builder.advancement().parent(tameBossFive).display(ModItems.SCALE_LEGEND.get(), Component.translatable("runecraftory.advancements.tame.boss.all.title"), Component.translatable("runecraftory.advancements.tame.boss.all.description"), null, FrameType.CHALLENGE, true, true, false)).save(cons, LibAdvancements.TAME_BOSS_ALL.toString());

        Advancement shipping = Advancement.Builder.advancement().parent(root).display(ModItems.SHIPPING_BIN.get(), Component.translatable("runecraftory.advancements.shipping.title"), Component.translatable("runecraftory.advancements.shipping.description"), null, FrameType.TASK, true, true, false).addCriterion("ship_item", ShippingTrigger.TriggerInstance.shipAny(1)).save(cons, LibAdvancements.SHIP_FIRST.toString());
        Advancement shippingFifty = Advancement.Builder.advancement().parent(shipping).display(ModItems.SHIPPING_BIN.get(), Component.translatable("runecraftory.advancements.shipping.fifty.title"), Component.translatable("runecraftory.advancements.shipping.fifty.description"), null, FrameType.GOAL, true, true, false).addCriterion("ship_item", ShippingTrigger.TriggerInstance.shipAny(50)).save(cons, LibAdvancements.SHIP_FIFTY.toString());
        Advancement shop = Advancement.Builder.advancement().parent(shipping).display(Items.GOLD_INGOT, Component.translatable("runecraftory.advancements.shop.title"), Component.translatable("runecraftory.advancements.shop.description"), null, FrameType.TASK, true, true, false).addCriterion("buy_item", ShopTrigger.TriggerInstance.buyAny()).save(cons, LibAdvancements.SHOP.toString());
        Advancement hundred_k = Advancement.Builder.advancement().parent(shop).display(Items.GOLD_BLOCK, Component.translatable("runecraftory.advancements.100k.title"), Component.translatable("runecraftory.advancements.100k.description"), null, FrameType.GOAL, true, true, false).addCriterion("have_money", MoneyTrigger.TriggerInstance.of(100000)).save(cons, LibAdvancements.MONEY_100K.toString());
        ...
        Advancement skill = Advancement.Builder.advancement().parent(root).display(SpawnEgg.fromType(ModEntities.WOOLY.get()).get(), Component.translatable("runecraftory.advancements.skill.weapon.5.title"), Component.translatable("runecraftory.advancements.skill.weapon.5.description"), null, FrameType.TASK, true, true, false).requirements(RequirementsStrategy.OR)
        ...
        Advancement skill10 = Advancement.Builder.advancement().parent(root).display(Items.EXPERIENCE_BOTTLE, Component.translatable("runecraftory.advancements.skill.10.title"), Component.translatable("runecraftory.advancements.skill.10.description"), null, FrameType.TASK, true, true, false).addCriterion("skill", SkillLevelTrigger.TriggerInstance.of(10)).save(cons, LibAdvancements.SKILL_10.toString());
        Advancement skill25 = Advancement.Builder.advancement().parent(skill10).display(Items.EXPERIENCE_BOTTLE, Component.translatable("runecraftory.advancements.skill.25.title"), Component.translatable("runecraftory.advancements.skill.25.description"), null, FrameType.TASK, true, true, false).addCriterion("skill", SkillLevelTrigger.TriggerInstance.of(25)).save(cons, LibAdvancements.SKILL_25.toString());
        ...
        Advancement skill100 = Advancement.Builder.advancement().parent(skill50).display(Items.EXPERIENCE_BOTTLE, Component.translatable("runecraftory.advancements.skill.100.title"), Component.translatable("runecraftory.advancements.skill.100.description"), null, FrameType.CHALLENGE, true, true, false).addCriterion("skill", SkillLevelTrigger.TriggerInstance.of(100)).save(cons, LibAdvancements.SKILL_100.toString());

        Advancement level10 = Advancement.Builder.advancement().parent(root).display(ModItems.LEVELISER.get(), Component.translatable("runecraftory.advancements.level.10.title"), Component.translatable("runecraftory.advancements.level.10.description"), null, FrameType.TASK, true, true, false).addCriterion("level", LevelTrigger.TriggerInstance.of(10)).save(cons, LibAdvancements.LEVEL_10.toString());
        Advancement level25 = Advancement.Builder.advancement().parent(level10).display(ModItems.LEVELISER.get(), Component.translatable("runecraftory.advancements.level.25.title"), Component.translatable("runecraftory.advancements.level.25.description"), null, FrameType.TASK, true, true, false).addCriterion("level", LevelTrigger.TriggerInstance.of(25)).save(cons, LibAdvancements.LEVEL_25.toString());
        Advancement level50 = Advancement.Builder.advancement().parent(level25).display(glowing(ModItems.LEVELISER.get()), Component.translatable("runecraftory.advancements.level.50.title"), Component.translatable("runecraftory.advancements.level.50.description"), null, FrameType.TASK, true, true, false).addCriterion("level", LevelTrigger.TriggerInstance.of(50)).save(cons, LibAdvancements.LEVEL_50.toString());
        Advancement level100 = Advancement.Builder.advancement().parent(level50).display(glowing(ModItems.LEVELISER.get()), Component.translatable("runecraftory.advancements.level.100.title"), Component.translatable("runecraftory.advancements.level.100.description"), null, FrameType.CHALLENGE, true, true, false).addCriterion("level", LevelTrigger.TriggerInstance.of(100)).save(cons, LibAdvancements.LEVEL_100.toString());

        Advancement forgingItem = Advancement.Builder.advancement().parent(root).display(ModItems.ITEM_BLOCK_FORGE.get(), Component.translatable("runecraftory.advancements.crafting.forging.title"), Component.translatable("runecraftory.advancements.crafting.forging.description"), null, FrameType.TASK, true, true, false).addCriterion("craft", SimpleTrigger.TriggerInstance.of(ModCriteria.FORGING)).save(cons, LibAdvancements.FORGE_ITEM.toString());
        Advancement craftingItem = Advancement.Builder.advancement().parent(root).display(ModItems.ITEM_BLOCK_ACCESS.get(), Component.translatable("runecraftory.advancements.crafting.armor.title"), Component.translatable("runecraftory.advancements.crafting.armor.description"), null, FrameType.TASK, true, true, false).addCriterion("craft", SimpleTrigger.TriggerInstance.of(ModCriteria.CRAFTING)).save(cons, LibAdvancements.CRAFT_ARMOR.toString());
        Advancement brewingItem = Advancement.Builder.advancement().parent(root).display(ModItems.ITEM_BLOCK_CHEM.get(), Component.translatable("runecraftory.advancements.crafting.chemistry.title"), Component.translatable("runecraftory.advancements.crafting.chemistry.description"), null, FrameType.TASK, true, true, false).addCriterion("craft", SimpleTrigger.TriggerInstance.of(ModCriteria.MEDICINE)).save(cons, LibAdvancements.MAKE_MEDICINE.toString());
        Advancement cookingItem = Advancement.Builder.advancement().parent(root).display(ModItems.ITEM_BLOCK_COOKING.get(), Component.translatable("runecraftory.advancements.crafting.cooking.title"), Component.translatable("runecraftory.advancements.crafting.cooking.description"), null, FrameType.TASK, true, true, false).addCriterion("craft", SimpleTrigger.TriggerInstance.of(ModCriteria.COOKING)).save(cons, LibAdvancements.COOK.toString());

        Advancement upgradeItem = Advancement.Builder.advancement().parent(craftingItem).display(ModItems.CHEAP_BRACELET.get(), Component.translatable("runecraftory.advancements.upgrade.title"), Component.translatable("runecraftory.advancements.upgrade.description"), null, FrameType.TASK, true, true, false).addCriterion("upgrade", SimpleTrigger.TriggerInstance.of(ModCriteria.UPGRADE_ITEM)).save(cons, LibAdvancements.UPGRADE_ITEM.toString());
        ...
        Advancement lightOre = Advancement.Builder.advancement().parent(changeElement).display(ModItems.LIGHT_ORE.get(), Component.translatable("runecraftory.advancements.lightore.title"), Component.translatable("runecraftory.advancements.lightore.description"), null, FrameType.GOAL, true, true, false).addCriterion("light_ore", SimpleTrigger.TriggerInstance.of(ModCriteria.LIGHT_ORE)).save(cons, LibAdvancements.LIGHT_ORE.toString());
        Advancement spell = Advancement.Builder.advancement().parent(forgingItem).display(ModItems.FIRE_BALL_SMALL.get(), Component.translatable("runecraftory.advancements.spell.title"), Component.translatable("runecraftory.advancements.spell.description"), null, FrameType.TASK, true, true, false).addCriterion("spell", InventoryChangeTrigger.TriggerInstance.hasItems(ItemPredicate.Builder.item().of(RunecraftoryTags.SPELLS).build())).save(cons, LibAdvancements.SPELL.toString());
        Advancement changeSpell = Advancement.Builder.advancement().parent(forgingItem).display(ModItems.ROD.get(), Component.translatable("runecraftory.advancements.change.spell.title"), Component.translatable("runecraftory.advancements.change.spell.description"), null, FrameType.TASK, true, true, false).addCriterion("spell", SimpleTrigger.TriggerInstance.of(ModCriteria.CHANGE_SPELL)).save(cons, LibAdvancements.CHANGE_SPELL.toString());

        Advancement fertilizer = Advancement.Builder.advancement().parent(root).display(ModItems.FORMULAR_A.get(), Component.translatable("runecraftory.advancements.fertilizer.title"), Component.translatable("runecraftory.advancements.fertilizer.description"), null, FrameType.TASK, true, true, false).addCriterion("fertilizer", SimpleTrigger.TriggerInstance.of(ModCriteria.FERTILIZE_FARM)).save(cons, LibAdvancements.FERTILIZER.toString());
        Advancement giantCrop = Advancement.Builder.advancement().parent(fertilizer).display(ModItems.TURNIP_GIANT.get(), Component.translatable("runecraftory.advancements.giant_crop.title"), Component.translatable("runecraftory.advancements.giant_crop.description"), null, FrameType.GOAL, true, true, false).addCriterion("giant_crop", CropHarvestTrigger.TriggerInstance.harvest(RunecraftoryTags.GIANT_CROP_BLOCKS)).save(cons, LibAdvancements.GIANT_CROPS.toString());
        Advancement helper = Advancement.Builder.advancement().parent(fertilizer).display(ModItems.MOB_STAFF.get(), Component.translatable("runecraftory.advancements.monster.help.title"), Component.translatable("runecraftory.advancements.monster.help.description"), null, FrameType.TASK, true, true, false).addCriterion("farming", SimpleTrigger.TriggerInstance.of(ModCriteria.COMMAND_FARMING)).save(cons, LibAdvancements.HELPER.toString());
        Advancement hightTierTool = Advancement.Builder.advancement().parent(helper).display(ModItems.WATERING_CAN_PLATINUM.get(), Component.translatable("runecraftory.advancements.final.tool.title"), Component.translatable("runecraftory.advancements.final.tool.description"), null, FrameType.CHALLENGE, true, true, false).addCriterion("final_tool", InventoryChangeTrigger.TriggerInstance.hasItems(ItemPredicate.Builder.item().of(RunecraftoryTags.HIGH_TIER_TOOLS).build())).save(cons, LibAdvancements.HIGH_TIER_TOOL.toString());

        Advancement rootProgression = Advancement.Builder.advancement().display(ModItems.SHORT_DAGGER.get(), Component.translatable("runecraftory.advancements.progression.root.title"), Component.translatable("runecraftory.advancements.progression.root.description"), new ResourceLocation("textures/block/dirt.png"), FrameType.TASK, false, false, false).addCriterion("crafting_table", InventoryChangeTrigger.TriggerInstance.hasItems(Blocks.CRAFTING_TABLE)).save(cons, LibAdvancements.ROOT_PROGRESSION.toString());
