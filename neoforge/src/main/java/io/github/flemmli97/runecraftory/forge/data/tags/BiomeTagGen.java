...
public class BiomeTagGen extends TagsProvider<Biome> {
    ...
    public BiomeTagGen(PackOutput output, CompletableFuture<HolderLookup.Provider> completableFuture) {
        super(output, Registries.BIOME, completableFuture, RuneCraftory.MODID, null);
    }
