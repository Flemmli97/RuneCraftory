...
public class EntityProperties {
	...
	private boolean ridable,flying;
	public EntityProperties(Map<IAttribute, Double> baseValues, Map<ItemProperties,Float> drops, int xp, int money, 
			float tamingChance, ItemProperties[] tamingItem, Map<ItemProperties,Integer> dailyDrops, boolean ridable , boolean flying)
	{
