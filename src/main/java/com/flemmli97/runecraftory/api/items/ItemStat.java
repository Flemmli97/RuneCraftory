...
public class ItemStat //implements IJsonSerializable
{
    ...
    private Map<Attribute, Integer> itemStats;

    public ItemStat(int buy, int sell, int upgradeDiff, EnumElement element, Map<Attribute, Integer> stats) {
        this.buyPrice = buy;
        this.sellPrice = sell;
        this.upgradeDifficulty = upgradeDiff;
        this.element = element;
        this.itemStats = new TreeMap<>(ModAttributes.sorted);
        this.itemStats.putAll(stats);
    }
