...
public class ItemStatAttributes extends RangedAttribute
{
	...
	public static final ItemStatAttributes RFPARA = new ItemStatAttributes("rf.paralysis", id++, 0, -100, 100);
	public static final ItemStatAttributes RFPOISON = new ItemStatAttributes("rf.poison", id++, 0, -100, 100);
	public static final ItemStatAttributes RFSEAL = new ItemStatAttributes("rf.seal", id++, 0, -100, 100);
	public static final ItemStatAttributes RFSLEEP = new ItemStatAttributes("rf.sleep", id++, 0, -100, 100);
	public static final ItemStatAttributes RFFAT = new ItemStatAttributes("rf.fatigue", id++, 0, -100, 100);
	public static final ItemStatAttributes RFCOLD = new ItemStatAttributes("rf.cold", id++, 0, -100, 100);
	public static final ItemStatAttributes RFDIZ = new ItemStatAttributes("rf.diz", id++, 0, -1000, 1000);
	public static final ItemStatAttributes RFCRIT = new ItemStatAttributes("rf.crit", id++, 0, -100, 100);
	public static final ItemStatAttributes RFSTUN = new ItemStatAttributes("rf.stun", id++, 0, -100, 100);
	public static final ItemStatAttributes RFFAINT = new ItemStatAttributes("rf.faint", id++, 0, -100, 100);
	public static final ItemStatAttributes RFDRAIN = new ItemStatAttributes("rf.drain", id++, 0, -100, 100);
	public static final ItemStatAttributes RFKNOCK = new ItemStatAttributes("rf.knock", id++, 0, -100, 100);
	...
	public static final ItemStatAttributes RFRLUCK = new ItemStatAttributes("rf.luck", id++, 0, -100, 200);
