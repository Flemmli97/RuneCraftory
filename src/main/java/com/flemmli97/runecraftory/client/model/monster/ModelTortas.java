...
public class ModelTortas<T extends EntityTortas> extends EntityModel<T> implements IResetModel {
    ...
    public ModelTortas() {
        ...
        this.body.setTextureOffset(0, 0).addBox(-9.0F, -6.0F, -11.0F, 18.0F, 4.0F, 24.0F, 0.0F, false);
        this.body.setTextureOffset(84, 4).addBox(9.0F, -6.0F, -9.0F, 2.0F, 4.0F, 20.0F, 0.0F, false);
        this.body.setTextureOffset(84, 4).addBox(-11.0F, -6.0F, -9.0F, 2.0F, 4.0F, 20.0F, 0.0F, true);
        this.body.setTextureOffset(0, 28).addBox(-8.0F, -9.0F, -10.0F, 16.0F, 3.0F, 22.0F, 0.0F, false);
        this.body.setTextureOffset(76, 32).addBox(8.0F, -9.0F, -8.0F, 2.0F, 3.0F, 18.0F, 0.0F, false);
        this.body.setTextureOffset(76, 32).addBox(-10.0F, -9.0F, -8.0F, 2.0F, 3.0F, 18.0F, 0.0F, true);
        this.body.setTextureOffset(0, 53).addBox(-7.0F, -11.0F, -9.0F, 14.0F, 2.0F, 20.0F, 0.0F, false);
        this.body.setTextureOffset(68, 57).addBox(7.0F, -11.0F, -7.0F, 2.0F, 2.0F, 16.0F, 0.0F, false);
        this.body.setTextureOffset(68, 57).addBox(-9.0F, -11.0F, -7.0F, 2.0F, 2.0F, 16.0F, 0.0F, true);
        this.body.setTextureOffset(0, 75).addBox(-8.0F, -2.0F, -10.0F, 16.0F, 2.0F, 21.0F, 0.0F, false);
        this.body.setTextureOffset(105, 61).addBox(0.0F, -14.0F, -7.0F, 0.0F, 3.0F, 4.0F, 0.0F, false);
        this.body.setTextureOffset(113, 61).addBox(0.0F, -14.0F, -1.0F, 0.0F, 3.0F, 4.0F, 0.0F, false);
        this.body.setTextureOffset(105, 68).addBox(0.0F, -14.0F, 5.0F, 0.0F, 3.0F, 4.0F, 0.0F, false);
        this.body.setTextureOffset(113, 68).addBox(0.0F, -11.0F, 11.0F, 0.0F, 4.0F, 3.0F, 0.0F, false);

        this.neck = new ModelRendererPlus(this);
        this.neck.setDefaultRotPoint(0.0F, 0.0F, -11.0F);
        this.body.addChild(this.neck);
        this.neck.setTextureOffset(75, 76).addBox(-3.0F, -2.0F, -2.0F, 6.0F, 2.0F, 3.0F, 0.0F, false);

        this.head = new ModelRendererPlus(this);
        this.head.setDefaultRotPoint(0.0F, -2.0F, -2.0F);
        this.neck.addChild(this.head);
        this.head.setTextureOffset(75, 81).addBox(-3.0F, -3.0F, -3.0F, 6.0F, 4.0F, 6.0F, 0.0F, false);
        this.head.setTextureOffset(75, 91).addBox(-3.0F, -4.0F, -2.0F, 6.0F, 1.0F, 3.0F, 0.0F, false);
        this.head.setTextureOffset(93, 76).addBox(-2.0F, -2.5F, -3.25F, 4.0F, 4.0F, 1.0F, 0.0F, false);
        ...
        this.jaw.setTextureOffset(93, 91).addBox(-2.0F, -0.5F, -5.1F, 4.0F, 1.0F, 4.0F, 0.0F, false);
        ...
        this.leftLegFrontBase.setTextureOffset(0, 99).addBox(-5.0F, 0.0F, -7.0F, 5.0F, 2.0F, 7.0F, 0.0F, false);
        ...
        this.leftLegFront.setTextureOffset(24, 102).addBox(0.0F, 0.0F, 0.0F, 8.0F, 2.0F, 4.0F, 0.0F, false);
        ...
        this.leftLegBackBase.setTextureOffset(48, 102).addBox(0.0F, 0.0F, 0.0F, 4.0F, 2.0F, 4.0F, 0.0F, false);
        ...
        this.leftLegBack.setTextureOffset(64, 102).addBox(0.0F, 0.0F, 0.0F, 8.0F, 2.0F, 4.0F, 0.0F, false);
        ...
        this.rightLegFrontBase.setTextureOffset(0, 99).addBox(0.0F, 0.0F, -7.0F, 5.0F, 2.0F, 7.0F, 0.0F, true);
        ...
        this.rightLegFront.setTextureOffset(24, 102).addBox(-8.0F, 0.0F, 0.0F, 8.0F, 2.0F, 4.0F, 0.0F, true);
        ...
        this.rightLegBackBase.setTextureOffset(48, 102).addBox(-4.0F, 0.0F, 0.0F, 4.0F, 2.0F, 4.0F, 0.0F, true);
        ...
        this.rightLegBack.setTextureOffset(64, 102).addBox(-8.0F, 0.0F, 0.0F, 8.0F, 2.0F, 4.0F, 0.0F, true);

        this.tail = new ModelRendererPlus(this);
        this.tail.setDefaultRotPoint(0.0F, -1.0F, 11.0F);
        this.body.addChild(this.tail);
        this.tail.setTextureOffset(114, 76).addBox(-1.5F, -2.0F, 0.0F, 3.0F, 3.0F, 3.0F, 0.0F, false);

        this.tail2 = new ModelRendererPlus(this);
        this.tail2.setDefaultRotPoint(0.0F, -1.0F, 3.0F);
        this.tail.addChild(this.tail2);
        this.tail2.setTextureOffset(114, 82).addBox(-1.0F, 0.0F, 0.0F, 2.0F, 2.0F, 2.0F, 0.0F, false);

        this.tail3 = new ModelRendererPlus(this);
        this.tail3.setDefaultRotPoint(0.0F, 0.0F, 2.0F);
        this.tail2.addChild(this.tail3);
        this.tail3.setTextureOffset(114, 86).addBox(-0.5F, 1.0F, 0.0F, 1.0F, 1.0F, 3.0F, 0.0F, false);
    ...
    @Override
    public void setRotationAngles(T tortas, float limbSwing, float limbSwingAmount, float ageInTicks, float netHeadYaw, float headPitch) {
        this.resetModel();
