...
public class ModelWooly<T extends EntityWooly> extends EntityModel<T> implements IResetModel {
    ...
    public ModelWooly() {
        ...
        this.body.setTextureOffset(0, 31).addCuboid(-3.5F, -7.0F, -4.5F, 7.0F, 13.0F, 9.0F, 0.0F, true);
        this.body.setTextureOffset(32, 30).addCuboid(-4.5F, -7.0F, -3.5F, 1.0F, 13.0F, 7.0F, 0.0F, true);
        this.body.setTextureOffset(32, 30).addCuboid(3.5F, -7.0F, -3.5F, 1.0F, 13.0F, 7.0F, 0.0F, false);

        this.bodyUp = new ModelRendererPlus(this);
        this.bodyUp.setDefaultRotPoint(0.0F, -8.0F, 0.0F);
        this.body.addChild(this.bodyUp);
        this.bodyUp.setTextureOffset(32, 14).addCuboid(-2.5F, -1.0F, -3.5F, 5, 2, 7, 0.0F, true);
        this.bodyUp.setTextureOffset(28, 23).addCuboid(2.5F, -1.0F, -2.5F, 1, 2, 5, 0.0F, false);
        this.bodyUp.setTextureOffset(28, 23).addCuboid(-3.5F, -1.0F, -2.5F, 1, 2, 5, 0.0F, true);

        this.neck = new ModelRendererPlus(this);
        this.neck.setDefaultRotPoint(0.0F, -1.5F, 0.0F);
        this.bodyUp.addChild(this.neck);
        this.neck.setTextureOffset(0, 24).addCuboid(-2.5F, -1.0F, -2.5F, 5, 2, 5, 0.0F, true);

        this.head = new ModelRendererPlus(this);
        this.head.setDefaultRotPoint(0.0F, -1.0F, 0.0F);
        this.neck.addChild(this.head);
        this.head.setTextureOffset(0, 0).addCuboid(-3.5F, -7.0F, -4.5F, 7, 7, 9, 0.0F, true);
        this.head.setTextureOffset(32, 0).addCuboid(-4.5F, -7.0F, -3.0F, 1, 7, 7, 0.0F, true);
        this.head.setTextureOffset(32, 0).addCuboid(3.5F, -7.0F, -3.5F, 1, 7, 7, 0.0F, false);
        this.head.setTextureOffset(0, 16).addCuboid(-3.5F, -8.0F, -3.5F, 7, 1, 7, 0.0F, true);
        ...
        this.earLeft.setTextureOffset(48, 0).addCuboid(0.0F, -0.5F, -1.0F, 5, 1, 2, 0.0F, true);
        ...
        this.earRight.setTextureOffset(48, 0).addCuboid(-5.0F, -0.5F, -1.0F, 5, 1, 2, 0.0F, false);
        ...
        this.armLeftBase.setTextureOffset(34, 50).addCuboid(0.25F, -1.0F, -1.0F, 2, 2, 2, 0.0F, false);
        ...
        this.armLeftUp.setTextureOffset(54, 23).addCuboid(-0.25F, -0.5F, -4.0F, 1, 1, 4, 0.0F, false);
        ...
        this.armLeftDown.setTextureOffset(54, 28).addCuboid(-1.0F, -0.5F, -4.0F, 1, 1, 4, 0.0F, false);
        ...
        this.armRightBase.setTextureOffset(34, 50).addCuboid(-2.25F, -1.0F, -1.0F, 2, 2, 2, 0.0F, false);
        ...
        this.armRightUp.setTextureOffset(54, 23).addCuboid(-0.75F, -0.5F, -4.0F, 1, 1, 4, 0.0F, false);
        ...
        this.armRightDown.setTextureOffset(54, 28).addCuboid(0.0F, -0.5F, -4.0F, 1, 1, 4, 0.0F, true);
        ...
        this.feetLeftBase.setTextureOffset(42, 50).addCuboid(-1.5F, -5.5F, -2.5F, 3, 7, 5, 0.0F, false);
        ...
        this.feetLeft.setTextureOffset(16, 53).addCuboid(-1.0F, 0.0F, -7.0F, 2, 1, 7, 0.0F, false);
        ...
        this.feetRightBase.setTextureOffset(42, 50).addCuboid(-1.5F, -5.5F, -2.5F, 3, 7, 5, 0.0F, true);
        ...
        this.feetRight.setTextureOffset(16, 53).addCuboid(-1.0F, 0.0F, -7.0F, 2, 1, 7, 0.0F, false);

        this.tail = new ModelRendererPlus(this);
        this.tail.setDefaultRotPoint(0.0F, 3.0F, 4.0F);
        this.body.addChild(this.tail);
        this.tail.setTextureOffset(52, 3).addCuboid(-1.5F, -1.5F, 0.0F, 3, 3, 3, 0.0F, true);
