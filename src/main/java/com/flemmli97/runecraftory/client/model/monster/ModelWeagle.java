...
public class ModelWeagle<T extends EntityWeagle> extends EntityModel<T> implements IResetModel {
    ...
    public ModelWeagle() {
        ...
        this.body.setTextureOffset(0, 0).addCuboid(-4.0F, -1.0F, -4.0F, 8.0F, 8.0F, 14.0F, 0.0F, false);
        this.body.setTextureOffset(0, 0).addCuboid(4.0F, 0.0F, -3.0F, 1.0F, 6.0F, 11.0F, 0.0F, false);
        this.body.setTextureOffset(0, 0).addCuboid(-5.0F, 0.0F, -3.0F, 1.0F, 6.0F, 11.0F, 0.0F, false);

        this.head = new ModelRendererPlus(this);
        this.head.setDefaultRotPoint(0.0F, 2.0F, -4.0F);
        this.body.addChild(this.head);
        this.head.setTextureOffset(0, 0).addCuboid(-3.0F, -2.0F, -6.0F, 6.0F, 6.0F, 7.0F, 0.0F, false);
        this.head.setTextureOffset(0, 0).addCuboid(0.0F, -5.0F, -6.0F, 0.0F, 3.0F, 6.0F, 0.0F, false);
        this.head.setTextureOffset(0, 0).addCuboid(0.0F, 4.0F, -5.0F, 0.0F, 2.0F, 5.0F, 0.0F, false);
        this.head.setTextureOffset(0, 0).addCuboid(-2.0F, -1.0F, -7.0F, 4.0F, 4.0F, 1.0F, 0.0F, false);
        this.head.setTextureOffset(0, 0).addCuboid(-1.0F, 0.0F, -8.5F, 2.0F, 3.0F, 2.0F, 0.0F, false);

        this.leftWing = new ModelRendererPlus(this);
        this.leftWing.setDefaultRotPoint(4.7F, 2.5F, -1.5F);
        this.body.addChild(this.leftWing);
        this.leftWing.setTextureOffset(0, 0).addCuboid(0.0F, -0.5F, -0.5F, 4.0F, 1.0F, 1.0F, 0.0F, false);
        this.leftWing.setTextureOffset(0, 0).addCuboid(0.0F, 0.0F, 0.0F, 4.0F, 0.0F, 6.0F, 0.0F, false);
        ...
        this.leftWing2.setTextureOffset(0, 0).addCuboid(0.0F, -1.0F, 0.0F, 6.0F, 1.0F, 1.0F, 0.0F, false);
        this.leftWing2.setTextureOffset(0, 0).addCuboid(0.0F, -0.5F, 0.5F, 6.0F, 0.0F, 8.0F, 0.0F, false);
        ...
        this.leftWing3.setTextureOffset(0, 0).addCuboid(0.0F, 0.0F, 0.0F, 10.0F, 1.0F, 1.0F, 0.0F, false);
        this.leftWing3.setTextureOffset(0, 0).addCuboid(0.0F, 0.5F, 0.5F, 10.0F, 0.0F, 8.0F, 0.0F, false);

        this.rightWing = new ModelRendererPlus(this);
        this.rightWing.setDefaultRotPoint(-4.7F, 2.5F, -1.5F);
        this.body.addChild(this.rightWing);
        this.rightWing.setTextureOffset(0, 0).addCuboid(-4.0F, -0.5F, -0.5F, 4.0F, 1.0F, 1.0F, 0.0F, false);
        this.rightWing.setTextureOffset(0, 0).addCuboid(-4.0F, 0.0F, 0.0F, 4.0F, 0.0F, 6.0F, 0.0F, false);
        ...
        this.rightWing2.setTextureOffset(0, 0).addCuboid(-6.0F, -1.0F, 0.0F, 6.0F, 1.0F, 1.0F, 0.0F, false);
        this.rightWing2.setTextureOffset(0, 0).addCuboid(-6.0F, -0.5F, 0.5F, 6.0F, 0.0F, 8.0F, 0.0F, false);
        ...
        this.rightWing3.setTextureOffset(0, 0).addCuboid(-10.0F, 0.0F, 0.0F, 10.0F, 1.0F, 1.0F, 0.0F, false);
        this.rightWing3.setTextureOffset(0, 0).addCuboid(-10.0F, 0.5F, 0.5F, 10.0F, 0.0F, 8.0F, 0.0F, false);

        this.leftLeg = new ModelRendererPlus(this);
        this.leftLeg.setDefaultRotPoint(3.5F, 6.0F, 8.5F);
        this.body.addChild(this.leftLeg);
        this.leftLeg.setTextureOffset(0, 0).addCuboid(-1.0F, -1.0F, -0.5F, 2.0F, 2.0F, 4.0F, 0.0F, false);
        this.leftLeg.setTextureOffset(0, 0).addCuboid(-2.5F, -1.0F, 3.5F, 5.0F, 4.0F, 0.0F, 0.0F, false);

        this.rightLeg = new ModelRendererPlus(this);
        this.rightLeg.setDefaultRotPoint(-3.5F, 6.0F, 8.5F);
        this.body.addChild(this.rightLeg);
        this.rightLeg.setTextureOffset(0, 0).addCuboid(-1.0F, -1.0F, -0.5F, 2.0F, 2.0F, 4.0F, 0.0F, false);
        this.rightLeg.setTextureOffset(0, 0).addCuboid(-2.5F, -1.0F, 3.5F, 5.0F, 4.0F, 0.0F, 0.0F, false);
