...
public class EntityButterfly extends EntityThrowable{
	...
	protected void onImpact(RayTraceResult result) {
		if(result.entityHit!=null)
		{
			...
			{
				result.entityHit.attackEntityFrom(CustomDamage.doAttack(this.getThrower(), EnumElement.EARTH, 2), RFCalculations.getAttributeValue(this.getThrower(), ItemStats.RFMAGICATT, null, null)/6.0F);
