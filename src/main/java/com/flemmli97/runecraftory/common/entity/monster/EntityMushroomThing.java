...
public class EntityMushroomThing extends EntityMobBase {

    private EntityAIChargeAttackBase<EntityMushroomThing> ai = new EntityAIChargeAttackBase<EntityMushroomThing>(this, 1.0f);;
    ...
    public EntityMushroomThing(World world) {
        super(world);
