	...
	public void onUpdate()
    {
		...
		if(!this.world.isRemote)
		{
	        ...
	        for(EntityLivingBase e : list)
	        {
	        		...
	        		{
	        			if(this.owner!=null)
	        				RFCalculations.attackEntity(e, CustomDamage.attack(this.owner, EnumElement.EARTH, CustomDamage.DamageType.NORMAL, CustomDamage.KnockBackType.BACK, 0, 20), RFCalculations.getAttributeValue(this.owner, ItemStats.RFMAGICATT, null, null)/3.0F);
