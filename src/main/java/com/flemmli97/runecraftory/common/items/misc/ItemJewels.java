...
public class ItemJewels extends Item implements IModelRegister
{
    private String[] jewels;
    
    public ItemJewels() {
        this.jewels = new String[] { "amethyst", "aquamarine", "emerald", "ruby", "sapphire", "diamond", "red", "green", "blue", "yellow", "crystal" };
    ...
    public void initModel() {
        for (int meta = 0; meta < 11; ++meta) {
            ModelLoader.setCustomModelResourceLocation(this, meta, new ModelResourceLocation(this.getRegistryName() + "_" + this.jewels[meta], "inventory"));
        }
    }
}
