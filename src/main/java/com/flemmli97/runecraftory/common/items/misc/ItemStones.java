...
public class ItemStones extends Item implements IModelRegister
{
    private String[] stones;
    
    public ItemStones() {
        this.stones = new String[] { "round", "tiny", "normal", "tablet", "spirit", "truth" };
    ...
    public void initModel() {
        for (int meta = 0; meta < 6; ++meta) {
            ModelLoader.setCustomModelResourceLocation(this, meta, new ModelResourceLocation(this.getRegistryName() + "_" + this.stones[meta], "inventory"));
        }
    }
}
