...
public class ItemShoeBase extends ItemArmor implements IItemWearable
{
    private static final String armorModelPath = "runecraftory:textures/models/armor/";
    
    public ItemShoeBase(String name) {
        this(ModItems.chain, name);
    }
    
    public ItemShoeBase(ItemArmor.ArmorMaterial mat, String name) {
        super(mat, 0, EntityEquipmentSlot.FEET);
