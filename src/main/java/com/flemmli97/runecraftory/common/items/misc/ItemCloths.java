...
public class ItemCloths extends Item implements IItemBase, IModelRegister{
	
	private String[] cloth = new String[] {"cheap", "quality", "h_quality","silk","ghost","giant","blue","insect","pretty","ancient"};
	...
	public void initModel() {
		for(int meta = 0; meta < 10;meta++)
			ModelLoader.setCustomModelResourceLocation(this, meta, new ModelResourceLocation(getRegistryName()+"_"+cloth[meta], "inventory"));		
	}
