...
public class ItemHeadBase extends ItemArmor implements IItemWearable
{
    private static final String armorModelPath = "runecraftory:textures/models/armor/";
    
    public ItemHeadBase(String name) {
        this(ModItems.chain, name);
    }
    
    public ItemHeadBase(ItemArmor.ArmorMaterial mat, String name) {
