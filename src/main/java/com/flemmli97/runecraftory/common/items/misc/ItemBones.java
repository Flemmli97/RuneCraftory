...
public class ItemBones extends Item implements IItemBase, IModelRegister{
	...
	public void initModel() {
		for(int meta = 0; meta < 6;meta++)
			ModelLoader.setCustomModelResourceLocation(this, meta, new ModelResourceLocation(getRegistryName()+"_"+bones[meta], "inventory"));		
	}
}
