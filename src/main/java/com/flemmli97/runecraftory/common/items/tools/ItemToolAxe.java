...
public class ItemToolAxe extends ItemAxe implements IItemUsable, IChargeable{

	private EnumToolTier tier;

	public ItemToolAxe(EnumToolTier tier) {
		super(ModItems.mat, 1, -3);
        this.setMaxStackSize(1);
        this.setCreativeTab(RuneCraftory.weaponToolTab);
        this.setRegistryName(new ResourceLocation(LibReference.MODID, "axe_" + tier.getName()));
