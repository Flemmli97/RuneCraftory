...
public class GeneralConfig {
    ...
    public static int platinumChargeTime;
    ...
    public static class GeneralConfigSpec {

        public static final Configuration<GeneralConfigSpec> config = new Configuration<>(GeneralConfigSpec::new, (p) -> p.resolve(RuneCraftory.MODID).resolve("mobs.toml"), GeneralConfig::load, RuneCraftory.MODID);
    ...
    static {
        weaponProps.put(EnumWeaponType.FARM, new WeaponTypeProperties(3, 0));
        weaponProps.put(EnumWeaponType.SHORTSWORD, new WeaponTypeProperties(2.5f, 6));
        weaponProps.put(EnumWeaponType.LONGSWORD, new WeaponTypeProperties(4.0f, 25));
        weaponProps.put(EnumWeaponType.SPEAR, new WeaponTypeProperties(5.0f, 1.5f));
        weaponProps.put(EnumWeaponType.HAXE, new WeaponTypeProperties(4.5f, 40));
        weaponProps.put(EnumWeaponType.DUAL, new WeaponTypeProperties(3.0f, 10));
        weaponProps.put(EnumWeaponType.GLOVE, new WeaponTypeProperties(3.0f, 3));
        weaponProps.put(EnumWeaponType.STAFF, new WeaponTypeProperties(3.5f, 0));
