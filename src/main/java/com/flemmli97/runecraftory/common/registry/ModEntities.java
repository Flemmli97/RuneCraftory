...
public class ModEntities {
    ...
    public static final RegistryObject<EntityType<EntityThiccLightningBolt>> lightningOrbBolt = reg(EntityType.Builder.<EntityThiccLightningBolt>create(EntityThiccLightningBolt::new, EntityClassification.MISC).size(0.8f, 0.8f).maxTrackingRange(4), LibEntities.lightningOrbBolt);
    public static final RegistryObject<EntityType<EntityThunderboltBeam>> lightningBeam = reg(EntityType.Builder.<EntityThunderboltBeam>create(EntityThunderboltBeam::new, EntityClassification.MISC).size(0.25f, 0.25f).maxTrackingRange(4), LibEntities.lightningBeam);

    public static final RegistryObject<EntityType<EntityWindBlade>> windBlade = reg(EntityType.Builder.<EntityWindBlade>create(EntityWindBlade::new, EntityClassification.MISC).size(0.05f, 0.05f).maxTrackingRange(4), LibEntities.windBlade);
    ...
    public static final RegistryObject<EntityType<EntityWaterLaser>> waterLaser = reg(EntityType.Builder.<EntityWaterLaser>create(EntityWaterLaser::new, EntityClassification.MISC).size(0.05f, 0.05f).maxTrackingRange(4), LibEntities.waterLaser);
