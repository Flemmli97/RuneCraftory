...
public class ModParticles {
    ...
    public static final RegistryObject<ParticleType<ColoredParticleData>> puff = registerColoredParticleType("puff", false);
    ...
    public static final RegistryObject<ParticleType<ColoredParticleData>> ambrosiaWaveParticle = registerColoredParticleType("butterfly_wave", false);
