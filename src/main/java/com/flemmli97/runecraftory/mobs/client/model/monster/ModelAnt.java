...
public class ModelAnt<T extends EntityAnt> extends EntityModel<T> implements IResetModel {
    ...
    public ModelAnt() {
        ...
        this.body.setTextureOffset(38, 14).addCuboid(-3.0F, -2.0F, -4.0F, 6.0F, 4.0F, 7.0F, 0.0F, true);
        ...
        this.bodyConnector.setTextureOffset(54, 10).addCuboid(-2.0F, -1.0F, -0.5F, 4.0F, 2.0F, 1.0F, 0.0F, true);

        this.bodyBack = new ModelRendererPlus(this);
        this.bodyBack.setDefaultRotPoint(0.0F, 0.0F, 4.0F);
        this.body.addChild(this.bodyBack);
        this.bodyBack.setTextureOffset(0, 26).addCuboid(-5.0F, -2.5F, 0.0F, 10.0F, 5.0F, 11.0F, 0.0F, true);
        this.bodyBack.setTextureOffset(32, 0).addCuboid(-3.5F, -3.5F, 1.0F, 7.0F, 1.0F, 9.0F, 0.0F, true);

        this.head = new ModelRendererPlus(this);
        this.head.setDefaultRotPoint(0.0F, 0.0F, -4.0F);
        this.body.addChild(this.head);
        this.head.setTextureOffset(0, 0).addCuboid(-5.0F, -3.0F, -3.0F, 10.0F, 6.0F, 3.0F, 0.0F, true);
        ...
        this.headFront.setTextureOffset(0, 9).addCuboid(-4.5F, -2.5F, -8.0F, 9.0F, 5.0F, 5.0F, 0.0F, true);
        ...
        this.feelerLeft.setTextureOffset(26, 0).addCuboid(-0.5F, -5.5F, -0.5F, 1.0F, 6.0F, 1.0F, 0.0F, true);
        ...
        this.feelerRight.setTextureOffset(26, 0).addCuboid(-0.5F, -5.5F, -0.5F, 1.0F, 6.0F, 1.0F, 0.0F, false);
        ...
        this.jawLeft.setTextureOffset(38, 10).addCuboid(0.0F, -0.5F, -3.5F, 2.0F, 1.0F, 3.0F, 0.0F, true);
        ...
        this.jawRight.setTextureOffset(38, 10).addCuboid(-2.0F, -0.5F, -3.5F, 2.0F, 1.0F, 3.0F, 0.0F, false);
        ...
        this.leg1Up1.setTextureOffset(0, 19).addCuboid(-7.0F, -1.0F, -1.0F, 7.0F, 2.0F, 2.0F, 0.0F, true);
        ...
        this.leg1Down1.setTextureOffset(0, 23).addCuboid(-9.0F, -1.0F, -0.5F, 9.0F, 2.0F, 1.0F, 0.0F, true);
        ...
        this.leg1Up2.setTextureOffset(0, 19).addCuboid(-7.0F, -1.0F, -1.0F, 7.0F, 2.0F, 2.0F, 0.0F, true);
        ...
        this.leg1Down2.setTextureOffset(0, 23).addCuboid(-9.0F, -1.0F, -0.5F, 9.0F, 2.0F, 1.0F, 0.0F, true);
        ...
        this.leg1Up3.setTextureOffset(0, 19).addCuboid(-7.0F, -1.0F, -1.0F, 7.0F, 2.0F, 2.0F, 0.0F, true);
        ...
        this.leg1Down3.setTextureOffset(0, 23).addCuboid(-9.0F, -1.0F, -0.5F, 9.0F, 2.0F, 1.0F, 0.0F, true);
        ...
        this.leg1Up4.setTextureOffset(0, 19).addCuboid(0.0F, -1.0F, -1.0F, 7.0F, 2.0F, 2.0F, 0.0F, false);
        ...
        this.leg1Down4.setTextureOffset(0, 23).addCuboid(0.0F, -1.0F, -0.5F, 9.0F, 2.0F, 1.0F, 0.0F, false);
        ...
        this.leg1Up5.setTextureOffset(0, 19).addCuboid(0.0F, -1.0F, -1.0F, 7.0F, 2.0F, 2.0F, 0.0F, false);
        ...
        this.leg1Down5.setTextureOffset(0, 23).addCuboid(0.0F, -1.0F, -0.5F, 9.0F, 2.0F, 1.0F, 0.0F, false);
        ...
        this.leg1Up6.setTextureOffset(0, 19).addCuboid(0.0F, -1.0F, -1.0F, 7.0F, 2.0F, 2.0F, 0.0F, false);
        ...
        this.leg1Down6.setTextureOffset(0, 23).addCuboid(0.0F, -1.0F, -0.5F, 9.0F, 2.0F, 1.0F, 0.0F, false);
