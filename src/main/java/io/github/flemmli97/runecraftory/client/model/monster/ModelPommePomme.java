...
public class ModelPommePomme<T extends EntityPommePomme> extends EntityModel<T> implements IResetModel {
    ...
    public ModelPommePomme() {
        ...
        this.body.setTextureOffset(0, 0).addBox(-7.0F, -6.0F, -7.0F, 14.0F, 14.0F, 14.0F, 0.0F, false);
        this.body.setTextureOffset(0, 28).addBox(7.0F, -5.0F, -6.0F, 1.0F, 12.0F, 12.0F, 0.0F, false);
        this.body.setTextureOffset(26, 28).addBox(8.0F, -3.0F, -4.0F, 1.0F, 8.0F, 8.0F, 0.0F, false);
        this.body.setTextureOffset(0, 28).addBox(-8.0F, -5.0F, -6.0F, 1.0F, 12.0F, 12.0F, 0.0F, true);
        this.body.setTextureOffset(26, 28).addBox(-9.0F, -3.0F, -4.0F, 1.0F, 8.0F, 8.0F, 0.0F, true);
        this.body.setTextureOffset(56, 0).addBox(-6.0F, -5.0F, -8.0F, 12.0F, 12.0F, 1.0F, 0.0F, false);
        this.body.setTextureOffset(56, 13).addBox(-4.0F, -3.0F, -9.0F, 8.0F, 8.0F, 1.0F, 0.0F, false);
        this.body.setTextureOffset(56, 0).addBox(-6.0F, -5.0F, 7.0F, 12.0F, 12.0F, 1.0F, 0.0F, true);
        this.body.setTextureOffset(56, 13).addBox(-4.0F, -3.0F, 8.0F, 8.0F, 8.0F, 1.0F, 0.0F, true);
        this.body.setTextureOffset(74, 23).addBox(-6.0F, -7.0F, -6.0F, 12.0F, 1.0F, 12.0F, 0.0F, false);
        this.body.setTextureOffset(44, 36).addBox(-6.0F, 8.0F, -6.0F, 12.0F, 1.0F, 12.0F, 0.0F, false);
        this.body.setTextureOffset(92, 36).addBox(-4.0F, 9.0F, -4.0F, 8.0F, 1.0F, 8.0F, 0.0F, false);

        this.inner = new ModelRendererPlus(this);
        this.inner.setDefaultRotPoint(0.0F, -7.0F, 0.0F);
        this.body.addChild(this.inner);
        this.inner.setTextureOffset(102, 0).addBox(-3.0F, -6.0F, -3.0F, 6.0F, 6.0F, 6.0F, 0.0F, false);
        this.inner.setTextureOffset(74, 14).addBox(-4.0F, -7.0F, -4.0F, 8.0F, 1.0F, 8.0F, 0.0F, false);

        this.stem = new ModelRendererPlus(this);
        this.stem.setDefaultRotPoint(0.0F, -8.0F, 0.0F);
        this.inner.addChild(this.stem);
        this.stem.setTextureOffset(106, 12).addBox(-0.5F, -4.0F, -0.5F, 1.0F, 5.0F, 1.0F, 0.0F, false);
        ...
        this.hairRight.setTextureOffset(56, 23).addBox(-6.0F, 0.0F, -4.0F, 6.0F, 0.0F, 8.0F, 0.0F, true);
        ...
        this.hairLeft.setTextureOffset(56, 23).addBox(0.0F, 0.0F, -4.0F, 6.0F, 0.0F, 8.0F, 0.0F, false);
        ...
        this.handLeft.setTextureOffset(82, 8).addBox(-1.0F, 1.4696F, -5.3473F, 2.0F, 1.0F, 5.0F, 0.0F, false);
        ...
        this.handRight.setTextureOffset(82, 8).addBox(-1.0F, 1.4696F, -5.3473F, 2.0F, 1.0F, 5.0F, 0.0F, false);

        this.feetLeft = new ModelRendererPlus(this);
        this.feetLeft.setDefaultRotPoint(3.5F, 10.0F, 1.0F);
        this.body.addChild(this.feetLeft);
        this.feetLeft.setTextureOffset(82, 0).addBox(-1.5F, 0.0F, -7.0F, 3.0F, 1.0F, 7.0F, 0.0F, false);
        ...
        this.feetRight.setTextureOffset(82, 0).addBox(-1.5F, 0.0F, -7.0F, 3.0F, 1.0F, 7.0F, 0.0F, true);
    ...
    @Override
    public void setRotationAngles(T pommePomme, float limbSwing, float limbSwingAmount, float ageInTicks, float netHeadYaw, float headPitch) {
        this.resetModel();
