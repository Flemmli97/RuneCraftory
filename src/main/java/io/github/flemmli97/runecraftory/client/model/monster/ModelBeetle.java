...
public class ModelBeetle<T extends EntityBeetle> extends EntityModel<T> implements IResetModel {
    ...
    public ModelBeetle() {
        ...
        this.body.setTextureOffset(0, 0).addBox(-5.0F, -5.0F, -7.0F, 10.0F, 7.0F, 15.0F, 0.0F, false);
        this.body.setTextureOffset(0, 22).addBox(-4.5F, 2.0F, -7.0F, 9.0F, 2.0F, 15.0F, 0.0F, false);
        ...
        this.head.setTextureOffset(110, 12).addBox(-2.0F, -3.1F, -5.0F, 4.0F, 6.0F, 5.0F, 0.0F, false);
        this.head.setTextureOffset(96, 24).addBox(-2.0F, -2.1F, -6.0F, 4.0F, 5.0F, 1.0F, 0.0F, false);
        this.head.setTextureOffset(106, 24).addBox(-1.0F, -1.1F, -7.0F, 2.0F, 4.0F, 1.0F, 0.0F, false);
        ...
        this.chin.setTextureOffset(112, 23).addBox(-0.5F, 0.0F, -1.0F, 1.0F, 1.0F, 1.0F, 0.0F, false);
        ...
        this.headLeft.setTextureOffset(106, 0).addBox(-2.0F, -3.1F, -5.0F, 2.0F, 6.0F, 6.0F, 0.0F, false);
        this.headLeft.setTextureOffset(96, 12).addBox(-3.0F, -4.1F, -2.0F, 2.0F, 7.0F, 5.0F, 0.0F, false);
        ...
        this.headRight.setTextureOffset(106, 0).addBox(0.0F, -3.1F, -5.0F, 2.0F, 6.0F, 6.0F, 0.0F, true);
        this.headRight.setTextureOffset(96, 12).addBox(1.0F, -4.1F, -2.0F, 2.0F, 7.0F, 5.0F, 0.0F, true);
        ...
        this.headUp.setTextureOffset(84, 30).addBox(-1.5F, -2.0F, -1.0F, 3.0F, 4.0F, 2.0F, 0.0F, false);
        this.headUp.setTextureOffset(94, 30).addBox(-2.0F, -4.0F, 0.0F, 4.0F, 4.0F, 2.0F, 0.0F, false);
        this.headUp.setTextureOffset(84, 36).addBox(-2.5F, -5.0F, 1.0F, 5.0F, 5.0F, 2.0F, 0.0F, false);
        this.headUp.setTextureOffset(98, 36).addBox(-2.5F, -6.0F, 3.0F, 5.0F, 6.0F, 3.0F, 0.0F, false);
        ...
        this.hornFront.setTextureOffset(112, 25).addBox(-0.5F, -2.0F, -3.25F, 1.0F, 2.0F, 3.0F, 0.0F, false);
        ...
        this.hornFrontTip2.setTextureOffset(112, 30).addBox(-0.5F, -2.0F, -4.25F, 1.0F, 1.0F, 4.0F, 0.0F, false);
        ...
        this.hornBackBase.setTextureOffset(82, 18).addBox(-1.0F, -4.5F, -1.5F, 2.0F, 4.0F, 2.0F, 0.0F, false);
        ...
        this.hornBack.setTextureOffset(90, 18).addBox(-0.5F, -5.25F, -2.0F, 1.0F, 5.0F, 2.0F, 0.0F, false);
        ...
        this.hornBackTip.setTextureOffset(84, 24).addBox(-0.5F, -5.25F, -1.0F, 1.0F, 5.0F, 1.0F, 0.0F, false);
        ...
        this.elytronLeft.setTextureOffset(0, 40).addBox(-3.0F, -1.0F, 0.0F, 5.0F, 1.0F, 15.0F, 0.0F, false);
        this.elytronLeft.setTextureOffset(50, 0).addBox(2.0F, 0.0F, 0.0F, 1.0F, 7.0F, 15.0F, 0.0F, false);
        this.elytronLeft.setTextureOffset(48, 22).addBox(-3.0F, -0.01F, 15.0F, 5.0F, 7.0F, 1.0F, 0.0F, false);
        ...
        this.elytronRight.setTextureOffset(0, 40).addBox(-2.0F, -1.0F, 0.0F, 5.0F, 1.0F, 15.0F, 0.0F, true);
        this.elytronRight.setTextureOffset(50, 0).addBox(-3.0F, 0.0F, 0.0F, 1.0F, 7.0F, 15.0F, 0.0F, true);
        this.elytronRight.setTextureOffset(48, 22).addBox(-2.0F, -0.01F, 15.0F, 5.0F, 7.0F, 1.0F, 0.0F, true);

        this.wingLeft = new ModelRendererPlus(this);
        this.wingLeft.setDefaultRotPoint(1.0F, -5.0F, -4.0F);
        this.body.addChild(this.wingLeft);
        this.wingLeft.setTextureOffset(48, 30).addBox(-1.0F, 0.0F, -1.0F, 5.0F, 0.0F, 13.0F, 0.0F, false);
        ...
        this.wingLeftSide.setTextureOffset(40, 43).addBox(0.0F, 0.0F, -6.0F, 0.0F, 7.0F, 13.0F, 0.0F, true);
        ...
        this.wingLeftBack.setTextureOffset(67, 43).addBox(-5.0F, -3.0F, 0.0F, 5.0F, 7.0F, 0.0F, 0.0F, false);

        this.wingRight = new ModelRendererPlus(this);
        this.wingRight.setDefaultRotPoint(-1.0F, -5.0F, -4.0F);
        this.body.addChild(this.wingRight);
        this.wingRight.setTextureOffset(48, 30).addBox(-4.0F, 0.0F, -1.0F, 5.0F, 0.0F, 13.0F, 0.0F, true);
        ...
        this.wingRightSide.setTextureOffset(40, 43).addBox(0.0F, 0.0F, -6.0F, 0.0F, 7.0F, 13.0F, 0.0F, false);
        ...
        this.wingRightBack.setTextureOffset(67, 43).addBox(0.0F, -3.0F, 0.0F, 5.0F, 7.0F, 0.0F, 0.0F, true);
        ...
        this.legLeft.setTextureOffset(82, 0).addBox(0.0F, 0.0F, 0.0F, 2.0F, 5.0F, 2.0F, 0.0F, false);
        ...
        this.legLeftMiddle.setTextureOffset(82, 7).addBox(-0.5F, 0.0F, 0.0F, 1.0F, 4.0F, 2.0F, 0.0F, false);
        ...
        this.legLeftDown.setTextureOffset(82, 13).addBox(-0.5F, 0.0F, -1.0F, 1.0F, 4.0F, 1.0F, 0.0F, false);
        ...
        this.legRight.setTextureOffset(82, 0).addBox(-2.0F, 0.0F, 0.0F, 2.0F, 5.0F, 2.0F, 0.0F, true);
        ...
        this.legRightMiddle.setTextureOffset(82, 7).addBox(-0.5F, 0.0F, 0.0F, 1.0F, 4.0F, 2.0F, 0.0F, true);
        ...
        this.legRightDown.setTextureOffset(82, 13).addBox(-0.5F, 0.0F, -1.0F, 1.0F, 4.0F, 1.0F, 0.0F, true);
        ...
        this.armLeft.setTextureOffset(90, 0).addBox(0.0F, 0.0F, 0.0F, 1.0F, 5.0F, 2.0F, 0.0F, false);
        ...
        this.armLeftMiddle.setTextureOffset(90, 7).addBox(-0.5F, 0.0F, 0.0F, 1.0F, 2.0F, 1.0F, 0.0F, false);
        this.armLeftMiddle.setTextureOffset(96, 0).addBox(-0.5F, 2.0F, 0.5F, 1.0F, 3.0F, 0.0F, 0.0F, false);
        this.armLeftMiddle.setTextureOffset(96, 3).addBox(0.0F, 2.0F, 0.0F, 0.0F, 3.0F, 1.0F, 0.0F, false);
        ...
        this.leftClaw.setTextureOffset(94, 7).addBox(-0.5F, 0.25F, -0.5F, 1.0F, 1.0F, 1.0F, 0.0F, false);
        ...
        this.armRight.setTextureOffset(90, 0).addBox(-1.0F, 0.0F, 0.0F, 1.0F, 5.0F, 2.0F, 0.0F, true);
        ...
        this.armRightMiddle.setTextureOffset(90, 7).addBox(-0.5F, 0.0F, 0.0F, 1.0F, 2.0F, 1.0F, 0.0F, true);
        this.armRightMiddle.setTextureOffset(96, 0).addBox(-0.5F, 2.0F, 0.5F, 1.0F, 3.0F, 0.0F, 0.0F, false);
        this.armRightMiddle.setTextureOffset(96, 3).addBox(0.0F, 2.0F, 0.0F, 0.0F, 3.0F, 1.0F, 0.0F, false);
        ...
        this.rightClaw.setTextureOffset(94, 7).addBox(-0.5F, 0.25F, -0.5F, 1.0F, 1.0F, 1.0F, 0.0F, true);
        ...
        this.armLeft2.setTextureOffset(98, 0).addBox(0.0F, 0.0F, 0.0F, 1.0F, 5.0F, 2.0F, 0.0F, false);
        ...
        this.armLeft2Middle.setTextureOffset(98, 7).addBox(-0.5F, 0.0F, -1.0F, 1.0F, 2.0F, 1.0F, 0.0F, false);
        this.armLeft2Middle.setTextureOffset(104, 0).addBox(-0.5F, 2.0F, -0.5F, 1.0F, 3.0F, 0.0F, 0.0F, false);
        this.armLeft2Middle.setTextureOffset(104, 5).addBox(0.0F, 2.0F, -1.0F, 0.0F, 3.0F, 1.0F, 0.0F, false);
        ...
        this.leftClaw2.setTextureOffset(102, 7).addBox(-0.5F, 0.25F, -0.5F, 1.0F, 1.0F, 1.0F, 0.0F, false);
        ...
        this.armRight2.setTextureOffset(98, 0).addBox(-1.0F, 0.0F, 0.0F, 1.0F, 5.0F, 2.0F, 0.0F, true);
        ...
        this.armRight2Middle.setTextureOffset(98, 7).addBox(-0.5F, 0.0F, -1.0F, 1.0F, 2.0F, 1.0F, 0.0F, true);
        this.armRight2Middle.setTextureOffset(104, 0).addBox(-0.5F, 2.0F, -0.5F, 1.0F, 3.0F, 0.0F, 0.0F, false);
        this.armRight2Middle.setTextureOffset(104, 5).addBox(0.0F, 2.0F, -1.0F, 0.0F, 3.0F, 1.0F, 0.0F, false);
        ...
        this.rightClaw2.setTextureOffset(102, 7).addBox(-0.5F, 0.25F, -0.5F, 1.0F, 1.0F, 1.0F, 0.0F, false);
    ...
    @Override
    public void setRotationAngles(T beetle, float limbSwing, float limbSwingAmount, float ageInTicks, float netHeadYaw, float headPitch) {
        this.resetModel();
        ...
        beetle.getAnimationHandler().getAnimation().ifPresent(anim -> this.animations.doAnimation(anim.getAnimationClient(), anim.getTick(), partialTicks));
    }
