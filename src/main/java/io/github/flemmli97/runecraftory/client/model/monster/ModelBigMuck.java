...
public class ModelBigMuck<T extends EntityBigMuck> extends EntityModel<T> implements IResetModel {
    ...
    public ModelBigMuck() {
        ...
        this.body.setTextureOffset(0, 0).addBox(-6.0F, -14.0F, -5.0F, 11.0F, 14.0F, 11.0F, 0.0F, false);
        this.body.setTextureOffset(0, 25).addBox(-5.0F, -14.0F, -6.0F, 9.0F, 14.0F, 1.0F, 0.0F, false);
        this.body.setTextureOffset(44, 0).addBox(5.0F, -14.0F, -4.0F, 1.0F, 14.0F, 9.0F, 0.0F, false);
        this.body.setTextureOffset(44, 0).addBox(-7.0F, -14.0F, -4.0F, 1.0F, 14.0F, 9.0F, 0.0F, false);
        this.body.setTextureOffset(20, 25).addBox(-5.0F, -14.0F, 6.0F, 9.0F, 14.0F, 1.0F, 0.0F, false);
        ...
        this.mushroomCap.setTextureOffset(0, 48).addBox(-10.0F, -16.0F, -9.0F, 19.0F, 2.0F, 19.0F, 0.0F, false);
        this.mushroomCap.setTextureOffset(0, 69).addBox(-8.0F, -18.0F, -7.0F, 15.0F, 2.0F, 15.0F, 0.0F, false);
        this.mushroomCap.setTextureOffset(0, 86).addBox(-7.0F, -21.0F, -6.0F, 13.0F, 3.0F, 13.0F, 0.0F, false);
        this.mushroomCap.setTextureOffset(0, 102).addBox(-6.0F, -24.0F, -5.0F, 11.0F, 3.0F, 11.0F, 0.0F, false);
        this.mushroomCap.setTextureOffset(0, 116).addBox(-4.0F, -26.0F, -3.0F, 7.0F, 2.0F, 7.0F, 0.0F, false);
        ...
        this.handLeft.setTextureOffset(0, 40).addBox(0.0F, -0.5F, -3.5F, 8.0F, 1.0F, 7.0F, 0.0F, true);
        ...
        this.handRight.setTextureOffset(0, 40).addBox(-8.0F, -0.5F, -3.5F, 8.0F, 1.0F, 7.0F, 0.0F, false);
        ...
        this.tail.setTextureOffset(44, 23).addBox(-0.5F, -1.0F, 0.0F, 1.0F, 1.0F, 2.0F, 0.0F, false);

        this.tailCap = new ModelRendererPlus(this);
        this.tailCap.setDefaultRotPoint(0.5F, 0.0F, 0.0F);
        this.tail.addChild(this.tailCap);
        this.tailCap.setTextureOffset(50, 23).addBox(-1.5F, -1.5F, 2.0F, 2.0F, 2.0F, 2.0F, 0.0F, false);
    ...
    @Override
    public void setRotationAngles(T mushroom, float limbSwing, float limbSwingAmount, float ageInTicks, float netHeadYaw, float headPitch) {
        this.resetModel();
        ...
        mushroom.getAnimationHandler().getAnimation().ifPresent(anim -> this.animations.doAnimation(anim.getAnimationClient(), anim.getTick(), partialTicks));
    }
