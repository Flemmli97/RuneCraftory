...
public class ModelCluckadoodle<T extends EntityCluckadoodle> extends EntityModel<T> implements IResetModel {
    ...
    public ModelCluckadoodle() {
        ...
        this.body.setTextureOffset(32, 15).addBox(-3.5F, -3.5F, -5.3333F, 7.0F, 7.0F, 10.0F, 0.0F, false);

        this.neck = new ModelRendererPlus(this);
        this.neck.setDefaultRotPoint(0.0F, -2.5F, -5.3333F);
        this.body.addChild(this.neck);
        this.neck.setTextureOffset(0, 16).addBox(-2.0F, 0.0F, -1.0F, 4.0F, 3.0F, 2.0F, 0.0F, false);

        this.head = new ModelRendererPlus(this);
        this.head.setDefaultRotPoint(0.0F, 0.0F, 0.0F);
        this.neck.addChild(this.head);
        this.head.setTextureOffset(0, 0).addBox(-2.0F, -6.0F, -2.0F, 4.0F, 6.0F, 4.0F, 0.0F, false);

        this.comb = new ModelRendererPlus(this);
        this.comb.setDefaultRotPoint(0.0F, 9.0F, 4.0F);
        this.head.addChild(this.comb);
        this.comb.setTextureOffset(20, 11).addBox(0.0F, -21.0F, -7.0F, 0.0F, 7.0F, 6.0F, 0.0F, false);

        this.beak = new ModelRendererPlus(this);
        this.beak.setDefaultRotPoint(0.0F, 0.0F, 0.0F);
        this.head.addChild(this.beak);
        this.beak.setTextureOffset(12, 14).addBox(-1.0F, -4.0F, -4.0F, 2.0F, 2.0F, 2.0F, 0.0F, false);
        this.beak.setTextureOffset(12, 18).addBox(-1.0F, -3.5F, -4.5F, 2.0F, 2.0F, 1.0F, 0.0F, false);
        ...
        this.backFeathersLeft.setTextureOffset(0, 21).addBox(0.0F, -8.5F, 0.0F, 6.0F, 9.0F, 0.0F, 0.0F, false);
        ...
        this.backFeathersLeftUp.setTextureOffset(12, 21).addBox(0.0F, -10.5F, 0.0F, 6.0F, 11.0F, 0.0F, 0.0F, false);
        ...
        this.backFeathersRight.setTextureOffset(0, 21).addBox(-6.0F, -9.5F, 0.0F, 6.0F, 10.0F, 0.0F, 0.0F, true);
        ...
        this.backFeathersRightUp.setTextureOffset(12, 21).addBox(-6.0F, -10.5F, 0.0F, 6.0F, 11.0F, 0.0F, 0.0F, true);

        this.legLeft = new ModelRendererPlus(this);
        this.legLeft.setDefaultRotPoint(1.5F, 3.5F, -0.8333F);
        this.body.addChild(this.legLeft);
        this.legLeft.setTextureOffset(26, 0).addBox(-0.5F, -1.0F, -0.5F, 1.0F, 6.0F, 1.0F, 0.0F, false);
        this.legLeft.setTextureOffset(26, 7).addBox(-1.5F, 5.0F, -2.5F, 3.0F, 0.0F, 4.0F, 0.0F, false);

        this.legRight = new ModelRendererPlus(this);
        this.legRight.setDefaultRotPoint(-1.5F, 3.5F, -0.8333F);
        this.body.addChild(this.legRight);
        this.legRight.setTextureOffset(26, 0).addBox(-0.5F, -1.0F, -0.5F, 1.0F, 6.0F, 1.0F, 0.0F, false);
        this.legRight.setTextureOffset(26, 7).addBox(-1.5F, 5.0F, -2.5F, 3.0F, 0.0F, 4.0F, 0.0F, false);
        ...
        this.wingLeft.setTextureOffset(40, 0).addBox(0.0F, -2.0F, -0.5F, 1.0F, 5.0F, 8.0F, 0.0F, false);
        ...
        this.wingRight.setTextureOffset(40, 0).addBox(-1.0F, -2.0603F, -0.842F, 1.0F, 5.0F, 8.0F, 0.0F, true);
    ...
    @Override
    public void setRotationAngles(T cluckadoodle, float limbSwing, float limbSwingAmount, float ageInTicks, float netHeadYaw, float headPitch) {
        this.resetModel();
        ...
        cluckadoodle.getAnimationHandler().getAnimation().ifPresent(anim -> this.animations.doAnimation(anim.getAnimationClient(), anim.getTick(), partialTicks));
    }
