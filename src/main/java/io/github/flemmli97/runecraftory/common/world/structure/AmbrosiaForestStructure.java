...
public class AmbrosiaForestStructure extends Structure<NoFeatureConfig> {

    public AmbrosiaForestStructure(Codec<NoFeatureConfig> codec) {
        super(codec);
    }
    ...
    public static class Start extends StructureStart<NoFeatureConfig> {
        ...
        public void func_230364_a_(DynamicRegistries reg, ChunkGenerator gen, TemplateManager templateManager, int chunkX, int chunkZ, Biome biome, NoFeatureConfig conf) {
            ...
            AmbrosiaForestPiece.add(templateManager, blockpos, rotation, this.components, this.rand);
