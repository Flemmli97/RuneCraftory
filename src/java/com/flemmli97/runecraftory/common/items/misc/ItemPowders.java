...
public class ItemPowders extends Item implements IItemBase, IUpgradeItem{
	
	private String[] powders = new String[] {"spore", "poison", "holy","dust","elixier","gunpowder", "root", "magicP", "mysterious", "magic","earth","fire","water","turnip","melody"};

	public ItemPowders()
	{
		super();
		this.setCreativeTab(RuneCraftory.upgradeItems);
        	this.setRegistryName(new ResourceLocation(RFReference.MODID, "powders" ));	
