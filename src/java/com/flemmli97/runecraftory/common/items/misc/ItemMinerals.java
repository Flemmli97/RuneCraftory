...
public class ItemMinerals extends Item implements IItemBase, IUpgradeItem{
	
	private String[] minerals = new String[] {"scrap", "scrap+", "iron","blonze","silver","gold","platinum","orichalcum","dragonic"};

	public ItemMinerals()
	{
		super();
		this.setCreativeTab(RuneCraftory.upgradeItems);
        	this.setRegistryName(new ResourceLocation(RFReference.MODID, "mineral" ));	
