...
public class ItemToolWateringCan extends ItemTool implements IRpUseItem, IItemBase, IItemWearable{
	...
	public ItemToolWateringCan(EnumToolTier tier) {
        ...
        this.setRegistryName(new ResourceLocation(RFReference.MODID, "wateringCan_" + tier.getName()));	
	...
	{
		this.element=EnumElement.WATER;
		switch(this.tier)
		{
			case SCRAP:
				this.stats.put(IRFAttributes.RFMAGICATT, 1);
				break;
			case IRON:
				this.stats.put(IRFAttributes.RFMAGICATT, 18);
				break;
			case SILVER:
				this.stats.put(IRFAttributes.RFMAGICATT, 35);
				break;
			case GOLD:
				this.stats.put(IRFAttributes.RFMAGICATT, 60);
				break;
			case PLATINUM:
				this.stats.put(IRFAttributes.RFDEFENCE, 40);
				this.stats.put(IRFAttributes.RFMAGICATT, 150);
				this.stats.put(IRFAttributes.RFMAGICDEF, 80);
				this.stats.put(IRFAttributes.RFDIZ, 5);
				this.stats.put(IRFAttributes.RFCRIT, 15);
				this.stats.put(IRFAttributes.RFSTUN, 80);
				break;
			default:
				break;
		}
