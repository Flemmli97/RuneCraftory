...
public abstract class DualBladeBase extends ItemSword implements IRpUseItem, IItemBase, IItemWearable{
	...
	public void onPlayerStoppedUsing(ItemStack stack, World worldIn, EntityLivingBase entityLiving, int timeLeft)
    {
		if(entityLiving instanceof EntityPlayer)
		{
			...
			if((this.getMaxItemUseDuration(stack) - timeLeft)>=this.getChargeTime()[0])
			{
				...
				this.levelSkill(player, 0, EnumSkills.DUAL);
				List<EntityLivingBase> entityList = RFCalculations.calculateEntitiesFromLook(player, this.getWeaponType().getRange()+2, this.getWeaponType().getAOE());
