...
public class ItemSpawnEgg extends Item{
	...
	public ItemSpawnEgg()
	{
		...
		this.setRegistryName(new ResourceLocation(RFReference.MODID, "spawn_egg"));
    ...
    public EnumActionResult onItemUse(EntityPlayer player, World world, BlockPos pos, EnumHand hand, EnumFacing facing, float hitX, float hitY, float hitZ)
    {
        ...
        else
        {
            ...
            EntityMobBase entity = (EntityMobBase) spawnCreature(getEntityIdFromItem(player.getHeldItem(hand)), world, (double)pos.getX() + 0.5D, (double)pos.getY() + d0, (double)pos.getZ() + 0.5D, level);
            if (entity != null)
            {
                if (!player.capabilities.isCreativeMode)
                {
        ...
        else
        {
            ...
            if (raytraceresult != null && raytraceresult.typeOfHit == RayTraceResult.Type.BLOCK)
            {
                ...
                else if (world.isBlockModifiable(player, blockpos) && player.canPlayerEdit(blockpos, raytraceresult.sideHit, player.getHeldItem(hand)))
                {
                     ...
                     EntityMobBase entity = (EntityMobBase) spawnCreature(getEntityIdFromItem(player.getHeldItem(hand)), world, (double)blockpos.getX() + 0.5D, (double)blockpos.getY(), (double)blockpos.getZ() + 0.5D, level);
    ...
    public static Entity spawnCreature(String entityName, World world, double x, double y, double z, int level)
    {
    		Entity entity = GateSpawning.entityFromString(world, entityName, level);
