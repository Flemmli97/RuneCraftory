...
public class OreDictInit {
	...
	public static void init()
	{
		...
		OreDictionary.registerOre("ingotIron", new ItemStack(ModItems.mineral, 1, 2));
		OreDictionary.registerOre("ingotBronze", new ItemStack(ModItems.mineral, 1, 3));
		OreDictionary.registerOre("ingotSilver", new ItemStack(ModItems.mineral, 1, 4));
		OreDictionary.registerOre("ingotGold", new ItemStack(ModItems.mineral, 1, 5));
		OreDictionary.registerOre("ingotPlatinum", new ItemStack(ModItems.mineral, 1, 6));
