...
public abstract class EntityMobBase extends EntityCreature  implements IEntityAdvanced, IMob{
	...
	private int baseXP, baseMoney, feedTimeOut;
	...
	{
		int neededXP = RFCalculations.xpAmountForLevelUp(this.level());
	...
	private void onLevelUp()
	{
		this.getAttributeMap().getAttributeInstance(SharedMonsterAttributes.MAX_HEALTH).setBaseValue(
				RFCalculations.onEntityLevelUp(baseValues.get(SharedMonsterAttributes.MAX_HEALTH), this.getAttributeMap().getAttributeInstance(SharedMonsterAttributes.MAX_HEALTH).getAttributeValue(), false, true));
		this.getAttributeMap().getAttributeInstance(ItemStats.RFATTACK).setBaseValue(
				RFCalculations.onEntityLevelUp(baseValues.get(ItemStats.RFATTACK), this.getAttributeMap().getAttributeInstance(ItemStats.RFATTACK).getAttributeValue(), false, false));
		this.getAttributeMap().getAttributeInstance(ItemStats.RFDEFENCE).setBaseValue(
				RFCalculations.onEntityLevelUp(baseValues.get(ItemStats.RFDEFENCE), this.getAttributeMap().getAttributeInstance(ItemStats.RFDEFENCE).getAttributeValue(), false, false));
		this.getAttributeMap().getAttributeInstance(ItemStats.RFMAGICATT).setBaseValue(
				RFCalculations.onEntityLevelUp(baseValues.get(ItemStats.RFMAGICATT), this.getAttributeMap().getAttributeInstance(ItemStats.RFMAGICATT).getAttributeValue(), false, false));
		this.getAttributeMap().getAttributeInstance(ItemStats.RFMAGICDEF).setBaseValue(
				RFCalculations.onEntityLevelUp(baseValues.get(ItemStats.RFMAGICDEF), this.getAttributeMap().getAttributeInstance(ItemStats.RFMAGICDEF).getAttributeValue(), false, false));
	...
	public boolean attackEntityAsMobWithElement(Entity entity, EnumElement element)
	{
		if(entity instanceof EntityLivingBase)
		{
	        ...
	        boolean flag = entity.attackEntityFrom(CustomDamage.doAttack(this, element, ignoreArmor?CustomDamage.DamageType.IGNOREDEF:CustomDamage.DamageType.NORMAL), damage);
	        if (flag)
	        {
	...
	{
		this.getAttributeMap().getAttributeInstance(SharedMonsterAttributes.MAX_HEALTH).setBaseValue(
				RFCalculations.initStatIncreaseLevel(baseValues.get(SharedMonsterAttributes.MAX_HEALTH), this.level(), false, true));
		this.getAttributeMap().getAttributeInstance(ItemStats.RFATTACK).setBaseValue(
				RFCalculations.initStatIncreaseLevel(baseValues.get(ItemStats.RFATTACK), this.level(), false, false));
		this.getAttributeMap().getAttributeInstance(ItemStats.RFDEFENCE).setBaseValue(
				RFCalculations.initStatIncreaseLevel(baseValues.get(ItemStats.RFDEFENCE), this.level(), false, false));
		this.getAttributeMap().getAttributeInstance(ItemStats.RFMAGICATT).setBaseValue(
				RFCalculations.initStatIncreaseLevel(baseValues.get(ItemStats.RFMAGICATT), this.level(), false, false));
		this.getAttributeMap().getAttributeInstance(ItemStats.RFMAGICDEF).setBaseValue(
				RFCalculations.initStatIncreaseLevel(baseValues.get(ItemStats.RFMAGICDEF), this.level(), false, false));
		this.setHealth(this.getMaxHealth());
	}
