...
public class EntityGate extends EntityLiving  implements IEntityBase{
	...
	public IEntityLivingData onInitialSpawn(DifficultyInstance difficulty, IEntityLivingData livingdata) {
		...
		this.getAttributeMap().getAttributeInstance(SharedMonsterAttributes.MAX_HEALTH).setBaseValue(
				RFCalculations.initStatIncreaseLevel((float) this.getAttributeMap().getAttributeInstance(SharedMonsterAttributes.MAX_HEALTH).getBaseValue(), this.dataManager.get(level), false, true));
		this.getAttributeMap().getAttributeInstance(ItemStats.RFDEFENCE).setBaseValue(
				RFCalculations.initStatIncreaseLevel((float) this.getAttributeMap().getAttributeInstance(ItemStats.RFDEFENCE).getBaseValue(), this.dataManager.get(level), false, false));
		this.getAttributeMap().getAttributeInstance(ItemStats.RFMAGICDEF).setBaseValue(
				RFCalculations.initStatIncreaseLevel((float) this.getAttributeMap().getAttributeInstance(ItemStats.RFMAGICDEF).getBaseValue(), this.dataManager.get(level), false, false));
