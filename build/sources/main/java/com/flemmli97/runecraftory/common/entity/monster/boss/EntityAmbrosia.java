...
public class EntityAmbrosia extends EntityBossBase{
	...
	protected void applyEntityAttributes() {
		...
		this.initiateBaseAttributes(SharedMonsterAttributes.MAX_HEALTH,32);
		...
		this.initiateBaseAttributes(ItemStats.RFDEFENCE,9.5);
		this.initiateBaseAttributes(ItemStats.RFMAGICATT,12.0);
		this.initiateBaseAttributes(ItemStats.RFMAGICDEF,8.0);
	}
