	...
	public void onUpdate()
    {
        ...
        for(EntityLivingBase e : list)
        {
        		if(!e.equals(this.owner))
        		{
        			if(this.owner!=null)
        			{
        				e.attackEntityFrom(CustomDamage.doAttack(this.owner, EnumElement.NONE, CustomDamage.DamageType.NORMAL, CustomDamage.KnockBackType.NONE), RFCalculations.getAttributeValue(this.owner, ItemStats.RFMAGICATT, null, null)/2.5F);
