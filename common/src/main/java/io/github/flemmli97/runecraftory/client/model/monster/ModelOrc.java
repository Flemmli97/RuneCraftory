...
public class ModelOrc<T extends EntityOrc> extends EntityModel<T> implements ExtendedModel, RideableModel<T>, IItemArmModel, SittingModel {
    ...
    public static final ModelLayerLocation LAYER_LOCATION = new ModelLayerLocation(RuneCraftory.modRes("orc"), "main");
    ...
    public ModelOrc(ModelPart root) {
        ...
        this.anim = AnimationManager.getInstance().getAnimation(RuneCraftory.modRes("orc"));
