...
public class Wooly extends LeapingMonster {
    ...
    protected static final EntityDataAccessor<Boolean> SHEARED = SynchedEntityData.defineId(Wooly.class, EntityDataSerializers.BOOLEAN);
    protected static final EntityDataAccessor<Boolean> SPAWNSHEARED = SynchedEntityData.defineId(Wooly.class, EntityDataSerializers.BOOLEAN);
    private final AnimationHandler<Wooly> animationHandler = new AnimationHandler<>(this, ANIMS);
    ...
    public ExtendedBehaviour<? extends BaseMonster> getCombatAI() {
        return AttackBehaviourBuilder.<BaseMonster>create()
                ...
                .prepareOptional(new SetWalkTargetToAttackTarget<BaseMonster>()
                        .closeEnoughDist(MonsterBehaviourUtils.closeEnough(3)), MonsterBehaviourUtils.moveTo())
                .end(1)
                .start(KICK).play(MonsterBehaviourUtils.cooldownedPlay())
                .prepareOptional(new SetWalkTargetAwayFromTarget<BaseMonster>().radius(5, 4), MonsterBehaviourUtils.moveTo())
                .end(1)
                .build()
