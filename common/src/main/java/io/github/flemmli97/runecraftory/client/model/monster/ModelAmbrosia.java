...
public class ModelAmbrosia<T extends EntityAmbrosia> extends EntityModel<T> implements ExtendedModel, RideableModel<T> {

    public static final ModelLayerLocation LAYER_LOCATION = new ModelLayerLocation(RuneCraftory.modRes("ambrosia"), "main");
    ...
    public ModelAmbrosia(ModelPart root) {
        ...
        this.anim = AnimationManager.getInstance().getAnimation(RuneCraftory.modRes("ambrosia"));
