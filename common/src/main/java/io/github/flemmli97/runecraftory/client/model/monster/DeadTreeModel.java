...
public class DeadTreeModel<T extends DeadTree> extends EntityModel<T> implements ExtendedModel, RideableModel<T> {

    public static final ResourceLocation LOCATION = RuneCraftory.modRes("entity/dead_tree");
