...
public class BlockCooking extends BlockCrafting {
    ...
    public static final VoxelShape[] shapesLeft = BlockCrafting.joinedOrDirs(ShapeBuilder.of(0, 0, 1, 16, 13, 16),
            ShapeBuilder.of(0, 13, 0, 16, 15, 16));
    public static final VoxelShape[] shapesRight = BlockCrafting.joinedOrDirs(ShapeBuilder.of(0, 0, 1, 16, 13, 16),
            ShapeBuilder.of(0, 13, 0, 16, 15, 16),
