...
public class SimpleEffect {
    ...
    public static final Codec<SimpleEffect> CODEC = RecordCodecBuilder.create(simpleEff -> simpleEff.group(
            BuiltInRegistries.MOB_EFFECT.holderByNameCodec().fieldOf("potion").forGetter(SimpleEffect::getPotion),
    ...
    public SimpleEffect(Holder<MobEffect> effect, int duration, int amplifier) {
        this.potion = effect;
