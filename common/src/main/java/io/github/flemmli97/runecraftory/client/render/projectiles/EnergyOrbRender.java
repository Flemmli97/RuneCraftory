...
public class EnergyOrbRender extends SimpleModelRenderer<HomingEnergyOrbEntity> implements RenderLayerParent<HomingEnergyOrbEntity, EntityModel<HomingEnergyOrbEntity>> {
