...
//        int buttonIndex = 1;
//        if (this.quest != null) {
//            this.addRenderableWidget(new Button(this.leftPos + x + xSize + 6, this.topPos + y, xSize, 20, Component.translatable(C2SNPCInteraction.Type.QUEST.translation), b -> {
...
//
//        if (this.isShopOpen)
//            this.addRenderableWidget(new Button(this.leftPos + x + (int) ((xSize + 5) * 0.5), this.topPos + y + 23 * 2, xSize, 20, Component.translatable(C2SNPCInteraction.Type.SHOP.translation), b -> this.handlePress(C2SNPCInteraction.Type.SHOP)));
//    }
//
