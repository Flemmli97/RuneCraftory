...
public class ModelFairy<T extends EntityFairy> extends EntityModel<T> implements ExtendedModel {
    ...
    public static LayerDefinition createBodyLayer() {
        ...
        PartDefinition body = partdefinition.addOrReplaceChild("body", CubeListBuilder.create().texOffs(27, 7).addBox(-3.0F, 1.0F, -1.5F, 6.0F, 8.0F, 3.0F, new CubeDeformation(0.0F)), PartPose.offsetAndRotation(0.0F, 6.0F, 0.0F, 0.2618F, 0.0F, 0.0F));
