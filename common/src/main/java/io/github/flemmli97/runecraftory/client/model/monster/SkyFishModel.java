...
public class SkyFishModel<T extends SkyFish> extends ExtendedEntityModel<T> implements RideableModel<T> {

    public static final ResourceLocation LOCATION = RuneCraftory.modRes("entity/sky_fish");
    ...
    public void setupAnim(T entity, float limbSwing, float limbSwingAmount, float ageInTicks, float netHeadYaw, float headPitch) {
        ...
        if (entity.deathTime <= 0 && !entity.playDeath()) {
            ...
            this.animation.get().doAnimation(this, "swim", entity.tickCount, partialTick, entity.interpolatedMoveTick(partialTick));
        }
