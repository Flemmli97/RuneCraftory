...
public class Marionetta extends BossMonster implements BoundEntityListListener {
    ...
    private static final ImmutableMap<String, BiConsumer<AnimationState, Marionetta>> ATTACK_HANDLER = createAnimationHandler(b -> {
        ...
        BiConsumer<AnimationState, Marionetta> trigger = (anim, entity) -> {
            if (anim.isAt("sound")) {
                entity.playSound(RuneCraftorySounds.ENTITY_MARIONETTA_ROAR.get(), 1, 1 + (entity.getRandom().nextFloat() - entity.getRandom().nextFloat()) * 0.2f);
            }
        };
        b.put(SPAWN, trigger);
        b.put(ANGRY, trigger);
    ...
    public ExtendedBehaviour<? extends BaseMonster> getCooldownAI() {
        return SelectableBehaviourBuilder.<BaseMonster>builder()
                ...
                .add(4, MonsterBehaviourUtils.ifCloserThan(12), new SetWalkTargetAwayFromTarget<BaseMonster>().minDist(3).radius(6), MonsterBehaviourUtils.moveTo())
