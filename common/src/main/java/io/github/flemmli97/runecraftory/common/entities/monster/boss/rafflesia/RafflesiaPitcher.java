...
public class RafflesiaPitcher extends RafflesiaPart {
    ...
    private final AnimationHandler<RafflesiaPitcher> animationHandler = new AnimationHandler<>(this, ANIMS);

    public RafflesiaPitcher(EntityType<? extends Mob> entityType, Level level) {
        super(entityType, level);
    }

    public RafflesiaPitcher(Level level, Rafflesia parent) {
        super(RuneCraftoryEntities.RAFFLESIA_PITCHER.get(), level, parent);
    }
