...
public class ModelHandonetta<T extends EntityHandonetta> extends EntityModel<T> implements ExtendedModel, RideableModel<T> {
    ...
    public static final ModelLayerLocation LAYER_LOCATION = new ModelLayerLocation(new ResourceLocation(RuneCraftory.MODID, "handonetta"), "main");
    ...
    public ModelHandonetta(ModelPart root) {
        ...
        this.anim = AnimationManager.getInstance().getAnimation(new ResourceLocation(RuneCraftory.MODID, "handonetta"));
