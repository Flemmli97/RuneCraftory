...
import io.github.flemmli97.runecraftory.client.model.monster.VeggieGhostModel;
...
public class VeggieGhostRender<T extends VeggieGhost> extends RenderMonster<T, VeggieGhostModel<T>> {

    public VeggieGhostRender(EntityRendererProvider.Context ctx, ResourceLocation texture) {
        super(ctx, new VeggieGhostModel<>(), texture, 0);
    }
    ...
    public boolean shouldRender(T entity, Frustum camera, double camX, double camY, double camZ) {
        ...
        if (anim != null && anim.is(VeggieGhost.VANISH)) {
