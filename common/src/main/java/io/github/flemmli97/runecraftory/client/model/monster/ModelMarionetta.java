...
public class ModelMarionetta<T extends EntityMarionetta> extends EntityModel<T> implements ExtendedModel, RideableModel<T> {
    ...
    public static final ResourceLocation LOCATION = RuneCraftory.modRes("marionetta");
    ...
    public void setupAnim(T entity, float limbSwing, float limbSwingAmount, float ageInTicks, float netHeadYaw, float headPitch) {
        ...
        this.anim.get().doAnimation(this, entity.getAnimationHandler(), partialTicks, a -> false, a -> a.is(EntityMarionetta.CHEST_ATTACK) && entity.caughtTarget() ? "chest_attack_hit" : a.getAnimation());
    }
