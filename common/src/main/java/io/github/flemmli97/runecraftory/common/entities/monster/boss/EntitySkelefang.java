...
public class EntitySkelefang extends BossMonster {
    ...
    public ExtendedBehaviour<? extends BaseMonster> getCombatAI() {
        return AttackBehaviourBuilder.<EntitySkelefang>create()
                ...
                .prepare(new SetWalkTargetToAttackTarget<EntitySkelefang>().closeEnoughDist(MonsterBehaviourUtils.closeEnough(4))).prepareOptional(new MoveToAttackTarget<>())
                .end(10)
                .start(MonsterBehaviourUtils.checkedAttack(TAIL_SLAP)).play(MonsterBehaviourUtils.cooldownedPlay())
                .condition(m -> m.remainingTailBones() > 10)
                .prepare(new SetWalkTargetToAttackTarget<EntitySkelefang>().closeEnoughDist(MonsterBehaviourUtils.closeEnough(4)))
                ...
                .prepare(new SetWalkTargetToAttackTarget<EntitySkelefang>().closeEnoughDist(MonsterBehaviourUtils.closeEnough(8)))
                .prepareOptional(new MoveToAttackTarget<>())
                .end(9)
                .start(MonsterBehaviourUtils.checkedAttack(SLASH)).play(MonsterBehaviourUtils.cooldownedPlay())
                .prepare(new SetWalkTargetToAttackTarget<EntitySkelefang>().closeEnoughDist(MonsterBehaviourUtils.closeEnough(3)))
                .prepareOptional(new MoveToAttackTarget<>())
                .end(9)
                .start(MonsterBehaviourUtils.checkedAttack(CHARGE)).play(MonsterBehaviourUtils.cooldownedPlay())
                .prepare(new SetWalkTargetToAttackTarget<EntitySkelefang>().closeEnoughDist(MonsterBehaviourUtils.closeEnough(7)))
                .prepareOptional(new MoveToAttackTarget<>())
                .end(11)
                .build();
    }
