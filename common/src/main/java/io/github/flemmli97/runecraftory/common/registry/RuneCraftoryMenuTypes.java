...
public class RuneCraftoryMenuTypes {
    ...
    public static final RegistryEntrySupplier<MenuType<?>, MenuType<ContainerCrafting>> CRAFTING_CONTAINER = CONTAINERS.register("crafting_container", () -> Platform.INSTANCE.menuType(ContainerCrafting::new, BlockPos.STREAM_CODEC.cast()));
    ...
    public static final RegistryEntrySupplier<MenuType<?>, MenuType<ContainerUpgrade>> UPGRADE_CONTAINER = CONTAINERS.register("upgrade_container", () -> Platform.INSTANCE.menuType(ContainerUpgrade::new, BlockPos.STREAM_CODEC.cast()));
