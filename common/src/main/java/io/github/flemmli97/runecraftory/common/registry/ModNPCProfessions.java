...
public class ModNPCProfessions {
    ...
    public static final RegistryEntrySupplier<NPCProfession, NPCProfession> SPELL_MERCHANT = register("spell_merchant", () -> new NPCProfession(new NPCProfession.Builder(ModPoiTypes.CASH_REGISTER.getKey())));
    public static final RegistryEntrySupplier<NPCProfession, NPCProfession> RUNE_ABILITIES_MERCHANT = register("rune_abilities_merchant", () -> new NPCProfession(new NPCProfession.Builder(ModPoiTypes.CASH_REGISTER.getKey())));
    public static final RegistryEntrySupplier<NPCProfession, NPCProfession> BATHHOUSE_ATTENDANT = register("bathhouse_attendant", () -> new BathhouseAttendant(new NPCProfession.Builder(ModPoiTypes.CASH_REGISTER.getKey()).noShop()));
