...
public abstract class RafflesiaPart extends Mob implements AnimatedEntity, OwnableEntity {
        ...
        if (!this.level().isClientSide && !this.firstTick) {
            if (this.getOwner() != null) {
                if (this.getOwner().isDeadOrDying() || this.getPartType().getPart.apply(this.getOwner()) != this)
                    ...
                    this.setPos(this.getOwner().position().add(Rafflesia.rotateVec(this.entityData.get(SPAWN_DIRECTION), this.offset())));
                }
    ...
    public Rafflesia getOwner() {
        ...
        if (uuid != null) {
            if (this.parent == null || !this.parent.isAlive()) {
                this.parent = EntityUtils.findFromUUID(Rafflesia.class, this.level(), uuid);
            }
        } else
            this.parent = null;
        return this.parent;
    ...
    public enum PartType {
        ...
        PartType(Function<Rafflesia, Entity> getPart) {
