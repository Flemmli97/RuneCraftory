...
public class ModParticles {
    ...
    public static final RegistryEntrySupplier<ParticleType<BlockStateParticleData>> BLOCK = PARTICLES.register("block", () -> new BlockParticleType(false));
    ...
    public static final RegistryEntrySupplier<ParticleType<SkelefangParticleData>> SKELEFANG_BONES = PARTICLES.register("skelefang_bones", () -> new GenericParticleType<>(false, SkelefangParticleData.DESERIALIZER, SkelefangParticleData.codec()));
    public static final RegistryEntrySupplier<ParticleType<DurationalParticleData>> DURATIONAL_PARTICLE = PARTICLES.register("particle_with_duration", () -> new GenericParticleType<>(false, DurationalParticleData.DESERIALIZER, DurationalParticleData.codec()));
