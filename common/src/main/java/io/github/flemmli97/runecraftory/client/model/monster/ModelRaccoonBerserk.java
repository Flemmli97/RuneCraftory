...
public class ModelRaccoonBerserk<T extends EntityRaccoon> extends ModelRaccoonBase<T> {
    ...
    public static final ModelLayerLocation LAYER_LOCATION = new ModelLayerLocation(RuneCraftory.modRes("raccoon_berserk"), "main");
    ...
    public ModelRaccoonBerserk(ModelPart root) {
        ...
        this.anim = AnimationManager.getInstance().getAnimation(RuneCraftory.modRes("raccoon_berserk"));
