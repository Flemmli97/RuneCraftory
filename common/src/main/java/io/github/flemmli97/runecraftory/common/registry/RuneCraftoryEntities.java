...
public class RuneCraftoryEntities {
    ...
    public static final RegistryEntrySupplier<EntityType<?>, EntityType<Wooly>> WOOLY = regMonster(EntityType.Builder.of(Wooly::new, MobCategory.MONSTER)
            ...
            new EntityProperties.Builder()
                    .putAttributes(Attributes.MAX_HEALTH, 18).putLevelGains(Attributes.MAX_HEALTH, 830)
                    .putAttributes(Attributes.ATTACK_DAMAGE, 3).putLevelGains(Attributes.ATTACK_DAMAGE, 310)
                    .putAttributes(RuneCraftoryAttributes.DEFENCE.asHolder(), 0).putLevelGains(RuneCraftoryAttributes.DEFENCE.asHolder(), 290)
                    .putAttributes(RuneCraftoryAttributes.MAGIC_ATTACK.asHolder(), 1).putLevelGains(RuneCraftoryAttributes.MAGIC_ATTACK.asHolder(), 280)
                    .putAttributes(RuneCraftoryAttributes.MAGIC_DEFENCE.asHolder(), 0).putLevelGains(RuneCraftoryAttributes.MAGIC_DEFENCE.asHolder(), 290)
    ...
    public static final RegistryEntrySupplier<EntityType<?>, EntityType<KingWooly>> KING_WOOLY = regMonster(EntityType.Builder.of(KingWooly::new, MobCategory.MONSTER)
            ...
            0xffffcc, 0xffffff,
            new EntityProperties.Builder()
                    .putAttributes(Attributes.MAX_HEALTH, 100).putLevelGains(Attributes.MAX_HEALTH, 850)
                    .putAttributes(Attributes.ATTACK_DAMAGE, 20).putLevelGains(Attributes.ATTACK_DAMAGE, 336)
                    .putAttributes(RuneCraftoryAttributes.DEFENCE.asHolder(), 6).putLevelGains(RuneCraftoryAttributes.DEFENCE.asHolder(), 305)
                    .putAttributes(RuneCraftoryAttributes.MAGIC_ATTACK.asHolder(), 14).putLevelGains(RuneCraftoryAttributes.MAGIC_ATTACK.asHolder(), 296)
                    .putAttributes(RuneCraftoryAttributes.MAGIC_DEFENCE.asHolder(), 6).putLevelGains(RuneCraftoryAttributes.MAGIC_DEFENCE.asHolder(), 305)
    ...
    public static final RegistryEntrySupplier<EntityType<?>, EntityType<Orc>> ORC = regMonster(EntityType.Builder.of(Orc::new, MobCategory.MONSTER)
            ...
            0x663300, 0xffbf80,
            new EntityProperties.Builder()
                    .putAttributes(Attributes.MAX_HEALTH, 20).putLevelGains(Attributes.MAX_HEALTH, 780)
                    .putAttributes(Attributes.ATTACK_DAMAGE, 9).putLevelGains(Attributes.ATTACK_DAMAGE, 327)
                    .putAttributes(RuneCraftoryAttributes.DEFENCE.asHolder(), 0).putLevelGains(RuneCraftoryAttributes.DEFENCE.asHolder(), 266)
                    .putAttributes(RuneCraftoryAttributes.MAGIC_ATTACK.asHolder(), 2).putLevelGains(RuneCraftoryAttributes.MAGIC_ATTACK.asHolder(), 295)
                    .putAttributes(RuneCraftoryAttributes.MAGIC_DEFENCE.asHolder(), 0).putLevelGains(RuneCraftoryAttributes.MAGIC_DEFENCE.asHolder(), 260)
    ...
    public static final RegistryEntrySupplier<EntityType<?>, EntityType<Orc>> HIGH_ORC = regMonster(EntityType.Builder.of(Orc::new, MobCategory.MONSTER)
            ...
            0x9f6c4e, 0x333e78,
            new EntityProperties.Builder()
                    .putAttributes(Attributes.MAX_HEALTH, 28).putLevelGains(Attributes.MAX_HEALTH, 805)
                    .putAttributes(Attributes.ATTACK_DAMAGE, 17).putLevelGains(Attributes.ATTACK_DAMAGE, 339)
                    .putAttributes(RuneCraftoryAttributes.DEFENCE.asHolder(), 5).putLevelGains(RuneCraftoryAttributes.DEFENCE.asHolder(), 281)
                    .putAttributes(RuneCraftoryAttributes.MAGIC_ATTACK.asHolder(), 7).putLevelGains(RuneCraftoryAttributes.MAGIC_ATTACK.asHolder(), 304)
                    .putAttributes(RuneCraftoryAttributes.MAGIC_DEFENCE.asHolder(), 5).putLevelGains(RuneCraftoryAttributes.MAGIC_DEFENCE.asHolder(), 279)
                    .putAttributes(RuneCraftoryAttributes.DIZZY.asHolder(), 3)
                    .putAttributes(RuneCraftoryAttributes.CRITICAL.asHolder(), 1)
                    .putAttributes(RuneCraftoryAttributes.CRITICAL_RESISTANCE.asHolder(), 5)
    ...
    public static final RegistryEntrySupplier<EntityType<?>, EntityType<Ant>> ANT = regMonster(EntityType.Builder.of(Ant::new, MobCategory.MONSTER)
            ...
            0x800000, 0x1a0000,
            new EntityProperties.Builder()
                    .putAttributes(Attributes.MAX_HEALTH, 22).putLevelGains(Attributes.MAX_HEALTH, 803)
                    .putAttributes(Attributes.ATTACK_DAMAGE, 7).putLevelGains(Attributes.ATTACK_DAMAGE, 317)
                    .putAttributes(RuneCraftoryAttributes.DEFENCE.asHolder(), 1).putLevelGains(RuneCraftoryAttributes.DEFENCE.asHolder(), 279)
                    .putAttributes(RuneCraftoryAttributes.MAGIC_ATTACK.asHolder(), 2).putLevelGains(RuneCraftoryAttributes.MAGIC_ATTACK.asHolder(), 268)
                    .putAttributes(RuneCraftoryAttributes.MAGIC_DEFENCE.asHolder(), 0).putLevelGains(RuneCraftoryAttributes.DEFENCE.asHolder(), 275)
                    .putAttributes(RuneCraftoryAttributes.DIZZY.asHolder(), 3)
                    .putAttributes(RuneCraftoryAttributes.CRITICAL.asHolder(), 1)
                    .putAttributes(RuneCraftoryAttributes.CRITICAL_RESISTANCE.asHolder(), 5)
                    .putAttributes(RuneCraftoryAttributes.WATER_RESISTANCE.asHolder(), -10)
    ...
    public static final RegistryEntrySupplier<EntityType<?>, EntityType<Ant>> KILLER_ANT = regMonster(EntityType.Builder.of(Ant::new, MobCategory.MONSTER)
            ...
            0x0f0e0e, 0x754848,
            new EntityProperties.Builder()
                    .putAttributes(Attributes.MAX_HEALTH, 28).putLevelGains(Attributes.MAX_HEALTH, 825)
                    .putAttributes(Attributes.ATTACK_DAMAGE, 16).putLevelGains(Attributes.ATTACK_DAMAGE, 332)
                    .putAttributes(RuneCraftoryAttributes.DEFENCE.asHolder(), 4).putLevelGains(RuneCraftoryAttributes.DEFENCE.asHolder(), 288)
                    .putAttributes(RuneCraftoryAttributes.MAGIC_ATTACK.asHolder(), 9).putLevelGains(RuneCraftoryAttributes.MAGIC_ATTACK.asHolder(), 271)
                    .putAttributes(RuneCraftoryAttributes.MAGIC_DEFENCE.asHolder(), 4).putLevelGains(RuneCraftoryAttributes.DEFENCE.asHolder(), 277)
                    .putAttributes(RuneCraftoryAttributes.DIZZY.asHolder(), 3)
                    .putAttributes(RuneCraftoryAttributes.CRITICAL.asHolder(), 1)
                    .putAttributes(RuneCraftoryAttributes.CRITICAL_RESISTANCE.asHolder(), 5)
    ...
    public static final RegistryEntrySupplier<EntityType<?>, EntityType<Beetle>> BEETLE = regMonster(EntityType.Builder.of(Beetle::new, MobCategory.MONSTER)
            ...
            0x9c6a43, 0x244a69,
            new EntityProperties.Builder()
                    .putAttributes(Attributes.MAX_HEALTH, 23).putLevelGains(Attributes.MAX_HEALTH, 798)
                    .putAttributes(Attributes.ATTACK_DAMAGE, 11).putLevelGains(Attributes.ATTACK_DAMAGE, 323)
                    .putAttributes(RuneCraftoryAttributes.DEFENCE.asHolder(), 0).putLevelGains(RuneCraftoryAttributes.DEFENCE.asHolder(), 269)
                    .putAttributes(RuneCraftoryAttributes.MAGIC_ATTACK.asHolder(), 3).putLevelGains(RuneCraftoryAttributes.MAGIC_ATTACK.asHolder(), 259)
                    .putAttributes(RuneCraftoryAttributes.MAGIC_DEFENCE.asHolder(), 0).putLevelGains(RuneCraftoryAttributes.MAGIC_DEFENCE.asHolder(), 264)
                    .putAttributes(RuneCraftoryAttributes.DIZZY.asHolder(), 3)
                    .putAttributes(RuneCraftoryAttributes.CRITICAL.asHolder(), 1)
                    .putAttributes(RuneCraftoryAttributes.CRITICAL_RESISTANCE.asHolder(), 5)
                    .putAttributes(RuneCraftoryAttributes.FIRE_RESISTANCE.asHolder(), -10)
    ...
    public static final RegistryEntrySupplier<EntityType<?>, EntityType<BigMuck>> BIG_MUCK = regMonster(EntityType.Builder.of(BigMuck::new, MobCategory.MONSTER)
            ...
            0xd7ce4a, 0xad5c25,
            new EntityProperties.Builder()
                    .putAttributes(Attributes.MAX_HEALTH, 20).putLevelGains(Attributes.MAX_HEALTH, 786)
                    .putAttributes(Attributes.ATTACK_DAMAGE, 8).putLevelGains(Attributes.ATTACK_DAMAGE, 284)
                    .putAttributes(RuneCraftoryAttributes.DEFENCE.asHolder(), 0).putLevelGains(RuneCraftoryAttributes.DEFENCE.asHolder(), 260)
                    .putAttributes(RuneCraftoryAttributes.MAGIC_ATTACK.asHolder(), 10).putLevelGains(RuneCraftoryAttributes.MAGIC_ATTACK.asHolder(), 325)
                    .putAttributes(RuneCraftoryAttributes.MAGIC_DEFENCE.asHolder(), 1).putLevelGains(RuneCraftoryAttributes.MAGIC_DEFENCE.asHolder(), 265)
                    .putAttributes(RuneCraftoryAttributes.DIZZY.asHolder(), 3)
                    .putAttributes(RuneCraftoryAttributes.CRITICAL.asHolder(), 1)
                    .putAttributes(RuneCraftoryAttributes.CRITICAL_RESISTANCE.asHolder(), 5)
                    .putAttributes(RuneCraftoryAttributes.LOVE_RESISTANCE.asHolder(), 10)
    ...
    public static final RegistryEntrySupplier<EntityType<?>, EntityType<TrickyMuck>> TRICKY_MUCK = regMonster(EntityType.Builder.of(TrickyMuck::new, MobCategory.MONSTER)
            ...
            0x207316, 0x90d681,
            new EntityProperties.Builder()
                    .putAttributes(Attributes.MAX_HEALTH, 29).putLevelGains(Attributes.MAX_HEALTH, 798)
                    .putAttributes(Attributes.ATTACK_DAMAGE, 13).putLevelGains(Attributes.ATTACK_DAMAGE, 304)
                    .putAttributes(RuneCraftoryAttributes.DEFENCE.asHolder(), 1).putLevelGains(RuneCraftoryAttributes.DEFENCE.asHolder(), 273)
                    .putAttributes(RuneCraftoryAttributes.MAGIC_ATTACK.asHolder(), 15).putLevelGains(RuneCraftoryAttributes.MAGIC_ATTACK.asHolder(), 341)
                    .putAttributes(RuneCraftoryAttributes.MAGIC_DEFENCE.asHolder(), 2).putLevelGains(RuneCraftoryAttributes.MAGIC_DEFENCE.asHolder(), 289)
                    .putAttributes(RuneCraftoryAttributes.DIZZY.asHolder(), 3)
                    .putAttributes(RuneCraftoryAttributes.CRITICAL.asHolder(), 1)
                    .putAttributes(RuneCraftoryAttributes.CRITICAL_RESISTANCE.asHolder(), 5)
                    .putAttributes(RuneCraftoryAttributes.EARTH_RESISTANCE.asHolder(), 15)
    ...
    public static final RegistryEntrySupplier<EntityType<?>, EntityType<Buffamoo>> BUFFAMOO = regMonster(EntityType.Builder.of(Buffamoo::new, MobCategory.MONSTER)
            ...
            0xd8d8d0, 0x4e4e4c,
            new EntityProperties.Builder()
                    .putAttributes(Attributes.MAX_HEALTH, 25).putLevelGains(Attributes.MAX_HEALTH, 806)
                    .putAttributes(Attributes.ATTACK_DAMAGE, 11).putLevelGains(Attributes.ATTACK_DAMAGE, 313)
                    .putAttributes(RuneCraftoryAttributes.DEFENCE.asHolder(), 1).putLevelGains(RuneCraftoryAttributes.DEFENCE.asHolder(), 272)
                    .putAttributes(RuneCraftoryAttributes.MAGIC_ATTACK.asHolder(), 6).putLevelGains(RuneCraftoryAttributes.MAGIC_ATTACK.asHolder(), 270)
                    .putAttributes(RuneCraftoryAttributes.MAGIC_DEFENCE.asHolder(), 0).putLevelGains(RuneCraftoryAttributes.MAGIC_DEFENCE.asHolder(), 272)
                    .putAttributes(RuneCraftoryAttributes.DIZZY.asHolder(), 3)
                    .putAttributes(RuneCraftoryAttributes.CRITICAL.asHolder(), 1)
                    .putAttributes(RuneCraftoryAttributes.CRITICAL_RESISTANCE.asHolder(), 5)
                    .putAttributes(RuneCraftoryAttributes.LOVE_RESISTANCE.asHolder(), 10)
    ...
    public static final RegistryEntrySupplier<EntityType<?>, EntityType<Buffamoo>> BUFFALOO = regMonster(EntityType.Builder.of(Buffamoo::new, MobCategory.MONSTER)
            ...
            0x8a8a5e, 0xb5b489,
            new EntityProperties.Builder()
                    .putAttributes(Attributes.MAX_HEALTH, 35).putLevelGains(Attributes.MAX_HEALTH, 821)
                    .putAttributes(Attributes.ATTACK_DAMAGE, 18).putLevelGains(Attributes.ATTACK_DAMAGE, 336)
                    .putAttributes(RuneCraftoryAttributes.DEFENCE.asHolder(), 2).putLevelGains(RuneCraftoryAttributes.DEFENCE.asHolder(), 293)
                    .putAttributes(RuneCraftoryAttributes.MAGIC_ATTACK.asHolder(), 11).putLevelGains(RuneCraftoryAttributes.MAGIC_ATTACK.asHolder(), 281)
                    .putAttributes(RuneCraftoryAttributes.MAGIC_DEFENCE.asHolder(), 2).putLevelGains(RuneCraftoryAttributes.MAGIC_DEFENCE.asHolder(), 293)
                    .putAttributes(RuneCraftoryAttributes.DIZZY.asHolder(), 3)
                    .putAttributes(RuneCraftoryAttributes.CRITICAL.asHolder(), 1)
                    .putAttributes(RuneCraftoryAttributes.CRITICAL_RESISTANCE.asHolder(), 5)
                    .putAttributes(RuneCraftoryAttributes.LOVE_RESISTANCE.asHolder(), -10)
    ...
    public static final RegistryEntrySupplier<EntityType<?>, EntityType<Chipsqueek>> CHIPSQUEEK = regMonster(EntityType.Builder.of(Chipsqueek::new, MobCategory.MONSTER)
            ...
            0xff3b5b, 0xf9ffbb,
            new EntityProperties.Builder()
                    .putAttributes(Attributes.MAX_HEALTH, 21).putLevelGains(Attributes.MAX_HEALTH, 789)
                    .putAttributes(Attributes.ATTACK_DAMAGE, 11).putLevelGains(Attributes.ATTACK_DAMAGE, 311)
                    .putAttributes(RuneCraftoryAttributes.DEFENCE.asHolder(), 0).putLevelGains(RuneCraftoryAttributes.DEFENCE.asHolder(), 263)
                    .putAttributes(RuneCraftoryAttributes.MAGIC_ATTACK.asHolder(), 7).putLevelGains(RuneCraftoryAttributes.MAGIC_ATTACK.asHolder(), 255)
                    .putAttributes(RuneCraftoryAttributes.MAGIC_DEFENCE.asHolder(), 1).putLevelGains(RuneCraftoryAttributes.MAGIC_DEFENCE.asHolder(), 260)
                    .putAttributes(RuneCraftoryAttributes.DIZZY.asHolder(), 3)
                    .putAttributes(RuneCraftoryAttributes.CRITICAL.asHolder(), 1)
                    .putAttributes(RuneCraftoryAttributes.CRITICAL_RESISTANCE.asHolder(), 5)
                    .putAttributes(RuneCraftoryAttributes.LOVE_RESISTANCE.asHolder(), 10)
    ...
    public static final RegistryEntrySupplier<EntityType<?>, EntityType<Chipsqueek>> FURPY = regMonster(EntityType.Builder.of(Chipsqueek::new, MobCategory.MONSTER)
            ...
            new EntityProperties.Builder()
                    .putAttributes(Attributes.MAX_HEALTH, 28).putLevelGains(Attributes.MAX_HEALTH, 805)
                    .putAttributes(Attributes.ATTACK_DAMAGE, 16).putLevelGains(Attributes.ATTACK_DAMAGE, 329)
                    .putAttributes(RuneCraftoryAttributes.DEFENCE.asHolder(), 3).putLevelGains(RuneCraftoryAttributes.DEFENCE.asHolder(), 287)
                    .putAttributes(RuneCraftoryAttributes.MAGIC_ATTACK.asHolder(), 9).putLevelGains(RuneCraftoryAttributes.MAGIC_ATTACK.asHolder(), 273)
                    .putAttributes(RuneCraftoryAttributes.MAGIC_DEFENCE.asHolder(), 3).putLevelGains(RuneCraftoryAttributes.MAGIC_DEFENCE.asHolder(), 281)
                    .putAttributes(RuneCraftoryAttributes.DIZZY.asHolder(), 3)
                    .putAttributes(RuneCraftoryAttributes.CRITICAL.asHolder(), 1)
                    .putAttributes(RuneCraftoryAttributes.CRITICAL_RESISTANCE.asHolder(), 5)
                    .putAttributes(RuneCraftoryAttributes.EARTH_RESISTANCE.asHolder(), 15)
    ...
    public static final RegistryEntrySupplier<EntityType<?>, EntityType<MineralSqueek>> MINERAL_SQUEEK = regMonster(EntityType.Builder.of(MineralSqueek::new, MobCategory.MONSTER)
            ...
            new EntityProperties.Builder()
                    ...
                    .putAttributes(Attributes.ATTACK_DAMAGE, 13).putLevelGains(Attributes.ATTACK_DAMAGE, 300)
                    .putAttributes(RuneCraftoryAttributes.DEFENCE.asHolder(), 0)
                    .putAttributes(RuneCraftoryAttributes.MAGIC_ATTACK.asHolder(), 7).putLevelGains(RuneCraftoryAttributes.MAGIC_ATTACK.asHolder(), 250)
    ...
    public static final RegistryEntrySupplier<EntityType<?>, EntityType<Cluckadoodle>> CLUCKADOODLE = regMonster(EntityType.Builder.of(Cluckadoodle::new, MobCategory.MONSTER)
            ...
            0xc2c2c2, 0xdc2121,
            new EntityProperties.Builder()
                    .putAttributes(Attributes.MAX_HEALTH, 19).putLevelGains(Attributes.MAX_HEALTH, 795)
                    .putAttributes(Attributes.ATTACK_DAMAGE, 13).putLevelGains(Attributes.ATTACK_DAMAGE, 315)
                    .putAttributes(RuneCraftoryAttributes.DEFENCE.asHolder(), 0).putLevelGains(RuneCraftoryAttributes.DEFENCE.asHolder(), 281)
                    .putAttributes(RuneCraftoryAttributes.MAGIC_ATTACK.asHolder(), 1).putLevelGains(RuneCraftoryAttributes.MAGIC_ATTACK.asHolder(), 250)
                    .putAttributes(RuneCraftoryAttributes.MAGIC_DEFENCE.asHolder(), 0).putLevelGains(RuneCraftoryAttributes.MAGIC_DEFENCE.asHolder(), 275)
                    .putAttributes(RuneCraftoryAttributes.DIZZY.asHolder(), 3)
                    .putAttributes(RuneCraftoryAttributes.CRITICAL.asHolder(), 1)
                    .putAttributes(RuneCraftoryAttributes.CRITICAL_RESISTANCE.asHolder(), 5)
    ...
    public static final RegistryEntrySupplier<EntityType<?>, EntityType<PommePomme>> POMME_POMME = regMonster(EntityType.Builder.of(PommePomme::new, MobCategory.MONSTER)
            ...
            0xff1c2b, 0xf7b4b8,
            new EntityProperties.Builder()
                    .putAttributes(Attributes.MAX_HEALTH, 24).putLevelGains(Attributes.MAX_HEALTH, 815)
                    .putAttributes(Attributes.ATTACK_DAMAGE, 10).putLevelGains(Attributes.ATTACK_DAMAGE, 298)
                    .putAttributes(RuneCraftoryAttributes.DEFENCE.asHolder(), 0).putLevelGains(RuneCraftoryAttributes.DEFENCE.asHolder(), 301)
                    .putAttributes(RuneCraftoryAttributes.MAGIC_ATTACK.asHolder(), 6).putLevelGains(RuneCraftoryAttributes.MAGIC_ATTACK.asHolder(), 265)
                    .putAttributes(RuneCraftoryAttributes.MAGIC_DEFENCE.asHolder(), 0).putLevelGains(RuneCraftoryAttributes.MAGIC_DEFENCE.asHolder(), 292)
                    .putAttributes(RuneCraftoryAttributes.DIZZY.asHolder(), 3)
                    .putAttributes(RuneCraftoryAttributes.CRITICAL.asHolder(), 1)
                    .putAttributes(RuneCraftoryAttributes.CRITICAL_RESISTANCE.asHolder(), 5)
                    .putAttributes(RuneCraftoryAttributes.EARTH_RESISTANCE.asHolder(), 15)
    ...
    public static final RegistryEntrySupplier<EntityType<?>, EntityType<PommePomme>> MINO = regMonster(EntityType.Builder.of(PommePomme::new, MobCategory.MONSTER)
            ...
            new EntityProperties.Builder()
                    .putAttributes(Attributes.MAX_HEALTH, 28).putLevelGains(Attributes.MAX_HEALTH, 825)
                    .putAttributes(Attributes.ATTACK_DAMAGE, 14).putLevelGains(Attributes.ATTACK_DAMAGE, 305)
                    .putAttributes(RuneCraftoryAttributes.DEFENCE.asHolder(), 2).putLevelGains(RuneCraftoryAttributes.DEFENCE.asHolder(), 318)
                    .putAttributes(RuneCraftoryAttributes.MAGIC_ATTACK.asHolder(), 8).putLevelGains(RuneCraftoryAttributes.MAGIC_ATTACK.asHolder(), 270)
                    .putAttributes(RuneCraftoryAttributes.MAGIC_DEFENCE.asHolder(), 2).putLevelGains(RuneCraftoryAttributes.MAGIC_DEFENCE.asHolder(), 309)
                    .putAttributes(RuneCraftoryAttributes.DIZZY.asHolder(), 3)
                    .putAttributes(RuneCraftoryAttributes.CRITICAL.asHolder(), 1)
                    .putAttributes(RuneCraftoryAttributes.CRITICAL_RESISTANCE.asHolder(), 5)
                    .putAttributes(RuneCraftoryAttributes.EARTH_RESISTANCE.asHolder(), 15)
    ...
    public static final RegistryEntrySupplier<EntityType<?>, EntityType<Nappie>> NAPPIE = regMonster(EntityType.Builder.of(Nappie::new, MobCategory.MONSTER)
            ...
            0xb4843c, 0x1b5a0d,
            new EntityProperties.Builder()
                    .putAttributes(Attributes.MAX_HEALTH, 30).putLevelGains(Attributes.MAX_HEALTH, 825)
                    .putAttributes(Attributes.ATTACK_DAMAGE, 13).putLevelGains(Attributes.ATTACK_DAMAGE, 299)
                    .putAttributes(RuneCraftoryAttributes.DEFENCE.asHolder(), 3).putLevelGains(RuneCraftoryAttributes.DEFENCE.asHolder(), 309)
                    .putAttributes(RuneCraftoryAttributes.MAGIC_ATTACK.asHolder(), 10).putLevelGains(RuneCraftoryAttributes.MAGIC_ATTACK.asHolder(), 297)
                    .putAttributes(RuneCraftoryAttributes.MAGIC_DEFENCE.asHolder(), 2).putLevelGains(RuneCraftoryAttributes.MAGIC_DEFENCE.asHolder(), 318)
                    .putAttributes(RuneCraftoryAttributes.DIZZY.asHolder(), 3)
                    .putAttributes(RuneCraftoryAttributes.CRITICAL.asHolder(), 1)
                    .putAttributes(RuneCraftoryAttributes.CRITICAL_RESISTANCE.asHolder(), 5)
                    .putAttributes(RuneCraftoryAttributes.EARTH_RESISTANCE.asHolder(), 15)
    ...
    public static final RegistryEntrySupplier<EntityType<?>, EntityType<Tortas>> TORTAS = regMonster(EntityType.Builder.of(Tortas::new, MobCategory.MONSTER)
            ...
            0x5c6682, 0xa5848c,
            new EntityProperties.Builder()
                    .putAttributes(Attributes.MAX_HEALTH, 28).putLevelGains(Attributes.MAX_HEALTH, 820)
                    .putAttributes(Attributes.ATTACK_DAMAGE, 15).putLevelGains(Attributes.ATTACK_DAMAGE, 319)
                    .putAttributes(RuneCraftoryAttributes.DEFENCE.asHolder(), 2).putLevelGains(RuneCraftoryAttributes.DEFENCE.asHolder(), 311)
                    .putAttributes(RuneCraftoryAttributes.MAGIC_ATTACK.asHolder(), 7).putLevelGains(RuneCraftoryAttributes.MAGIC_ATTACK.asHolder(), 258)
                    .putAttributes(RuneCraftoryAttributes.MAGIC_DEFENCE.asHolder(), 0).putLevelGains(RuneCraftoryAttributes.MAGIC_DEFENCE.asHolder(), 294)
                    .putAttributes(RuneCraftoryAttributes.DIZZY.asHolder(), 3)
                    .putAttributes(RuneCraftoryAttributes.CRITICAL.asHolder(), 1)
                    .putAttributes(RuneCraftoryAttributes.CRITICAL_RESISTANCE.asHolder(), 5)
                    .putAttributes(RuneCraftoryAttributes.FIRE_RESISTANCE.asHolder(), -25)
    ...
    public static final RegistryEntrySupplier<EntityType<?>, EntityType<SkyFish>> SKY_FISH = regMonster(EntityType.Builder.of(SkyFish::new, MobCategory.MONSTER)
            ...
            0x8fa4c5, 0x5a3536,
            new EntityProperties.Builder()
                    .putAttributes(Attributes.MAX_HEALTH, 23).putLevelGains(Attributes.MAX_HEALTH, 797)
                    .putAttributes(Attributes.ATTACK_DAMAGE, 9).putLevelGains(Attributes.ATTACK_DAMAGE, 253)
                    .putAttributes(RuneCraftoryAttributes.DEFENCE.asHolder(), 0).putLevelGains(RuneCraftoryAttributes.DEFENCE.asHolder(), 268)
                    .putAttributes(RuneCraftoryAttributes.MAGIC_ATTACK.asHolder(), 11).putLevelGains(RuneCraftoryAttributes.MAGIC_ATTACK.asHolder(), 335)
                    .putAttributes(RuneCraftoryAttributes.MAGIC_DEFENCE.asHolder(), 1).putLevelGains(RuneCraftoryAttributes.MAGIC_DEFENCE.asHolder(), 281)
                    .putAttributes(RuneCraftoryAttributes.DIZZY.asHolder(), 3)
                    .putAttributes(RuneCraftoryAttributes.CRITICAL.asHolder(), 1)
                    .putAttributes(RuneCraftoryAttributes.CRITICAL_RESISTANCE.asHolder(), 5)
                    .putAttributes(RuneCraftoryAttributes.FIRE_RESISTANCE.asHolder(), -25)
    ...
    public static final RegistryEntrySupplier<EntityType<?>, EntityType<Weagle>> WEAGLE = regMonster(EntityType.Builder.of(Weagle::new, MobCategory.MONSTER)
            ...
            new EntityProperties.Builder()
                    .putAttributes(Attributes.MAX_HEALTH, 22).putLevelGains(Attributes.MAX_HEALTH, 810)
                    .putAttributes(Attributes.ATTACK_DAMAGE, 11).putLevelGains(Attributes.ATTACK_DAMAGE, 305)
                    .putAttributes(RuneCraftoryAttributes.DEFENCE.asHolder(), 0).putLevelGains(RuneCraftoryAttributes.DEFENCE.asHolder(), 281)
                    .putAttributes(RuneCraftoryAttributes.MAGIC_ATTACK.asHolder(), 6).putLevelGains(RuneCraftoryAttributes.MAGIC_ATTACK.asHolder(), 260)
                    .putAttributes(RuneCraftoryAttributes.MAGIC_DEFENCE.asHolder(), 1).putLevelGains(RuneCraftoryAttributes.MAGIC_DEFENCE.asHolder(), 277)
                    .putAttributes(RuneCraftoryAttributes.DIZZY.asHolder(), 3)
                    .putAttributes(RuneCraftoryAttributes.CRITICAL.asHolder(), 1)
                    .putAttributes(RuneCraftoryAttributes.CRITICAL_RESISTANCE.asHolder(), 5)
    ...
    public static final RegistryEntrySupplier<EntityType<?>, EntityType<Goblin>> GOBLIN = regMonster(EntityType.Builder.of(Goblin::new, MobCategory.MONSTER)
            ...
            0x21b322, 0x462f2a,
            new EntityProperties.Builder()
                    .putAttributes(Attributes.MAX_HEALTH, 24).putLevelGains(Attributes.MAX_HEALTH, 800)
                    .putAttributes(Attributes.ATTACK_DAMAGE, 13).putLevelGains(Attributes.ATTACK_DAMAGE, 317)
                    .putAttributes(RuneCraftoryAttributes.DEFENCE.asHolder(), 0).putLevelGains(RuneCraftoryAttributes.DEFENCE.asHolder(), 290)
                    .putAttributes(RuneCraftoryAttributes.MAGIC_ATTACK.asHolder(), 8).putLevelGains(RuneCraftoryAttributes.MAGIC_ATTACK.asHolder(), 278)
                    .putAttributes(RuneCraftoryAttributes.MAGIC_DEFENCE.asHolder(), 0).putLevelGains(RuneCraftoryAttributes.MAGIC_DEFENCE.asHolder(), 270)
                    .putAttributes(RuneCraftoryAttributes.DIZZY.asHolder(), 3)
                    .putAttributes(RuneCraftoryAttributes.CRITICAL.asHolder(), 1)
                    .putAttributes(RuneCraftoryAttributes.CRITICAL_RESISTANCE.asHolder(), 5)
                    .putAttributes(RuneCraftoryAttributes.EARTH_RESISTANCE.asHolder(), 10)
    ...
    public static final RegistryEntrySupplier<EntityType<?>, EntityType<GoblinPirate>> GOBLIN_PIRATE = regMonster(EntityType.Builder.of(GoblinPirate::new, MobCategory.MONSTER)
            ...
            0x484209, 0x29307f,
            new EntityProperties.Builder()
                    .putAttributes(Attributes.MAX_HEALTH, 26).putLevelGains(Attributes.MAX_HEALTH, 821)
                    .putAttributes(Attributes.ATTACK_DAMAGE, 17).putLevelGains(Attributes.ATTACK_DAMAGE, 338)
                    .putAttributes(RuneCraftoryAttributes.DEFENCE.asHolder(), 1).putLevelGains(RuneCraftoryAttributes.DEFENCE.asHolder(), 308)
                    .putAttributes(RuneCraftoryAttributes.MAGIC_ATTACK.asHolder(), 2).putLevelGains(RuneCraftoryAttributes.MAGIC_ATTACK.asHolder(), 287)
                    .putAttributes(RuneCraftoryAttributes.MAGIC_DEFENCE.asHolder(), 1).putLevelGains(RuneCraftoryAttributes.MAGIC_DEFENCE.asHolder(), 296)
                    .putAttributes(RuneCraftoryAttributes.DIZZY.asHolder(), 3)
                    .putAttributes(RuneCraftoryAttributes.CRITICAL.asHolder(), 1)
                    .putAttributes(RuneCraftoryAttributes.CRITICAL_RESISTANCE.asHolder(), 5)
                    .putAttributes(RuneCraftoryAttributes.EARTH_RESISTANCE.asHolder(), 10)
    ...
    public static final RegistryEntrySupplier<EntityType<?>, EntityType<GoblinPirate>> GOBLIN_CAPTAIN = regMonster(EntityType.Builder.of(GoblinPirate::new, MobCategory.MONSTER)
            ...
            0x452621, 0xe9e9e9,
            new EntityProperties.Builder()
                    .putAttributes(Attributes.MAX_HEALTH, 30).putLevelGains(Attributes.MAX_HEALTH, 844)
                    .putAttributes(Attributes.ATTACK_DAMAGE, 21).putLevelGains(Attributes.ATTACK_DAMAGE, 351)
                    .putAttributes(RuneCraftoryAttributes.DEFENCE.asHolder(), 2).putLevelGains(RuneCraftoryAttributes.DEFENCE.asHolder(), 305)
                    .putAttributes(RuneCraftoryAttributes.MAGIC_ATTACK.asHolder(), 14).putLevelGains(RuneCraftoryAttributes.MAGIC_ATTACK.asHolder(), 303)
                    .putAttributes(RuneCraftoryAttributes.MAGIC_DEFENCE.asHolder(), 1).putLevelGains(RuneCraftoryAttributes.MAGIC_DEFENCE.asHolder(), 299)
                    .putAttributes(RuneCraftoryAttributes.DIZZY.asHolder(), 3)
                    .putAttributes(RuneCraftoryAttributes.CRITICAL.asHolder(), 1)
                    .putAttributes(RuneCraftoryAttributes.CRITICAL_RESISTANCE.asHolder(), 5)
                    .putAttributes(RuneCraftoryAttributes.EARTH_RESISTANCE.asHolder(), 10)
    ...
    public static final RegistryEntrySupplier<EntityType<?>, EntityType<Duck>> DUCK = regMonster(EntityType.Builder.of(Duck::new, MobCategory.MONSTER)
            ...
            0xdabf33, 0x845242,
            new EntityProperties.Builder()
                    .putAttributes(Attributes.MAX_HEALTH, 23).putLevelGains(Attributes.MAX_HEALTH, 830)
                    .putAttributes(Attributes.ATTACK_DAMAGE, 13).putLevelGains(Attributes.ATTACK_DAMAGE, 313)
                    .putAttributes(RuneCraftoryAttributes.DEFENCE.asHolder(), 0).putLevelGains(RuneCraftoryAttributes.DEFENCE.asHolder(), 275)
                    .putAttributes(RuneCraftoryAttributes.MAGIC_ATTACK.asHolder(), 4).putLevelGains(RuneCraftoryAttributes.MAGIC_ATTACK.asHolder(), 290)
                    .putAttributes(RuneCraftoryAttributes.MAGIC_DEFENCE.asHolder(), 0).putLevelGains(RuneCraftoryAttributes.MAGIC_DEFENCE.asHolder(), 285)
                    .putAttributes(RuneCraftoryAttributes.DIZZY.asHolder(), 3)
                    .putAttributes(RuneCraftoryAttributes.CRITICAL.asHolder(), 1)
                    .putAttributes(RuneCraftoryAttributes.CRITICAL_RESISTANCE.asHolder(), 5)
                    .putAttributes(RuneCraftoryAttributes.EARTH_RESISTANCE.asHolder(), -10)
    ...
    public static final RegistryEntrySupplier<EntityType<?>, EntityType<Fairy>> FAIRY = regMonster(EntityType.Builder.of(Fairy::new, MobCategory.MONSTER)
            ...
            new EntityProperties.Builder()
                    .putAttributes(Attributes.MAX_HEALTH, 19).putLevelGains(Attributes.MAX_HEALTH, 785)
                    .putAttributes(Attributes.ATTACK_DAMAGE, 10).putLevelGains(Attributes.ATTACK_DAMAGE, 260)
                    .putAttributes(RuneCraftoryAttributes.DEFENCE.asHolder(), 0).putLevelGains(RuneCraftoryAttributes.DEFENCE.asHolder(), 265)
                    .putAttributes(RuneCraftoryAttributes.MAGIC_ATTACK.asHolder(), 12).putLevelGains(RuneCraftoryAttributes.MAGIC_ATTACK.asHolder(), 330)
                    .putAttributes(RuneCraftoryAttributes.MAGIC_DEFENCE.asHolder(), 2).putLevelGains(RuneCraftoryAttributes.MAGIC_DEFENCE.asHolder(), 278)
                    .putAttributes(RuneCraftoryAttributes.DIZZY.asHolder(), 3)
                    .putAttributes(RuneCraftoryAttributes.CRITICAL.asHolder(), 1)
                    .putAttributes(RuneCraftoryAttributes.CRITICAL_RESISTANCE.asHolder(), 5)
                    .putAttributes(RuneCraftoryAttributes.LOVE_RESISTANCE.asHolder(), 10)
    ...
    public static final RegistryEntrySupplier<EntityType<?>, EntityType<Ghost>> GHOST = regMonster(EntityType.Builder.of(Ghost::new, MobCategory.MONSTER)
            ...
            new EntityProperties.Builder()
                    .putAttributes(Attributes.MAX_HEALTH, 23).putLevelGains(Attributes.MAX_HEALTH, 810)
                    .putAttributes(Attributes.ATTACK_DAMAGE, 10).putLevelGains(Attributes.ATTACK_DAMAGE, 321)
                    .putAttributes(RuneCraftoryAttributes.DEFENCE.asHolder(), 1).putLevelGains(RuneCraftoryAttributes.DEFENCE.asHolder(), 263)
                    .putAttributes(RuneCraftoryAttributes.MAGIC_ATTACK.asHolder(), 10).putLevelGains(RuneCraftoryAttributes.MAGIC_ATTACK.asHolder(), 313)
                    .putAttributes(RuneCraftoryAttributes.MAGIC_DEFENCE.asHolder(), 1).putLevelGains(RuneCraftoryAttributes.MAGIC_DEFENCE.asHolder(), 270)
                    .putAttributes(RuneCraftoryAttributes.DIZZY.asHolder(), 3)
                    .putAttributes(RuneCraftoryAttributes.CRITICAL.asHolder(), 1)
                    .putAttributes(RuneCraftoryAttributes.CRITICAL_RESISTANCE.asHolder(), 5)
                    .putAttributes(RuneCraftoryAttributes.LIGHT_RESISTANCE.asHolder(), -10)
    ...
    public static final RegistryEntrySupplier<EntityType<?>, EntityType<Ghost>> GHOST_RAY = regMonster(EntityType.Builder.of(Ghost::new, MobCategory.MONSTER)
            ...
            new EntityProperties.Builder()
                    .putAttributes(Attributes.MAX_HEALTH, 45).putLevelGains(Attributes.MAX_HEALTH, 840)
                    .putAttributes(Attributes.ATTACK_DAMAGE, 18).putLevelGains(Attributes.ATTACK_DAMAGE, 346)
                    .putAttributes(RuneCraftoryAttributes.DEFENCE.asHolder(), 2).putLevelGains(RuneCraftoryAttributes.DEFENCE.asHolder(), 282)
                    .putAttributes(RuneCraftoryAttributes.MAGIC_ATTACK.asHolder(), 15).putLevelGains(RuneCraftoryAttributes.MAGIC_ATTACK.asHolder(), 339)
                    .putAttributes(RuneCraftoryAttributes.MAGIC_DEFENCE.asHolder(), 2).putLevelGains(RuneCraftoryAttributes.MAGIC_DEFENCE.asHolder(), 291)
                    .putAttributes(RuneCraftoryAttributes.DIZZY.asHolder(), 3)
                    .putAttributes(RuneCraftoryAttributes.CRITICAL.asHolder(), 1)
                    .putAttributes(RuneCraftoryAttributes.CRITICAL_RESISTANCE.asHolder(), 5)
                    .putAttributes(RuneCraftoryAttributes.LIGHT_RESISTANCE.asHolder(), -10)
    ...
    public static final RegistryEntrySupplier<EntityType<?>, EntityType<Spirit>> SPIRIT = regMonster(EntityType.Builder.of(Spirit::new, MobCategory.MONSTER)
            ...
            new EntityProperties.Builder()
                    .putAttributes(Attributes.MAX_HEALTH, 21).putLevelGains(Attributes.MAX_HEALTH, 797)
                    .putAttributes(Attributes.ATTACK_DAMAGE, 9).putLevelGains(Attributes.ATTACK_DAMAGE, 260)
                    .putAttributes(RuneCraftoryAttributes.DEFENCE.asHolder(), 1).putLevelGains(RuneCraftoryAttributes.DEFENCE.asHolder(), 260)
                    .putAttributes(RuneCraftoryAttributes.MAGIC_ATTACK.asHolder(), 13).putLevelGains(RuneCraftoryAttributes.MAGIC_ATTACK.asHolder(), 334)
                    .putAttributes(RuneCraftoryAttributes.MAGIC_DEFENCE.asHolder(), 2).putLevelGains(RuneCraftoryAttributes.MAGIC_DEFENCE.asHolder(), 274)
                    .putAttributes(RuneCraftoryAttributes.DIZZY.asHolder(), 3)
                    .putAttributes(RuneCraftoryAttributes.CRITICAL.asHolder(), 1)
                    .putAttributes(RuneCraftoryAttributes.CRITICAL_RESISTANCE.asHolder(), 5)
                    .putAttributes(RuneCraftoryAttributes.LIGHT_RESISTANCE.asHolder(), -10)
    ...
    public static final RegistryEntrySupplier<EntityType<?>, EntityType<Ignis>> IGNIS = regMonster(EntityType.Builder.of(Ignis::new, MobCategory.MONSTER)
            ...
            new EntityProperties.Builder()
                    .putAttributes(Attributes.MAX_HEALTH, 23).putLevelGains(Attributes.MAX_HEALTH, 802)
                    .putAttributes(Attributes.ATTACK_DAMAGE, 14).putLevelGains(Attributes.ATTACK_DAMAGE, 264)
                    .putAttributes(RuneCraftoryAttributes.DEFENCE.asHolder(), 2).putLevelGains(RuneCraftoryAttributes.DEFENCE.asHolder(), 269)
                    .putAttributes(RuneCraftoryAttributes.MAGIC_ATTACK.asHolder(), 15).putLevelGains(RuneCraftoryAttributes.MAGIC_ATTACK.asHolder(), 341)
                    .putAttributes(RuneCraftoryAttributes.MAGIC_DEFENCE.asHolder(), 3).putLevelGains(RuneCraftoryAttributes.MAGIC_DEFENCE.asHolder(), 278)
                    .putAttributes(RuneCraftoryAttributes.DIZZY.asHolder(), 3)
                    .putAttributes(RuneCraftoryAttributes.CRITICAL.asHolder(), 1)
                    .putAttributes(RuneCraftoryAttributes.CRITICAL_RESISTANCE.asHolder(), 5)
                    .putAttributes(RuneCraftoryAttributes.FIRE_RESISTANCE.asHolder(), 25)
    ...
    public static final RegistryEntrySupplier<EntityType<?>, EntityType<Spider>> SPIDER = regMonster(EntityType.Builder.of(Spider::new, MobCategory.MONSTER)
            ...
            0x6f6751, 0x404148,
            new EntityProperties.Builder()
                    .putAttributes(Attributes.MAX_HEALTH, 19).putLevelGains(Attributes.MAX_HEALTH, 789)
                    .putAttributes(Attributes.ATTACK_DAMAGE, 13).putLevelGains(Attributes.ATTACK_DAMAGE, 317)
                    .putAttributes(RuneCraftoryAttributes.DEFENCE.asHolder(), 0).putLevelGains(RuneCraftoryAttributes.DEFENCE.asHolder(), 277)
                    .putAttributes(RuneCraftoryAttributes.MAGIC_ATTACK.asHolder(), 9).putLevelGains(RuneCraftoryAttributes.MAGIC_ATTACK.asHolder(), 259)
                    .putAttributes(RuneCraftoryAttributes.MAGIC_DEFENCE.asHolder(), 0).putLevelGains(RuneCraftoryAttributes.MAGIC_DEFENCE.asHolder(), 272)
                    .putAttributes(RuneCraftoryAttributes.DIZZY.asHolder(), 3)
                    .putAttributes(RuneCraftoryAttributes.CRITICAL.asHolder(), 1)
                    .putAttributes(RuneCraftoryAttributes.CRITICAL_RESISTANCE.asHolder(), 5)
    ...
    public static final RegistryEntrySupplier<EntityType<?>, EntityType<Panther>> SHADOW_PANTHER = regMonster(EntityType.Builder.of(Panther::new, MobCategory.MONSTER)
            ...
            0x27375b, 0x733838,
            new EntityProperties.Builder()
                    .putAttributes(Attributes.MAX_HEALTH, 28).putLevelGains(Attributes.MAX_HEALTH, 815)
                    .putAttributes(Attributes.ATTACK_DAMAGE, 17).putLevelGains(Attributes.ATTACK_DAMAGE, 325)
                    .putAttributes(RuneCraftoryAttributes.DEFENCE.asHolder(), 2).putLevelGains(RuneCraftoryAttributes.DEFENCE.asHolder(), 275)
                    .putAttributes(RuneCraftoryAttributes.MAGIC_ATTACK.asHolder(), 8).putLevelGains(RuneCraftoryAttributes.MAGIC_ATTACK.asHolder(), 288)
                    .putAttributes(RuneCraftoryAttributes.MAGIC_DEFENCE.asHolder(), 2).putLevelGains(RuneCraftoryAttributes.MAGIC_DEFENCE.asHolder(), 283)
                    .putAttributes(RuneCraftoryAttributes.DIZZY.asHolder(), 3)
                    .putAttributes(RuneCraftoryAttributes.CRITICAL.asHolder(), 1)
                    .putAttributes(RuneCraftoryAttributes.CRITICAL_RESISTANCE.asHolder(), 5)
                    .putAttributes(RuneCraftoryAttributes.LIGHT_RESISTANCE.asHolder(), -10)
    ...
    public static final RegistryEntrySupplier<EntityType<?>, EntityType<Mimic>> MONSTER_BOX = regMonster(EntityType.Builder.of(Mimic::new, MobCategory.MONSTER)
            ...
            0xac935e, 0x462f10,
            new EntityProperties.Builder()
                    .putAttributes(Attributes.MAX_HEALTH, 30).putLevelGains(Attributes.MAX_HEALTH, 830)
                    .putAttributes(Attributes.ATTACK_DAMAGE, 15).putLevelGains(Attributes.ATTACK_DAMAGE, 315)
                    .putAttributes(RuneCraftoryAttributes.DEFENCE.asHolder(), 2).putLevelGains(RuneCraftoryAttributes.DEFENCE.asHolder(), 285)
                    .putAttributes(RuneCraftoryAttributes.MAGIC_ATTACK.asHolder(), 11).putLevelGains(RuneCraftoryAttributes.MAGIC_ATTACK.asHolder(), 315)
                    .putAttributes(RuneCraftoryAttributes.MAGIC_DEFENCE.asHolder(), 1).putLevelGains(RuneCraftoryAttributes.MAGIC_DEFENCE.asHolder(), 285)
                    .putAttributes(RuneCraftoryAttributes.DIZZY.asHolder(), 3)
                    .putAttributes(RuneCraftoryAttributes.CRITICAL.asHolder(), 1)
                    .putAttributes(RuneCraftoryAttributes.CRITICAL_RESISTANCE.asHolder(), 5)
                    .putAttributes(RuneCraftoryAttributes.LIGHT_RESISTANCE.asHolder(), 10)
    ...
    public static final RegistryEntrySupplier<EntityType<?>, EntityType<Mimic>> GOBBLE_BOX = regMonster(EntityType.Builder.of(Mimic::new, MobCategory.MONSTER)
            ...
            0x8f9cc4, 0x343843,
            new EntityProperties.Builder()
                    .putAttributes(Attributes.MAX_HEALTH, 50).putLevelGains(Attributes.MAX_HEALTH, 850)
                    .putAttributes(Attributes.ATTACK_DAMAGE, 20).putLevelGains(Attributes.ATTACK_DAMAGE, 329)
                    .putAttributes(RuneCraftoryAttributes.DEFENCE.asHolder(), 3).putLevelGains(RuneCraftoryAttributes.DEFENCE.asHolder(), 304)
                    .putAttributes(RuneCraftoryAttributes.MAGIC_ATTACK.asHolder(), 14).putLevelGains(RuneCraftoryAttributes.MAGIC_ATTACK.asHolder(), 329)
                    .putAttributes(RuneCraftoryAttributes.MAGIC_DEFENCE.asHolder(), 2).putLevelGains(RuneCraftoryAttributes.MAGIC_DEFENCE.asHolder(), 304)
                    .putAttributes(RuneCraftoryAttributes.DIZZY.asHolder(), 3)
                    .putAttributes(RuneCraftoryAttributes.CRITICAL.asHolder(), 1)
                    .putAttributes(RuneCraftoryAttributes.CRITICAL_RESISTANCE.asHolder(), 5)
    ...
    public static final RegistryEntrySupplier<EntityType<?>, EntityType<Hornet>> HORNET = regMonster(EntityType.Builder.of(Hornet::new, MobCategory.MONSTER)
            ...
            new EntityProperties.Builder()
                    .putAttributes(Attributes.MAX_HEALTH, 19).putLevelGains(Attributes.MAX_HEALTH, 799)
                    .putAttributes(Attributes.ATTACK_DAMAGE, 11).putLevelGains(Attributes.ATTACK_DAMAGE, 308)
                    .putAttributes(RuneCraftoryAttributes.DEFENCE.asHolder(), 3).putLevelGains(RuneCraftoryAttributes.DEFENCE.asHolder(), 276)
                    .putAttributes(RuneCraftoryAttributes.MAGIC_ATTACK.asHolder(), 6).putLevelGains(RuneCraftoryAttributes.MAGIC_ATTACK.asHolder(), 260)
                    .putAttributes(RuneCraftoryAttributes.MAGIC_DEFENCE.asHolder(), 4).putLevelGains(RuneCraftoryAttributes.MAGIC_DEFENCE.asHolder(), 279)
                    .putAttributes(RuneCraftoryAttributes.DIZZY.asHolder(), 3)
                    .putAttributes(RuneCraftoryAttributes.CRITICAL.asHolder(), 1)
                    .putAttributes(RuneCraftoryAttributes.CRITICAL_RESISTANCE.asHolder(), 5)
    ...
    public static final RegistryEntrySupplier<EntityType<?>, EntityType<Wolf>> SILVER_WOLF = regMonster(EntityType.Builder.of(Wolf::new, MobCategory.MONSTER)
            ...
            0x9bb9c3, 0x436ea1,
            new EntityProperties.Builder()
                    .putAttributes(Attributes.MAX_HEALTH, 23).putLevelGains(Attributes.MAX_HEALTH, 815)
                    .putAttributes(Attributes.ATTACK_DAMAGE, 12).putLevelGains(Attributes.ATTACK_DAMAGE, 317)
                    .putAttributes(RuneCraftoryAttributes.DEFENCE.asHolder(), 4).putLevelGains(RuneCraftoryAttributes.DEFENCE.asHolder(), 275)
                    .putAttributes(RuneCraftoryAttributes.MAGIC_ATTACK.asHolder(), 5).putLevelGains(RuneCraftoryAttributes.MAGIC_ATTACK.asHolder(), 260)
                    .putAttributes(RuneCraftoryAttributes.MAGIC_DEFENCE.asHolder(), 2).putLevelGains(RuneCraftoryAttributes.MAGIC_DEFENCE.asHolder(), 275)
                    .putAttributes(RuneCraftoryAttributes.DIZZY.asHolder(), 3)
                    .putAttributes(RuneCraftoryAttributes.CRITICAL.asHolder(), 1)
                    .putAttributes(RuneCraftoryAttributes.CRITICAL_RESISTANCE.asHolder(), 5)
    ...
    public static final RegistryEntrySupplier<EntityType<?>, EntityType<LeafBall>> LEAF_BALL = regMonster(EntityType.Builder.of(LeafBall::new, MobCategory.MONSTER)
            ...
            new EntityProperties.Builder()
                    .putAttributes(Attributes.MAX_HEALTH, 24).putLevelGains(Attributes.MAX_HEALTH, 820)
                    .putAttributes(Attributes.ATTACK_DAMAGE, 9).putLevelGains(Attributes.ATTACK_DAMAGE, 300)
                    .putAttributes(RuneCraftoryAttributes.DEFENCE.asHolder(), 3).putLevelGains(RuneCraftoryAttributes.DEFENCE.asHolder(), 265)
                    .putAttributes(RuneCraftoryAttributes.MAGIC_ATTACK.asHolder(), 12).putLevelGains(RuneCraftoryAttributes.MAGIC_ATTACK.asHolder(), 327)
                    .putAttributes(RuneCraftoryAttributes.MAGIC_DEFENCE.asHolder(), 4).putLevelGains(RuneCraftoryAttributes.MAGIC_DEFENCE.asHolder(), 265)
                    .putAttributes(RuneCraftoryAttributes.DIZZY.asHolder(), 3)
                    .putAttributes(RuneCraftoryAttributes.CRITICAL.asHolder(), 1)
                    .putAttributes(RuneCraftoryAttributes.CRITICAL_RESISTANCE.asHolder(), 5)
                    .putAttributes(RuneCraftoryAttributes.FIRE_RESISTANCE.asHolder(), -15)
    ...
    public static final RegistryEntrySupplier<EntityType<?>, EntityType<PalmCat>> PALM_CAT = regMonster(EntityType.Builder.of(PalmCat::new, MobCategory.MONSTER)
            ...
            0xc98f2d, 0xb46d28,
            new EntityProperties.Builder()
                    .putAttributes(Attributes.MAX_HEALTH, 24).putLevelGains(Attributes.MAX_HEALTH, 809)
                    .putAttributes(Attributes.ATTACK_DAMAGE, 13).putLevelGains(Attributes.ATTACK_DAMAGE, 330)
                    .putAttributes(RuneCraftoryAttributes.DEFENCE.asHolder(), 2).putLevelGains(RuneCraftoryAttributes.DEFENCE.asHolder(), 283)
                    .putAttributes(RuneCraftoryAttributes.MAGIC_ATTACK.asHolder(), 6).putLevelGains(RuneCraftoryAttributes.MAGIC_ATTACK.asHolder(), 280)
                    .putAttributes(RuneCraftoryAttributes.MAGIC_DEFENCE.asHolder(), 4).putLevelGains(RuneCraftoryAttributes.MAGIC_DEFENCE.asHolder(), 283)
                    .putAttributes(RuneCraftoryAttributes.DIZZY.asHolder(), 3)
                    .putAttributes(RuneCraftoryAttributes.CRITICAL.asHolder(), 1)
                    .putAttributes(RuneCraftoryAttributes.CRITICAL_RESISTANCE.asHolder(), 5)
                    .putAttributes(RuneCraftoryAttributes.EARTH_RESISTANCE.asHolder(), 15)
    ...
    public static final RegistryEntrySupplier<EntityType<?>, EntityType<PalmCat>> MALM_TIGER = regMonster(EntityType.Builder.of(PalmCat::new, MobCategory.MONSTER)
            ...
            0x8596ae, 0x3a5573,
            new EntityProperties.Builder()
                    .putAttributes(Attributes.MAX_HEALTH, 29).putLevelGains(Attributes.MAX_HEALTH, 811)
                    .putAttributes(Attributes.ATTACK_DAMAGE, 20).putLevelGains(Attributes.ATTACK_DAMAGE, 331)
                    .putAttributes(RuneCraftoryAttributes.DEFENCE.asHolder(), 3).putLevelGains(RuneCraftoryAttributes.DEFENCE.asHolder(), 277)
                    .putAttributes(RuneCraftoryAttributes.MAGIC_ATTACK.asHolder(), 11).putLevelGains(RuneCraftoryAttributes.MAGIC_ATTACK.asHolder(), 280)
                    .putAttributes(RuneCraftoryAttributes.MAGIC_DEFENCE.asHolder(), 4).putLevelGains(RuneCraftoryAttributes.MAGIC_DEFENCE.asHolder(), 288)
                    .putAttributes(RuneCraftoryAttributes.DIZZY.asHolder(), 3)
                    .putAttributes(RuneCraftoryAttributes.CRITICAL.asHolder(), 1)
                    .putAttributes(RuneCraftoryAttributes.CRITICAL_RESISTANCE.asHolder(), 5)
    ...
    public static final RegistryEntrySupplier<EntityType<?>, EntityType<FlowerLily>> FLOWER_LILY = regMonster(EntityType.Builder.of(FlowerLily::new, MobCategory.MONSTER)
            ...
            0xe8b3e7, 0x156e12,
            new EntityProperties.Builder()
                    .putAttributes(Attributes.MAX_HEALTH, 23).putLevelGains(Attributes.MAX_HEALTH, 813)
                    .putAttributes(Attributes.ATTACK_DAMAGE, 16).putLevelGains(Attributes.ATTACK_DAMAGE, 323)
                    .putAttributes(RuneCraftoryAttributes.DEFENCE.asHolder(), 1).putLevelGains(RuneCraftoryAttributes.DEFENCE.asHolder(), 298)
                    .putAttributes(RuneCraftoryAttributes.MAGIC_ATTACK.asHolder(), 12).putLevelGains(RuneCraftoryAttributes.MAGIC_ATTACK.asHolder(), 288)
                    .putAttributes(RuneCraftoryAttributes.MAGIC_DEFENCE.asHolder(), 1).putLevelGains(RuneCraftoryAttributes.MAGIC_DEFENCE.asHolder(), 282)
                    .putAttributes(RuneCraftoryAttributes.DIZZY.asHolder(), 3)
                    .putAttributes(RuneCraftoryAttributes.CRITICAL.asHolder(), 1)
                    .putAttributes(RuneCraftoryAttributes.CRITICAL_RESISTANCE.asHolder(), 5)
    ...
    public static final RegistryEntrySupplier<EntityType<?>, EntityType<FlowerLion>> FLOWER_LION = regMonster(EntityType.Builder.of(FlowerLion::new, MobCategory.MONSTER)
            ...
            0xf2ad7a, 0x893a1d,
            new EntityProperties.Builder()
                    .putAttributes(Attributes.MAX_HEALTH, 26).putLevelGains(Attributes.MAX_HEALTH, 820)
                    .putAttributes(Attributes.ATTACK_DAMAGE, 18).putLevelGains(Attributes.ATTACK_DAMAGE, 335)
                    .putAttributes(RuneCraftoryAttributes.DEFENCE.asHolder(), 2).putLevelGains(RuneCraftoryAttributes.DEFENCE.asHolder(), 308)
                    .putAttributes(RuneCraftoryAttributes.MAGIC_ATTACK.asHolder(), 14).putLevelGains(RuneCraftoryAttributes.MAGIC_ATTACK.asHolder(), 295)
                    .putAttributes(RuneCraftoryAttributes.MAGIC_DEFENCE.asHolder(), 2).putLevelGains(RuneCraftoryAttributes.MAGIC_DEFENCE.asHolder(), 301)
                    .putAttributes(RuneCraftoryAttributes.DIZZY.asHolder(), 3)
                    .putAttributes(RuneCraftoryAttributes.CRITICAL.asHolder(), 1)
                    .putAttributes(RuneCraftoryAttributes.CRITICAL_RESISTANCE.asHolder(), 5)
                    .putAttributes(RuneCraftoryAttributes.FIRE_RESISTANCE.asHolder(), -5)
    ...
    public static final RegistryEntrySupplier<EntityType<?>, EntityType<Scorpion>> SCORPION = regMonster(EntityType.Builder.of(Scorpion::new, MobCategory.MONSTER)
            ...
            0x606060, 0xacacac,
            new EntityProperties.Builder()
                    .putAttributes(Attributes.MAX_HEALTH, 21).putLevelGains(Attributes.MAX_HEALTH, 805)
                    .putAttributes(Attributes.ATTACK_DAMAGE, 13).putLevelGains(Attributes.ATTACK_DAMAGE, 321)
                    .putAttributes(RuneCraftoryAttributes.DEFENCE.asHolder(), 2).putLevelGains(RuneCraftoryAttributes.DEFENCE.asHolder(), 294)
                    .putAttributes(RuneCraftoryAttributes.MAGIC_ATTACK.asHolder(), 7).putLevelGains(RuneCraftoryAttributes.MAGIC_ATTACK.asHolder(), 270)
                    .putAttributes(RuneCraftoryAttributes.MAGIC_DEFENCE.asHolder(), 0).putLevelGains(RuneCraftoryAttributes.MAGIC_DEFENCE.asHolder(), 288)
                    .putAttributes(RuneCraftoryAttributes.DIZZY.asHolder(), 3)
                    .putAttributes(RuneCraftoryAttributes.CRITICAL.asHolder(), 1)
                    .putAttributes(RuneCraftoryAttributes.CRITICAL_RESISTANCE.asHolder(), 5)
    ...
    public static final RegistryEntrySupplier<EntityType<?>, EntityType<Troll>> TROLL = regMonster(EntityType.Builder.of(Troll::new, MobCategory.MONSTER)
            ...
            0xac924b, 0xcfcbbc,
            new EntityProperties.Builder()
                    .putAttributes(Attributes.MAX_HEALTH, 35).putLevelGains(Attributes.MAX_HEALTH, 840)
                    .putAttributes(Attributes.ATTACK_DAMAGE, 21).putLevelGains(Attributes.ATTACK_DAMAGE, 340)
                    .putAttributes(RuneCraftoryAttributes.DEFENCE.asHolder(), 3).putLevelGains(RuneCraftoryAttributes.DEFENCE.asHolder(), 295)
                    .putAttributes(RuneCraftoryAttributes.MAGIC_ATTACK.asHolder(), 2).putLevelGains(RuneCraftoryAttributes.MAGIC_ATTACK.asHolder(), 250)
                    .putAttributes(RuneCraftoryAttributes.MAGIC_DEFENCE.asHolder(), 2).putLevelGains(RuneCraftoryAttributes.MAGIC_DEFENCE.asHolder(), 285)
    ...
    public static final RegistryEntrySupplier<EntityType<?>, EntityType<VeggieGhost>> TOMATO_GHOST = regMonster(EntityType.Builder.of(VeggieGhost::new, MobCategory.MONSTER)
            ...
            new EntityProperties.Builder()
                    .putAttributes(Attributes.MAX_HEALTH, 22).putLevelGains(Attributes.MAX_HEALTH, 810)
                    .putAttributes(Attributes.ATTACK_DAMAGE, 16).putLevelGains(Attributes.ATTACK_DAMAGE, 310)
                    .putAttributes(RuneCraftoryAttributes.DEFENCE.asHolder(), 1).putLevelGains(RuneCraftoryAttributes.DEFENCE.asHolder(), 280)
                    .putAttributes(RuneCraftoryAttributes.MAGIC_ATTACK.asHolder(), 15).putLevelGains(RuneCraftoryAttributes.MAGIC_ATTACK.asHolder(), 310)
                    .putAttributes(RuneCraftoryAttributes.MAGIC_DEFENCE.asHolder(), 2).putLevelGains(RuneCraftoryAttributes.MAGIC_DEFENCE.asHolder(), 280)
                    .putAttributes(RuneCraftoryAttributes.DIZZY.asHolder(), 3)
                    .putAttributes(RuneCraftoryAttributes.CRITICAL.asHolder(), 1)
                    .putAttributes(RuneCraftoryAttributes.CRITICAL_RESISTANCE.asHolder(), 5)
                    .putAttributes(RuneCraftoryAttributes.WIND_RESISTANCE.asHolder(), -5)
    ...
    public static final RegistryEntrySupplier<EntityType<?>, EntityType<Mage>> LITTLE_EMPEROR = regMonster(EntityType.Builder.of(Mage::new, MobCategory.MONSTER)
            ...
            0x49ab5f, 0xdedede,
            new EntityProperties.Builder()
                    .putAttributes(Attributes.MAX_HEALTH, 21).putLevelGains(Attributes.MAX_HEALTH, 820)
                    .putAttributes(Attributes.ATTACK_DAMAGE, 13).putLevelGains(Attributes.ATTACK_DAMAGE, 308)
                    .putAttributes(RuneCraftoryAttributes.DEFENCE.asHolder(), 1).putLevelGains(RuneCraftoryAttributes.DEFENCE.asHolder(), 275)
                    .putAttributes(RuneCraftoryAttributes.MAGIC_ATTACK.asHolder(), 16).putLevelGains(RuneCraftoryAttributes.MAGIC_ATTACK.asHolder(), 321)
                    .putAttributes(RuneCraftoryAttributes.MAGIC_DEFENCE.asHolder(), 4).putLevelGains(RuneCraftoryAttributes.MAGIC_DEFENCE.asHolder(), 302)
                    .putAttributes(RuneCraftoryAttributes.DIZZY.asHolder(), 3)
                    .putAttributes(RuneCraftoryAttributes.CRITICAL.asHolder(), 1)
                    .putAttributes(RuneCraftoryAttributes.CRITICAL_RESISTANCE.asHolder(), 5)
                    .putAttributes(RuneCraftoryAttributes.LIGHT_RESISTANCE.asHolder(), 15)
    ...
    public static final RegistryEntrySupplier<EntityType<?>, EntityType<Demon>> DEMON = regMonster(EntityType.Builder.of(Demon::new, MobCategory.MONSTER)
            ...
            0xba8b84, 0x6a5450,
            new EntityProperties.Builder()
                    .putAttributes(Attributes.MAX_HEALTH, 27).putLevelGains(Attributes.MAX_HEALTH, 815)
                    .putAttributes(Attributes.ATTACK_DAMAGE, 19).putLevelGains(Attributes.ATTACK_DAMAGE, 314)
                    .putAttributes(RuneCraftoryAttributes.DEFENCE.asHolder(), 3).putLevelGains(RuneCraftoryAttributes.DEFENCE.asHolder(), 285)
                    .putAttributes(RuneCraftoryAttributes.MAGIC_ATTACK.asHolder(), 15).putLevelGains(RuneCraftoryAttributes.MAGIC_ATTACK.asHolder(), 319)
                    .putAttributes(RuneCraftoryAttributes.MAGIC_DEFENCE.asHolder(), 4).putLevelGains(RuneCraftoryAttributes.MAGIC_DEFENCE.asHolder(), 285)
                    .putAttributes(RuneCraftoryAttributes.DIZZY.asHolder(), 3)
                    .putAttributes(RuneCraftoryAttributes.CRITICAL.asHolder(), 1)
                    .putAttributes(RuneCraftoryAttributes.CRITICAL_RESISTANCE.asHolder(), 5)
                    .putAttributes(RuneCraftoryAttributes.LIGHT_RESISTANCE.asHolder(), -15)
    ...
    public static final RegistryEntrySupplier<EntityType<?>, EntityType<Demon>> ARCH_DEMON = regMonster(EntityType.Builder.of(Demon::new, MobCategory.MONSTER)
            ...
            0x9f6a63, 0x372321,
            new EntityProperties.Builder()
                    .putAttributes(Attributes.MAX_HEALTH, 40).putLevelGains(Attributes.MAX_HEALTH, 840)
                    .putAttributes(Attributes.ATTACK_DAMAGE, 22).putLevelGains(Attributes.ATTACK_DAMAGE, 329)
                    .putAttributes(RuneCraftoryAttributes.DEFENCE.asHolder(), 3).putLevelGains(RuneCraftoryAttributes.DEFENCE.asHolder(), 294)
                    .putAttributes(RuneCraftoryAttributes.MAGIC_ATTACK.asHolder(), 18).putLevelGains(RuneCraftoryAttributes.MAGIC_ATTACK.asHolder(), 334)
                    .putAttributes(RuneCraftoryAttributes.MAGIC_DEFENCE.asHolder(), 5).putLevelGains(RuneCraftoryAttributes.MAGIC_DEFENCE.asHolder(), 294)
                    .putAttributes(RuneCraftoryAttributes.DIZZY.asHolder(), 3)
                    .putAttributes(RuneCraftoryAttributes.CRITICAL.asHolder(), 1)
                    .putAttributes(RuneCraftoryAttributes.CRITICAL_RESISTANCE.asHolder(), 5)
                    .putAttributes(RuneCraftoryAttributes.LIGHT_RESISTANCE.asHolder(), -10)
    ...
    public static final RegistryEntrySupplier<EntityType<?>, EntityType<Minotaur>> MINOTAUR = regMonster(EntityType.Builder.of(Minotaur::new, MobCategory.MONSTER)
            ...
            0x61423d, 0x2c2825,
            new EntityProperties.Builder()
                    .putAttributes(Attributes.MAX_HEALTH, 40).putLevelGains(Attributes.MAX_HEALTH, 825)
                    .putAttributes(Attributes.ATTACK_DAMAGE, 23).putLevelGains(Attributes.ATTACK_DAMAGE, 340)
                    .putAttributes(RuneCraftoryAttributes.DEFENCE.asHolder(), 4).putLevelGains(RuneCraftoryAttributes.DEFENCE.asHolder(), 295)
                    .putAttributes(RuneCraftoryAttributes.MAGIC_ATTACK.asHolder(), 12).putLevelGains(RuneCraftoryAttributes.MAGIC_ATTACK.asHolder(), 280)
                    .putAttributes(RuneCraftoryAttributes.MAGIC_DEFENCE.asHolder(), 3).putLevelGains(RuneCraftoryAttributes.MAGIC_DEFENCE.asHolder(), 285)
                    .putAttributes(RuneCraftoryAttributes.DIZZY.asHolder(), 3)
                    .putAttributes(RuneCraftoryAttributes.CRITICAL.asHolder(), 1)
                    .putAttributes(RuneCraftoryAttributes.CRITICAL_RESISTANCE.asHolder(), 5)
                    .xp(35).tamingChance(0.05f),
    ...
    public static final RegistryEntrySupplier<EntityType<?>, EntityType<Minotaur>> MINOTAUR_KING = regMonster(EntityType.Builder.of(Minotaur::new, MobCategory.MONSTER)
            ...
            0x344a53, 0x907822,
            new EntityProperties.Builder()
                    .putAttributes(Attributes.MAX_HEALTH, 70).putLevelGains(Attributes.MAX_HEALTH, 850)
                    .putAttributes(Attributes.ATTACK_DAMAGE, 30).putLevelGains(Attributes.ATTACK_DAMAGE, 355)
                    .putAttributes(RuneCraftoryAttributes.DEFENCE.asHolder(), 5).putLevelGains(RuneCraftoryAttributes.DEFENCE.asHolder(), 306)
                    .putAttributes(RuneCraftoryAttributes.MAGIC_ATTACK.asHolder(), 12).putLevelGains(RuneCraftoryAttributes.MAGIC_ATTACK.asHolder(), 285)
                    .putAttributes(RuneCraftoryAttributes.MAGIC_DEFENCE.asHolder(), 5).putLevelGains(RuneCraftoryAttributes.MAGIC_DEFENCE.asHolder(), 298)
                    .putAttributes(RuneCraftoryAttributes.DIZZY.asHolder(), 3)
                    .putAttributes(RuneCraftoryAttributes.CRITICAL.asHolder(), 1)
                    .putAttributes(RuneCraftoryAttributes.CRITICAL_RESISTANCE.asHolder(), 5)
                    .xp(35).tamingChance(0.05f),
    ...
    public static final RegistryEntrySupplier<EntityType<?>, EntityType<Chimera>> CHIMERA = regBoss(EntityType.Builder.of(Chimera::new, MobCategory.MONSTER)
            ...
            0x536983, 0xaaa7c8,
            new EntityProperties.Builder()
                    .putAttributes(Attributes.MAX_HEALTH, 315).putLevelGains(Attributes.MAX_HEALTH, 1015)
                    .putAttributes(Attributes.ATTACK_DAMAGE, 17).putLevelGains(Attributes.ATTACK_DAMAGE, 352)
                    .putAttributes(RuneCraftoryAttributes.DEFENCE.asHolder(), 4).putLevelGains(RuneCraftoryAttributes.DEFENCE.asHolder(), 292)
                    .putAttributes(RuneCraftoryAttributes.MAGIC_ATTACK.asHolder(), 11).putLevelGains(RuneCraftoryAttributes.MAGIC_ATTACK.asHolder(), 339)
                    .putAttributes(RuneCraftoryAttributes.MAGIC_DEFENCE.asHolder(), 3).putLevelGains(RuneCraftoryAttributes.MAGIC_DEFENCE.asHolder(), 298)
    ...
    public static final RegistryEntrySupplier<EntityType<?>, EntityType<Rafflesia>> RAFFLESIA = regBoss(EntityType.Builder.of(Rafflesia::new, MobCategory.MONSTER)
            ...
            0x9b58ba, 0x0a8414,
            new EntityProperties.Builder()
                    .putAttributes(Attributes.MAX_HEALTH, 330).putLevelGains(Attributes.MAX_HEALTH, 1025)
                    .putAttributes(Attributes.ATTACK_DAMAGE, 11).putLevelGains(Attributes.ATTACK_DAMAGE, 321)
                    .putAttributes(RuneCraftoryAttributes.DEFENCE.asHolder(), 4).putLevelGains(RuneCraftoryAttributes.DEFENCE.asHolder(), 288)
                    .putAttributes(RuneCraftoryAttributes.MAGIC_ATTACK.asHolder(), 13).putLevelGains(RuneCraftoryAttributes.MAGIC_ATTACK.asHolder(), 341)
                    .putAttributes(RuneCraftoryAttributes.MAGIC_DEFENCE.asHolder(), 6).putLevelGains(RuneCraftoryAttributes.MAGIC_DEFENCE.asHolder(), 299)
                    .putAttributes(Attributes.ARMOR, 6).putAttributes(Attributes.ARMOR_TOUGHNESS, 3)
                    .putAttributes(RuneCraftoryAttributes.EARTH_RESISTANCE.asHolder(), 15)
                    .putAttributes(RuneCraftoryAttributes.WATER_RESISTANCE.asHolder(), 15)
                    .putAttributes(RuneCraftoryAttributes.FIRE_RESISTANCE.asHolder(), 15)
                    .putAttributes(RuneCraftoryAttributes.WIND_RESISTANCE.asHolder(), -25)
    ...
    public static final RegistryEntrySupplier<EntityType<?>, EntityType<Grimoire>> GRIMOIRE = regBoss(EntityType.Builder.of(Grimoire::new, MobCategory.MONSTER)
            ...
            0x3b785c, 0x2e4d3f,
            new EntityProperties.Builder()
                    .putAttributes(Attributes.MAX_HEALTH, 350).putLevelGains(Attributes.MAX_HEALTH, 1025)
                    .putAttributes(Attributes.ATTACK_DAMAGE, 18).putLevelGains(Attributes.ATTACK_DAMAGE, 342)
                    .putAttributes(RuneCraftoryAttributes.DEFENCE.asHolder(), 5.5).putLevelGains(RuneCraftoryAttributes.DEFENCE.asHolder(), 303)
                    .putAttributes(RuneCraftoryAttributes.MAGIC_ATTACK.asHolder(), 14).putLevelGains(RuneCraftoryAttributes.MAGIC_ATTACK.asHolder(), 328)
                    .putAttributes(RuneCraftoryAttributes.MAGIC_DEFENCE.asHolder(), 4).putLevelGains(RuneCraftoryAttributes.MAGIC_DEFENCE.asHolder(), 303)
                    .putAttributes(Attributes.ARMOR, 12).putAttributes(Attributes.ARMOR_TOUGHNESS, 7)
                    .putAttributes(RuneCraftoryAttributes.EARTH_RESISTANCE.asHolder(), 10)
    ...
    public static final RegistryEntrySupplier<EntityType<?>, EntityType<DeadTree>> DEAD_TREE = regBoss(EntityType.Builder.of(DeadTree::new, MobCategory.MONSTER)
            ...
            0x3e4a40, 0x227904,
            new EntityProperties.Builder()
                    .putAttributes(Attributes.MAX_HEALTH, 300).putLevelGains(Attributes.MAX_HEALTH, 1040)
                    .putAttributes(Attributes.ATTACK_DAMAGE, 17).putLevelGains(Attributes.ATTACK_DAMAGE, 337)
                    .putAttributes(RuneCraftoryAttributes.DEFENCE.asHolder(), 4).putLevelGains(RuneCraftoryAttributes.DEFENCE.asHolder(), 296)
                    .putAttributes(RuneCraftoryAttributes.MAGIC_ATTACK.asHolder(), 12).putLevelGains(RuneCraftoryAttributes.MAGIC_ATTACK.asHolder(), 332)
                    .putAttributes(RuneCraftoryAttributes.MAGIC_DEFENCE.asHolder(), 3).putLevelGains(RuneCraftoryAttributes.MAGIC_DEFENCE.asHolder(), 296)
                    .putAttributes(Attributes.ARMOR, 6).putAttributes(Attributes.ARMOR_TOUGHNESS, 2)
    ...
    public static final RegistryEntrySupplier<EntityType<?>, EntityType<Raccoon>> RACCOON = regBoss(EntityType.Builder.of(Raccoon::new, MobCategory.MONSTER)
            ...
            0xcb8055, 0x6d4342,
            new EntityProperties.Builder()
                    .putAttributes(Attributes.MAX_HEALTH, 290).putLevelGains(Attributes.MAX_HEALTH, 1015)
                    .putAttributes(Attributes.ATTACK_DAMAGE, 16).putLevelGains(Attributes.ATTACK_DAMAGE, 333)
                    .putAttributes(RuneCraftoryAttributes.DEFENCE.asHolder(), 4.5).putLevelGains(RuneCraftoryAttributes.DEFENCE.asHolder(), 299)
                    .putAttributes(RuneCraftoryAttributes.MAGIC_ATTACK.asHolder(), 12).putLevelGains(RuneCraftoryAttributes.MAGIC_ATTACK.asHolder(), 328)
                    .putAttributes(RuneCraftoryAttributes.MAGIC_DEFENCE.asHolder(), 3).putLevelGains(RuneCraftoryAttributes.MAGIC_DEFENCE.asHolder(), 305)
                    .putAttributes(Attributes.ARMOR, 5).putAttributes(Attributes.ARMOR_TOUGHNESS, 2)
                    .putAttributes(RuneCraftoryAttributes.EARTH_RESISTANCE.asHolder(), 25)
                    .putAttributes(RuneCraftoryAttributes.WIND_RESISTANCE.asHolder(), 25)
                    .putAttributes(RuneCraftoryAttributes.LOVE_RESISTANCE.asHolder(), -25)
                    .putAttributes(RuneCraftoryAttributes.CRITICAL_RESISTANCE.asHolder(), 25)
    ...
    public static final RegistryEntrySupplier<EntityType<?>, EntityType<Skelefang>> SKELEFANG = regBoss(EntityType.Builder.of(Skelefang::new, MobCategory.MONSTER)
            ...
            0x615237, 0xc2a982,
            new EntityProperties.Builder()
                    .putAttributes(Attributes.MAX_HEALTH, 225).putLevelGains(Attributes.MAX_HEALTH, 1000)
                    .putAttributes(Attributes.ATTACK_DAMAGE, 18).putLevelGains(Attributes.ATTACK_DAMAGE, 344)
                    .putAttributes(RuneCraftoryAttributes.DEFENCE.asHolder(), 5).putLevelGains(RuneCraftoryAttributes.DEFENCE.asHolder(), 311)
                    .putAttributes(RuneCraftoryAttributes.MAGIC_ATTACK.asHolder(), 15).putLevelGains(RuneCraftoryAttributes.MAGIC_ATTACK.asHolder(), 314)
                    .putAttributes(RuneCraftoryAttributes.MAGIC_DEFENCE.asHolder(), 4).putLevelGains(RuneCraftoryAttributes.MAGIC_DEFENCE.asHolder(), 287)
                    .putAttributes(Attributes.ARMOR, 7).putAttributes(Attributes.ARMOR_TOUGHNESS, 3)
                    .putAttributes(RuneCraftoryAttributes.FIRE_RESISTANCE.asHolder(), -25)
                    .putAttributes(RuneCraftoryAttributes.EARTH_RESISTANCE.asHolder(), 50)
    ...
    public static final RegistryEntrySupplier<EntityType<?>, EntityType<Ambrosia>> AMBROSIA = regBoss(EntityType.Builder.of(Ambrosia::new, MobCategory.MONSTER)
            ...
            0x00ff00, 0xe600e6,
            new EntityProperties.Builder()
                    .putAttributes(Attributes.MAX_HEALTH, 300).putLevelGains(Attributes.MAX_HEALTH, 1030)
                    .putAttributes(Attributes.ATTACK_DAMAGE, 14).putLevelGains(Attributes.ATTACK_DAMAGE, 325)
                    .putAttributes(RuneCraftoryAttributes.DEFENCE.asHolder(), 4).putLevelGains(RuneCraftoryAttributes.DEFENCE.asHolder(), 280)
                    .putAttributes(RuneCraftoryAttributes.MAGIC_ATTACK.asHolder(), 10).putLevelGains(RuneCraftoryAttributes.MAGIC_ATTACK.asHolder(), 330)
                    .putAttributes(RuneCraftoryAttributes.MAGIC_DEFENCE.asHolder(), 4).putLevelGains(RuneCraftoryAttributes.MAGIC_DEFENCE.asHolder(), 295)
                    .putAttributes(Attributes.ARMOR, 4).putAttributes(Attributes.ARMOR_TOUGHNESS, 2)
                    .putAttributes(RuneCraftoryAttributes.EARTH_RESISTANCE.asHolder(), 25)
                    .putAttributes(RuneCraftoryAttributes.WIND_RESISTANCE.asHolder(), -25)
                    .putAttributes(RuneCraftoryAttributes.LOVE_RESISTANCE.asHolder(), -25)
                    .putAttributes(RuneCraftoryAttributes.CRITICAL_RESISTANCE.asHolder(), 25)
    ...
    public static final RegistryEntrySupplier<EntityType<?>, EntityType<Thunderbolt>> THUNDERBOLT = regBoss(EntityType.Builder.of(Thunderbolt::new, MobCategory.MONSTER)
            ...
            0x212121, 0x2f1177,
            new EntityProperties.Builder()
                    .putAttributes(Attributes.MAX_HEALTH, 325).putLevelGains(Attributes.MAX_HEALTH, 1010)
                    .putAttributes(Attributes.ATTACK_DAMAGE, 18).putLevelGains(Attributes.ATTACK_DAMAGE, 330)
                    .putAttributes(RuneCraftoryAttributes.DEFENCE.asHolder(), 4).putLevelGains(RuneCraftoryAttributes.DEFENCE.asHolder(), 290)
                    .putAttributes(RuneCraftoryAttributes.MAGIC_ATTACK.asHolder(), 14).putLevelGains(RuneCraftoryAttributes.MAGIC_ATTACK.asHolder(), 322)
                    .putAttributes(RuneCraftoryAttributes.MAGIC_DEFENCE.asHolder(), 3).putLevelGains(RuneCraftoryAttributes.MAGIC_DEFENCE.asHolder(), 290)
                    .putAttributes(Attributes.ARMOR, 6).putAttributes(Attributes.ARMOR_TOUGHNESS, 4)
    ...
    public static final RegistryEntrySupplier<EntityType<?>, EntityType<Marionetta>> MARIONETTA = regBoss(EntityType.Builder.of(Marionetta::new, MobCategory.MONSTER)
            ...
            0xb86b13, 0xd8d7d7,
            new EntityProperties.Builder()
                    .putAttributes(Attributes.MAX_HEALTH, 320).putLevelGains(Attributes.MAX_HEALTH, 1020)
                    .putAttributes(Attributes.ATTACK_DAMAGE, 19).putLevelGains(Attributes.ATTACK_DAMAGE, 336)
                    .putAttributes(RuneCraftoryAttributes.DEFENCE.asHolder(), 5).putLevelGains(RuneCraftoryAttributes.DEFENCE.asHolder(), 297)
                    .putAttributes(RuneCraftoryAttributes.MAGIC_ATTACK.asHolder(), 14).putLevelGains(RuneCraftoryAttributes.MAGIC_ATTACK.asHolder(), 329)
                    .putAttributes(RuneCraftoryAttributes.MAGIC_DEFENCE.asHolder(), 4).putLevelGains(RuneCraftoryAttributes.MAGIC_DEFENCE.asHolder(), 297)
                    .putAttributes(Attributes.ARMOR, 8).putAttributes(Attributes.ARMOR_TOUGHNESS, 2)
    ...
    public static final RegistryEntrySupplier<EntityType<?>, EntityType<Handonetta>> HANDONETTA = regBoss(EntityType.Builder.of(Handonetta::new, MobCategory.MONSTER)
            ...
            new EntityProperties.Builder()
                    .putAttributes(Attributes.MAX_HEALTH, 300).putLevelGains(Attributes.MAX_HEALTH, 1010)
                    .putAttributes(Attributes.ATTACK_DAMAGE, 21).putLevelGains(Attributes.ATTACK_DAMAGE, 340)
                    .putAttributes(RuneCraftoryAttributes.DEFENCE.asHolder(), 4).putLevelGains(RuneCraftoryAttributes.DEFENCE.asHolder(), 295)
                    .putAttributes(RuneCraftoryAttributes.MAGIC_ATTACK.asHolder(), 15).putLevelGains(RuneCraftoryAttributes.MAGIC_ATTACK.asHolder(), 326)
                    .putAttributes(RuneCraftoryAttributes.MAGIC_DEFENCE.asHolder(), 4).putLevelGains(RuneCraftoryAttributes.MAGIC_DEFENCE.asHolder(), 295)
                    .putAttributes(Attributes.ARMOR, 4).putAttributes(Attributes.ARMOR_TOUGHNESS, 3)
                    .putAttributes(RuneCraftoryAttributes.DARK_RESISTANCE.asHolder(), 25)
                    .putAttributes(RuneCraftoryAttributes.LIGHT_RESISTANCE.asHolder(), -25)
                    .putAttributes(RuneCraftoryAttributes.CRITICAL_RESISTANCE.asHolder(), 25)
                    .putAttributes(RuneCraftoryAttributes.DRAIN_RESISTANCE.asHolder(), 30)
    ...
    public static final RegistryEntrySupplier<EntityType<?>, EntityType<Sano>> SANO = regBoss(EntityType.Builder.of(Sano::new, MobCategory.MONSTER)
            ...
            0xa18c4a, 0xa82626,
            new EntityProperties.Builder()
                    .putAttributes(Attributes.MAX_HEALTH, 275).putLevelGains(Attributes.MAX_HEALTH, 1050)
                    .putAttributes(Attributes.ATTACK_DAMAGE, 12).putLevelGains(Attributes.ATTACK_DAMAGE, 310)
                    .putAttributes(RuneCraftoryAttributes.DEFENCE.asHolder(), 6).putLevelGains(RuneCraftoryAttributes.DEFENCE.asHolder(), 309)
                    .putAttributes(RuneCraftoryAttributes.MAGIC_ATTACK.asHolder(), 14).putLevelGains(RuneCraftoryAttributes.MAGIC_ATTACK.asHolder(), 332)
                    .putAttributes(RuneCraftoryAttributes.MAGIC_DEFENCE.asHolder(), 5).putLevelGains(RuneCraftoryAttributes.MAGIC_DEFENCE.asHolder(), 299)
                    .putAttributes(Attributes.ARMOR, 10).putAttributes(Attributes.ARMOR_TOUGHNESS, 5)
                    .putAttributes(RuneCraftoryAttributes.FIRE_RESISTANCE.asHolder(), 50)
                    .putAttributes(RuneCraftoryAttributes.CRITICAL_RESISTANCE.asHolder(), 25)
                    .putAttributes(RuneCraftoryAttributes.DRAIN_RESISTANCE.asHolder(), 25)
                    .putAttributes(RuneCraftoryAttributes.DIZZY_RESISTANCE.asHolder(), 100)
    ...
    public static final RegistryEntrySupplier<EntityType<?>, EntityType<Uno>> UNO = regBoss(EntityType.Builder.of(Uno::new, MobCategory.MONSTER)
            ...
            new EntityProperties.Builder()
                    .putAttributes(Attributes.MAX_HEALTH, 275).putLevelGains(Attributes.MAX_HEALTH, 1050)
                    .putAttributes(Attributes.ATTACK_DAMAGE, 12).putLevelGains(Attributes.ATTACK_DAMAGE, 310)
                    .putAttributes(RuneCraftoryAttributes.DEFENCE.asHolder(), 5).putLevelGains(RuneCraftoryAttributes.DEFENCE.asHolder(), 309)
                    .putAttributes(RuneCraftoryAttributes.MAGIC_ATTACK.asHolder(), 14).putLevelGains(RuneCraftoryAttributes.MAGIC_ATTACK.asHolder(), 332)
                    .putAttributes(RuneCraftoryAttributes.MAGIC_DEFENCE.asHolder(), 6).putLevelGains(RuneCraftoryAttributes.MAGIC_DEFENCE.asHolder(), 299)
                    .putAttributes(Attributes.ARMOR, 10).putAttributes(Attributes.ARMOR_TOUGHNESS, 5)
                    .putAttributes(RuneCraftoryAttributes.WATER_RESISTANCE.asHolder(), 50)
    ...
    public static final RegistryEntrySupplier<EntityType<?>, EntityType<Sarcophagus>> SARCOPHAGUS = regBoss(EntityType.Builder.of(Sarcophagus::new, MobCategory.MONSTER)
            ...
            0x482f27, 0xf3d07f,
            new EntityProperties.Builder()
                    .putAttributes(Attributes.MAX_HEALTH, 350).putLevelGains(Attributes.MAX_HEALTH, 1033)
                    .putAttributes(Attributes.ATTACK_DAMAGE, 17).putLevelGains(Attributes.ATTACK_DAMAGE, 326)
                    .putAttributes(RuneCraftoryAttributes.DEFENCE.asHolder(), 6).putLevelGains(RuneCraftoryAttributes.DEFENCE.asHolder(), 293)
                    .putAttributes(RuneCraftoryAttributes.MAGIC_ATTACK.asHolder(), 17).putLevelGains(RuneCraftoryAttributes.MAGIC_ATTACK.asHolder(), 330)
                    .putAttributes(RuneCraftoryAttributes.MAGIC_DEFENCE.asHolder(), 6).putLevelGains(RuneCraftoryAttributes.MAGIC_DEFENCE.asHolder(), 293)
                    .putAttributes(Attributes.ARMOR, 10).putAttributes(Attributes.ARMOR_TOUGHNESS, 3)
                    .putAttributes(RuneCraftoryAttributes.LOVE_RESISTANCE.asHolder(), -25)
                    .putAttributes(RuneCraftoryAttributes.CRITICAL_RESISTANCE.asHolder(), 25)
                    .putAttributes(RuneCraftoryAttributes.DRAIN_RESISTANCE.asHolder(), 25)
                    .putAttributes(RuneCraftoryAttributes.DIZZY_RESISTANCE.asHolder(), 100)
    ...
    public static final RegistryEntrySupplier<EntityType<?>, EntityType<MarionettaTrapEntity>> TRAP_CHEST = reg(EntityType.Builder.<MarionettaTrapEntity>of(MarionettaTrapEntity::new, MobCategory.MISC).sized(1.25f, 1.25f).clientTrackingRange(4), RuneCraftory.modRes("trap_chest"));
