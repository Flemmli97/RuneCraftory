...
public class RuneCraftoryEntities {
    ...
    public static final RegistryEntrySupplier<EntityType<?>, EntityType<Wooly>> WOOLY = regMonster(EntityType.Builder.of(Wooly::new, MobCategory.MONSTER)
            ...
            new EntityProperties.Builder()
                    .putAttributes(Attributes.MAX_HEALTH, 18).putLevelGains(Attributes.MAX_HEALTH, 730)
                    .putAttributes(Attributes.ATTACK_DAMAGE, 3).putLevelGains(Attributes.ATTACK_DAMAGE, 210)
                    .putAttributes(RuneCraftoryAttributes.DEFENCE.asHolder(), 0).putLevelGains(RuneCraftoryAttributes.DEFENCE.asHolder(), 190)
                    .putAttributes(RuneCraftoryAttributes.MAGIC_ATTACK.asHolder(), -1).putLevelGains(RuneCraftoryAttributes.MAGIC_ATTACK.asHolder(), 180)
                    .putAttributes(RuneCraftoryAttributes.MAGIC_DEFENCE.asHolder(), 0).putLevelGains(RuneCraftoryAttributes.MAGIC_DEFENCE.asHolder(), 190)
    ...
    public static final RegistryEntrySupplier<EntityType<?>, EntityType<KingWooly>> KING_WOOLY = regMonster(EntityType.Builder.of(KingWooly::new, MobCategory.MONSTER)
            ...
            0xffffcc, 0xffffff,
            new EntityProperties.Builder()
                    .putAttributes(Attributes.MAX_HEALTH, 100).putLevelGains(Attributes.MAX_HEALTH, 750)
                    .putAttributes(Attributes.ATTACK_DAMAGE, 20).putLevelGains(Attributes.ATTACK_DAMAGE, 236)
                    .putAttributes(RuneCraftoryAttributes.DEFENCE.asHolder(), 6).putLevelGains(RuneCraftoryAttributes.DEFENCE.asHolder(), 205)
                    .putAttributes(RuneCraftoryAttributes.MAGIC_ATTACK.asHolder(), 14).putLevelGains(RuneCraftoryAttributes.MAGIC_ATTACK.asHolder(), 196)
                    .putAttributes(RuneCraftoryAttributes.MAGIC_DEFENCE.asHolder(), 6).putLevelGains(RuneCraftoryAttributes.MAGIC_DEFENCE.asHolder(), 205)
    ...
    public static final RegistryEntrySupplier<EntityType<?>, EntityType<Orc>> ORC = regMonster(EntityType.Builder.of(Orc::new, MobCategory.MONSTER)
            ...
            0x663300, 0xffbf80,
            new EntityProperties.Builder()
                    .putAttributes(Attributes.MAX_HEALTH, 20).putLevelGains(Attributes.MAX_HEALTH, 580)
                    .putAttributes(Attributes.ATTACK_DAMAGE, 9).putLevelGains(Attributes.ATTACK_DAMAGE, 227)
                    .putAttributes(RuneCraftoryAttributes.DEFENCE.asHolder(), 0).putLevelGains(RuneCraftoryAttributes.DEFENCE.asHolder(), 166)
                    .putAttributes(RuneCraftoryAttributes.MAGIC_ATTACK.asHolder(), 2).putLevelGains(RuneCraftoryAttributes.MAGIC_ATTACK.asHolder(), 195)
                    .putAttributes(RuneCraftoryAttributes.MAGIC_DEFENCE.asHolder(), 0).putLevelGains(RuneCraftoryAttributes.MAGIC_DEFENCE.asHolder(), 160)
    ...
    public static final RegistryEntrySupplier<EntityType<?>, EntityType<Orc>> HIGH_ORC = regMonster(EntityType.Builder.of(Orc::new, MobCategory.MONSTER)
            ...
            0x9f6c4e, 0x333e78,
            new EntityProperties.Builder()
                    .putAttributes(Attributes.MAX_HEALTH, 28).putLevelGains(Attributes.MAX_HEALTH, 705)
                    .putAttributes(Attributes.ATTACK_DAMAGE, 17).putLevelGains(Attributes.ATTACK_DAMAGE, 239)
                    .putAttributes(RuneCraftoryAttributes.DEFENCE.asHolder(), 5).putLevelGains(RuneCraftoryAttributes.DEFENCE.asHolder(), 181)
                    .putAttributes(RuneCraftoryAttributes.MAGIC_ATTACK.asHolder(), 7).putLevelGains(RuneCraftoryAttributes.MAGIC_ATTACK.asHolder(), 204)
                    .putAttributes(RuneCraftoryAttributes.MAGIC_DEFENCE.asHolder(), 5).putLevelGains(RuneCraftoryAttributes.MAGIC_DEFENCE.asHolder(), 179)
                    .putAttributes(RuneCraftoryAttributes.DIZZY.asHolder(), 3)
                    .putAttributes(RuneCraftoryAttributes.CRITICAL.asHolder(), 1)
                    .putAttributes(RuneCraftoryAttributes.CRITICAL_RESISTANCE.asHolder(), 5)
    ...
    public static final RegistryEntrySupplier<EntityType<?>, EntityType<Ant>> ANT = regMonster(EntityType.Builder.of(Ant::new, MobCategory.MONSTER)
            ...
            0x800000, 0x1a0000,
            new EntityProperties.Builder()
                    .putAttributes(Attributes.MAX_HEALTH, 22).putLevelGains(Attributes.MAX_HEALTH, 703)
                    .putAttributes(Attributes.ATTACK_DAMAGE, 7).putLevelGains(Attributes.ATTACK_DAMAGE, 217)
                    .putAttributes(RuneCraftoryAttributes.DEFENCE.asHolder(), 1).putLevelGains(RuneCraftoryAttributes.DEFENCE.asHolder(), 179)
                    .putAttributes(RuneCraftoryAttributes.MAGIC_ATTACK.asHolder(), 2).putLevelGains(RuneCraftoryAttributes.MAGIC_ATTACK.asHolder(), 168)
                    .putAttributes(RuneCraftoryAttributes.MAGIC_DEFENCE.asHolder(), 0).putLevelGains(RuneCraftoryAttributes.DEFENCE.asHolder(), 175)
                    .putAttributes(RuneCraftoryAttributes.DIZZY.asHolder(), 3)
                    .putAttributes(RuneCraftoryAttributes.CRITICAL.asHolder(), 1)
                    .putAttributes(RuneCraftoryAttributes.CRITICAL_RESISTANCE.asHolder(), 5)
                    .putAttributes(RuneCraftoryAttributes.WATER_RESISTANCE.asHolder(), -10)
    ...
    public static final RegistryEntrySupplier<EntityType<?>, EntityType<Ant>> KILLER_ANT = regMonster(EntityType.Builder.of(Ant::new, MobCategory.MONSTER)
            ...
            0x0f0e0e, 0x754848,
            new EntityProperties.Builder()
                    .putAttributes(Attributes.MAX_HEALTH, 28).putLevelGains(Attributes.MAX_HEALTH, 725)
                    .putAttributes(Attributes.ATTACK_DAMAGE, 16).putLevelGains(Attributes.ATTACK_DAMAGE, 232)
                    .putAttributes(RuneCraftoryAttributes.DEFENCE.asHolder(), 4).putLevelGains(RuneCraftoryAttributes.DEFENCE.asHolder(), 188)
                    .putAttributes(RuneCraftoryAttributes.MAGIC_ATTACK.asHolder(), 9).putLevelGains(RuneCraftoryAttributes.MAGIC_ATTACK.asHolder(), 171)
                    .putAttributes(RuneCraftoryAttributes.MAGIC_DEFENCE.asHolder(), 4).putLevelGains(RuneCraftoryAttributes.DEFENCE.asHolder(), 177)
                    .putAttributes(RuneCraftoryAttributes.DIZZY.asHolder(), 3)
                    .putAttributes(RuneCraftoryAttributes.CRITICAL.asHolder(), 1)
                    .putAttributes(RuneCraftoryAttributes.CRITICAL_RESISTANCE.asHolder(), 5)
    ...
    public static final RegistryEntrySupplier<EntityType<?>, EntityType<Beetle>> BEETLE = regMonster(EntityType.Builder.of(Beetle::new, MobCategory.MONSTER)
            ...
            0x9c6a43, 0x244a69,
            new EntityProperties.Builder()
                    .putAttributes(Attributes.MAX_HEALTH, 23).putLevelGains(Attributes.MAX_HEALTH, 598)
                    .putAttributes(Attributes.ATTACK_DAMAGE, 11).putLevelGains(Attributes.ATTACK_DAMAGE, 223)
                    .putAttributes(RuneCraftoryAttributes.DEFENCE.asHolder(), 0).putLevelGains(RuneCraftoryAttributes.DEFENCE.asHolder(), 169)
                    .putAttributes(RuneCraftoryAttributes.MAGIC_ATTACK.asHolder(), 3).putLevelGains(RuneCraftoryAttributes.MAGIC_ATTACK.asHolder(), 159)
                    .putAttributes(RuneCraftoryAttributes.MAGIC_DEFENCE.asHolder(), 0).putLevelGains(RuneCraftoryAttributes.MAGIC_DEFENCE.asHolder(), 164)
                    .putAttributes(RuneCraftoryAttributes.DIZZY.asHolder(), 3)
                    .putAttributes(RuneCraftoryAttributes.CRITICAL.asHolder(), 1)
                    .putAttributes(RuneCraftoryAttributes.CRITICAL_RESISTANCE.asHolder(), 5)
                    .putAttributes(RuneCraftoryAttributes.FIRE_RESISTANCE.asHolder(), -10)
    ...
    public static final RegistryEntrySupplier<EntityType<?>, EntityType<BigMuck>> BIG_MUCK = regMonster(EntityType.Builder.of(BigMuck::new, MobCategory.MONSTER)
            ...
            0xd7ce4a, 0xad5c25,
            new EntityProperties.Builder()
                    .putAttributes(Attributes.MAX_HEALTH, 20).putLevelGains(Attributes.MAX_HEALTH, 586)
                    .putAttributes(Attributes.ATTACK_DAMAGE, 8).putLevelGains(Attributes.ATTACK_DAMAGE, 184)
                    .putAttributes(RuneCraftoryAttributes.DEFENCE.asHolder(), 0).putLevelGains(RuneCraftoryAttributes.DEFENCE.asHolder(), 160)
                    .putAttributes(RuneCraftoryAttributes.MAGIC_ATTACK.asHolder(), 10).putLevelGains(RuneCraftoryAttributes.MAGIC_ATTACK.asHolder(), 225)
                    .putAttributes(RuneCraftoryAttributes.MAGIC_DEFENCE.asHolder(), 1).putLevelGains(RuneCraftoryAttributes.MAGIC_DEFENCE.asHolder(), 165)
                    .putAttributes(RuneCraftoryAttributes.DIZZY.asHolder(), 3)
                    .putAttributes(RuneCraftoryAttributes.CRITICAL.asHolder(), 1)
                    .putAttributes(RuneCraftoryAttributes.CRITICAL_RESISTANCE.asHolder(), 5)
                    .putAttributes(RuneCraftoryAttributes.LOVE_RESISTANCE.asHolder(), 10)
    ...
    public static final RegistryEntrySupplier<EntityType<?>, EntityType<TrickyMuck>> TRICKY_MUCK = regMonster(EntityType.Builder.of(TrickyMuck::new, MobCategory.MONSTER)
            ...
            0x207316, 0x90d681,
            new EntityProperties.Builder()
                    .putAttributes(Attributes.MAX_HEALTH, 29).putLevelGains(Attributes.MAX_HEALTH, 598)
                    .putAttributes(Attributes.ATTACK_DAMAGE, 13).putLevelGains(Attributes.ATTACK_DAMAGE, 204)
                    .putAttributes(RuneCraftoryAttributes.DEFENCE.asHolder(), 1).putLevelGains(RuneCraftoryAttributes.DEFENCE.asHolder(), 173)
                    .putAttributes(RuneCraftoryAttributes.MAGIC_ATTACK.asHolder(), 17).putLevelGains(RuneCraftoryAttributes.MAGIC_ATTACK.asHolder(), 241)
                    .putAttributes(RuneCraftoryAttributes.MAGIC_DEFENCE.asHolder(), 2).putLevelGains(RuneCraftoryAttributes.MAGIC_DEFENCE.asHolder(), 189)
                    .putAttributes(RuneCraftoryAttributes.DIZZY.asHolder(), 3)
                    .putAttributes(RuneCraftoryAttributes.CRITICAL.asHolder(), 1)
                    .putAttributes(RuneCraftoryAttributes.CRITICAL_RESISTANCE.asHolder(), 5)
                    .putAttributes(RuneCraftoryAttributes.EARTH_RESISTANCE.asHolder(), 15)
    ...
    public static final RegistryEntrySupplier<EntityType<?>, EntityType<Buffamoo>> BUFFAMOO = regMonster(EntityType.Builder.of(Buffamoo::new, MobCategory.MONSTER)
            ...
            0xd8d8d0, 0x4e4e4c,
            new EntityProperties.Builder()
                    .putAttributes(Attributes.MAX_HEALTH, 25).putLevelGains(Attributes.MAX_HEALTH, 706)
                    .putAttributes(Attributes.ATTACK_DAMAGE, 11).putLevelGains(Attributes.ATTACK_DAMAGE, 213)
                    .putAttributes(RuneCraftoryAttributes.DEFENCE.asHolder(), 1).putLevelGains(RuneCraftoryAttributes.DEFENCE.asHolder(), 172)
                    .putAttributes(RuneCraftoryAttributes.MAGIC_ATTACK.asHolder(), 7).putLevelGains(RuneCraftoryAttributes.MAGIC_ATTACK.asHolder(), 170)
                    .putAttributes(RuneCraftoryAttributes.MAGIC_DEFENCE.asHolder(), 0).putLevelGains(RuneCraftoryAttributes.MAGIC_DEFENCE.asHolder(), 172)
                    .putAttributes(RuneCraftoryAttributes.DIZZY.asHolder(), 3)
                    .putAttributes(RuneCraftoryAttributes.CRITICAL.asHolder(), 1)
                    .putAttributes(RuneCraftoryAttributes.CRITICAL_RESISTANCE.asHolder(), 5)
                    .putAttributes(RuneCraftoryAttributes.LOVE_RESISTANCE.asHolder(), 10)
    ...
    public static final RegistryEntrySupplier<EntityType<?>, EntityType<Buffamoo>> BUFFALOO = regMonster(EntityType.Builder.of(Buffamoo::new, MobCategory.MONSTER)
            ...
            0x8a8a5e, 0xb5b489,
            new EntityProperties.Builder()
                    .putAttributes(Attributes.MAX_HEALTH, 35).putLevelGains(Attributes.MAX_HEALTH, 721)
                    .putAttributes(Attributes.ATTACK_DAMAGE, 18).putLevelGains(Attributes.ATTACK_DAMAGE, 236)
                    .putAttributes(RuneCraftoryAttributes.DEFENCE.asHolder(), 2).putLevelGains(RuneCraftoryAttributes.DEFENCE.asHolder(), 193)
                    .putAttributes(RuneCraftoryAttributes.MAGIC_ATTACK.asHolder(), 11).putLevelGains(RuneCraftoryAttributes.MAGIC_ATTACK.asHolder(), 181)
                    .putAttributes(RuneCraftoryAttributes.MAGIC_DEFENCE.asHolder(), 2).putLevelGains(RuneCraftoryAttributes.MAGIC_DEFENCE.asHolder(), 193)
                    .putAttributes(RuneCraftoryAttributes.DIZZY.asHolder(), 3)
                    .putAttributes(RuneCraftoryAttributes.CRITICAL.asHolder(), 1)
                    .putAttributes(RuneCraftoryAttributes.CRITICAL_RESISTANCE.asHolder(), 5)
                    .putAttributes(RuneCraftoryAttributes.LOVE_RESISTANCE.asHolder(), -10)
    ...
    public static final RegistryEntrySupplier<EntityType<?>, EntityType<Chipsqueek>> CHIPSQUEEK = regMonster(EntityType.Builder.of(Chipsqueek::new, MobCategory.MONSTER)
            ...
            0xff3b5b, 0xf9ffbb,
            new EntityProperties.Builder()
                    .putAttributes(Attributes.MAX_HEALTH, 21).putLevelGains(Attributes.MAX_HEALTH, 589)
                    .putAttributes(Attributes.ATTACK_DAMAGE, 11).putLevelGains(Attributes.ATTACK_DAMAGE, 211)
                    .putAttributes(RuneCraftoryAttributes.DEFENCE.asHolder(), 0).putLevelGains(RuneCraftoryAttributes.DEFENCE.asHolder(), 163)
                    .putAttributes(RuneCraftoryAttributes.MAGIC_ATTACK.asHolder(), 7).putLevelGains(RuneCraftoryAttributes.MAGIC_ATTACK.asHolder(), 155)
                    .putAttributes(RuneCraftoryAttributes.MAGIC_DEFENCE.asHolder(), 1).putLevelGains(RuneCraftoryAttributes.MAGIC_DEFENCE.asHolder(), 160)
                    .putAttributes(RuneCraftoryAttributes.DIZZY.asHolder(), 3)
                    .putAttributes(RuneCraftoryAttributes.CRITICAL.asHolder(), 1)
                    .putAttributes(RuneCraftoryAttributes.CRITICAL_RESISTANCE.asHolder(), 5)
                    .putAttributes(RuneCraftoryAttributes.LOVE_RESISTANCE.asHolder(), 10)
    ...
    public static final RegistryEntrySupplier<EntityType<?>, EntityType<Chipsqueek>> FURPY = regMonster(EntityType.Builder.of(Chipsqueek::new, MobCategory.MONSTER)
            ...
            new EntityProperties.Builder()
                    .putAttributes(Attributes.MAX_HEALTH, 28).putLevelGains(Attributes.MAX_HEALTH, 705)
                    .putAttributes(Attributes.ATTACK_DAMAGE, 16).putLevelGains(Attributes.ATTACK_DAMAGE, 229)
                    .putAttributes(RuneCraftoryAttributes.DEFENCE.asHolder(), 3).putLevelGains(RuneCraftoryAttributes.DEFENCE.asHolder(), 187)
                    .putAttributes(RuneCraftoryAttributes.MAGIC_ATTACK.asHolder(), 9).putLevelGains(RuneCraftoryAttributes.MAGIC_ATTACK.asHolder(), 173)
                    .putAttributes(RuneCraftoryAttributes.MAGIC_DEFENCE.asHolder(), 3).putLevelGains(RuneCraftoryAttributes.MAGIC_DEFENCE.asHolder(), 181)
                    .putAttributes(RuneCraftoryAttributes.DIZZY.asHolder(), 3)
                    .putAttributes(RuneCraftoryAttributes.CRITICAL.asHolder(), 1)
                    .putAttributes(RuneCraftoryAttributes.CRITICAL_RESISTANCE.asHolder(), 5)
                    .putAttributes(RuneCraftoryAttributes.EARTH_RESISTANCE.asHolder(), 15)
    ...
    public static final RegistryEntrySupplier<EntityType<?>, EntityType<MineralSqueek>> MINERAL_SQUEEK = regMonster(EntityType.Builder.of(MineralSqueek::new, MobCategory.MONSTER)
            ...
            new EntityProperties.Builder()
                    ...
                    .putAttributes(RuneCraftoryAttributes.MAGIC_ATTACK.asHolder(), 7).putLevelGains(RuneCraftoryAttributes.MAGIC_ATTACK.asHolder(), 150)
    ...
    public static final RegistryEntrySupplier<EntityType<?>, EntityType<Cluckadoodle>> CLUCKADOODLE = regMonster(EntityType.Builder.of(Cluckadoodle::new, MobCategory.MONSTER)
            ...
            0xc2c2c2, 0xdc2121,
            new EntityProperties.Builder()
                    .putAttributes(Attributes.MAX_HEALTH, 19).putLevelGains(Attributes.MAX_HEALTH, 595)
                    .putAttributes(Attributes.ATTACK_DAMAGE, 13).putLevelGains(Attributes.ATTACK_DAMAGE, 215)
                    .putAttributes(RuneCraftoryAttributes.DEFENCE.asHolder(), 0).putLevelGains(RuneCraftoryAttributes.DEFENCE.asHolder(), 181)
                    .putAttributes(RuneCraftoryAttributes.MAGIC_ATTACK.asHolder(), 1).putLevelGains(RuneCraftoryAttributes.MAGIC_ATTACK.asHolder(), 150)
                    .putAttributes(RuneCraftoryAttributes.MAGIC_DEFENCE.asHolder(), 0).putLevelGains(RuneCraftoryAttributes.MAGIC_DEFENCE.asHolder(), 175)
                    .putAttributes(RuneCraftoryAttributes.DIZZY.asHolder(), 3)
                    .putAttributes(RuneCraftoryAttributes.CRITICAL.asHolder(), 1)
                    .putAttributes(RuneCraftoryAttributes.CRITICAL_RESISTANCE.asHolder(), 5)
    ...
    public static final RegistryEntrySupplier<EntityType<?>, EntityType<PommePomme>> POMME_POMME = regMonster(EntityType.Builder.of(PommePomme::new, MobCategory.MONSTER)
            ...
            0xff1c2b, 0xf7b4b8,
            new EntityProperties.Builder()
                    .putAttributes(Attributes.MAX_HEALTH, 24).putLevelGains(Attributes.MAX_HEALTH, 715)
                    .putAttributes(Attributes.ATTACK_DAMAGE, 10).putLevelGains(Attributes.ATTACK_DAMAGE, 198)
                    .putAttributes(RuneCraftoryAttributes.DEFENCE.asHolder(), 0).putLevelGains(RuneCraftoryAttributes.DEFENCE.asHolder(), 201)
                    .putAttributes(RuneCraftoryAttributes.MAGIC_ATTACK.asHolder(), 7).putLevelGains(RuneCraftoryAttributes.MAGIC_ATTACK.asHolder(), 165)
                    .putAttributes(RuneCraftoryAttributes.MAGIC_DEFENCE.asHolder(), 0).putLevelGains(RuneCraftoryAttributes.MAGIC_DEFENCE.asHolder(), 192)
                    .putAttributes(RuneCraftoryAttributes.DIZZY.asHolder(), 3)
                    .putAttributes(RuneCraftoryAttributes.CRITICAL.asHolder(), 1)
                    .putAttributes(RuneCraftoryAttributes.CRITICAL_RESISTANCE.asHolder(), 5)
                    .putAttributes(RuneCraftoryAttributes.EARTH_RESISTANCE.asHolder(), 15)
    ...
    public static final RegistryEntrySupplier<EntityType<?>, EntityType<PommePomme>> MINO = regMonster(EntityType.Builder.of(PommePomme::new, MobCategory.MONSTER)
            ...
            new EntityProperties.Builder()
                    .putAttributes(Attributes.MAX_HEALTH, 28).putLevelGains(Attributes.MAX_HEALTH, 725)
                    .putAttributes(Attributes.ATTACK_DAMAGE, 14).putLevelGains(Attributes.ATTACK_DAMAGE, 205)
                    .putAttributes(RuneCraftoryAttributes.DEFENCE.asHolder(), 2).putLevelGains(RuneCraftoryAttributes.DEFENCE.asHolder(), 218)
                    .putAttributes(RuneCraftoryAttributes.MAGIC_ATTACK.asHolder(), 8).putLevelGains(RuneCraftoryAttributes.MAGIC_ATTACK.asHolder(), 170)
                    .putAttributes(RuneCraftoryAttributes.MAGIC_DEFENCE.asHolder(), 2).putLevelGains(RuneCraftoryAttributes.MAGIC_DEFENCE.asHolder(), 209)
                    .putAttributes(RuneCraftoryAttributes.DIZZY.asHolder(), 3)
                    .putAttributes(RuneCraftoryAttributes.CRITICAL.asHolder(), 1)
                    .putAttributes(RuneCraftoryAttributes.CRITICAL_RESISTANCE.asHolder(), 5)
                    .putAttributes(RuneCraftoryAttributes.EARTH_RESISTANCE.asHolder(), 15)
    ...
    public static final RegistryEntrySupplier<EntityType<?>, EntityType<Nappie>> NAPPIE = regMonster(EntityType.Builder.of(Nappie::new, MobCategory.MONSTER)
            ...
            0xb4843c, 0x1b5a0d,
            new EntityProperties.Builder()
                    .putAttributes(Attributes.MAX_HEALTH, 30).putLevelGains(Attributes.MAX_HEALTH, 725)
                    .putAttributes(Attributes.ATTACK_DAMAGE, 13).putLevelGains(Attributes.ATTACK_DAMAGE, 199)
                    .putAttributes(RuneCraftoryAttributes.DEFENCE.asHolder(), 3).putLevelGains(RuneCraftoryAttributes.DEFENCE.asHolder(), 209)
                    .putAttributes(RuneCraftoryAttributes.MAGIC_ATTACK.asHolder(), 12).putLevelGains(RuneCraftoryAttributes.MAGIC_ATTACK.asHolder(), 197)
                    .putAttributes(RuneCraftoryAttributes.MAGIC_DEFENCE.asHolder(), 2).putLevelGains(RuneCraftoryAttributes.MAGIC_DEFENCE.asHolder(), 218)
                    .putAttributes(RuneCraftoryAttributes.DIZZY.asHolder(), 3)
                    .putAttributes(RuneCraftoryAttributes.CRITICAL.asHolder(), 1)
                    .putAttributes(RuneCraftoryAttributes.CRITICAL_RESISTANCE.asHolder(), 5)
                    .putAttributes(RuneCraftoryAttributes.EARTH_RESISTANCE.asHolder(), 15)
    ...
    public static final RegistryEntrySupplier<EntityType<?>, EntityType<Tortas>> TORTAS = regMonster(EntityType.Builder.of(Tortas::new, MobCategory.MONSTER)
            ...
            0x5c6682, 0xa5848c,
            new EntityProperties.Builder()
                    .putAttributes(Attributes.MAX_HEALTH, 28).putLevelGains(Attributes.MAX_HEALTH, 720)
                    .putAttributes(Attributes.ATTACK_DAMAGE, 15).putLevelGains(Attributes.ATTACK_DAMAGE, 219)
                    .putAttributes(RuneCraftoryAttributes.DEFENCE.asHolder(), 2).putLevelGains(RuneCraftoryAttributes.DEFENCE.asHolder(), 211)
                    .putAttributes(RuneCraftoryAttributes.MAGIC_ATTACK.asHolder(), 7).putLevelGains(RuneCraftoryAttributes.MAGIC_ATTACK.asHolder(), 158)
                    .putAttributes(RuneCraftoryAttributes.MAGIC_DEFENCE.asHolder(), 0).putLevelGains(RuneCraftoryAttributes.MAGIC_DEFENCE.asHolder(), 194)
                    .putAttributes(RuneCraftoryAttributes.DIZZY.asHolder(), 3)
                    .putAttributes(RuneCraftoryAttributes.CRITICAL.asHolder(), 1)
                    .putAttributes(RuneCraftoryAttributes.CRITICAL_RESISTANCE.asHolder(), 5)
                    .putAttributes(RuneCraftoryAttributes.FIRE_RESISTANCE.asHolder(), -25)
    ...
    public static final RegistryEntrySupplier<EntityType<?>, EntityType<SkyFish>> SKY_FISH = regMonster(EntityType.Builder.of(SkyFish::new, MobCategory.MONSTER)
            ...
            0x8fa4c5, 0x5a3536,
            new EntityProperties.Builder()
                    .putAttributes(Attributes.MAX_HEALTH, 23).putLevelGains(Attributes.MAX_HEALTH, 597)
                    .putAttributes(Attributes.ATTACK_DAMAGE, 9).putLevelGains(Attributes.ATTACK_DAMAGE, 153)
                    .putAttributes(RuneCraftoryAttributes.DEFENCE.asHolder(), 0).putLevelGains(RuneCraftoryAttributes.DEFENCE.asHolder(), 168)
                    .putAttributes(RuneCraftoryAttributes.MAGIC_ATTACK.asHolder(), 12).putLevelGains(RuneCraftoryAttributes.MAGIC_ATTACK.asHolder(), 235)
                    .putAttributes(RuneCraftoryAttributes.MAGIC_DEFENCE.asHolder(), 1).putLevelGains(RuneCraftoryAttributes.MAGIC_DEFENCE.asHolder(), 181)
                    .putAttributes(RuneCraftoryAttributes.DIZZY.asHolder(), 3)
                    .putAttributes(RuneCraftoryAttributes.CRITICAL.asHolder(), 1)
                    .putAttributes(RuneCraftoryAttributes.CRITICAL_RESISTANCE.asHolder(), 5)
                    .putAttributes(RuneCraftoryAttributes.FIRE_RESISTANCE.asHolder(), -25)
    ...
    public static final RegistryEntrySupplier<EntityType<?>, EntityType<Weagle>> WEAGLE = regMonster(EntityType.Builder.of(Weagle::new, MobCategory.MONSTER)
            ...
            new EntityProperties.Builder()
                    .putAttributes(Attributes.MAX_HEALTH, 22).putLevelGains(Attributes.MAX_HEALTH, 710)
                    .putAttributes(Attributes.ATTACK_DAMAGE, 11).putLevelGains(Attributes.ATTACK_DAMAGE, 205)
                    .putAttributes(RuneCraftoryAttributes.DEFENCE.asHolder(), 0).putLevelGains(RuneCraftoryAttributes.DEFENCE.asHolder(), 181)
                    .putAttributes(RuneCraftoryAttributes.MAGIC_ATTACK.asHolder(), 6).putLevelGains(RuneCraftoryAttributes.MAGIC_ATTACK.asHolder(), 160)
                    .putAttributes(RuneCraftoryAttributes.MAGIC_DEFENCE.asHolder(), 1).putLevelGains(RuneCraftoryAttributes.MAGIC_DEFENCE.asHolder(), 177)
                    .putAttributes(RuneCraftoryAttributes.DIZZY.asHolder(), 3)
                    .putAttributes(RuneCraftoryAttributes.CRITICAL.asHolder(), 1)
                    .putAttributes(RuneCraftoryAttributes.CRITICAL_RESISTANCE.asHolder(), 5)
    ...
    public static final RegistryEntrySupplier<EntityType<?>, EntityType<Goblin>> GOBLIN = regMonster(EntityType.Builder.of(Goblin::new, MobCategory.MONSTER)
            ...
            0x21b322, 0x462f2a,
            new EntityProperties.Builder()
                    .putAttributes(Attributes.MAX_HEALTH, 24).putLevelGains(Attributes.MAX_HEALTH, 700)
                    .putAttributes(Attributes.ATTACK_DAMAGE, 13).putLevelGains(Attributes.ATTACK_DAMAGE, 217)
                    .putAttributes(RuneCraftoryAttributes.DEFENCE.asHolder(), 0).putLevelGains(RuneCraftoryAttributes.DEFENCE.asHolder(), 190)
                    .putAttributes(RuneCraftoryAttributes.MAGIC_ATTACK.asHolder(), 8).putLevelGains(RuneCraftoryAttributes.MAGIC_ATTACK.asHolder(), 178)
                    .putAttributes(RuneCraftoryAttributes.MAGIC_DEFENCE.asHolder(), 0).putLevelGains(RuneCraftoryAttributes.MAGIC_DEFENCE.asHolder(), 170)
                    .putAttributes(RuneCraftoryAttributes.DIZZY.asHolder(), 3)
                    .putAttributes(RuneCraftoryAttributes.CRITICAL.asHolder(), 1)
                    .putAttributes(RuneCraftoryAttributes.CRITICAL_RESISTANCE.asHolder(), 5)
                    .putAttributes(RuneCraftoryAttributes.EARTH_RESISTANCE.asHolder(), 10)
    ...
    public static final RegistryEntrySupplier<EntityType<?>, EntityType<GoblinPirate>> GOBLIN_PIRATE = regMonster(EntityType.Builder.of(GoblinPirate::new, MobCategory.MONSTER)
            ...
            0x484209, 0x29307f,
            new EntityProperties.Builder()
                    .putAttributes(Attributes.MAX_HEALTH, 26).putLevelGains(Attributes.MAX_HEALTH, 721)
                    .putAttributes(Attributes.ATTACK_DAMAGE, 17).putLevelGains(Attributes.ATTACK_DAMAGE, 238)
                    .putAttributes(RuneCraftoryAttributes.DEFENCE.asHolder(), 1).putLevelGains(RuneCraftoryAttributes.DEFENCE.asHolder(), 208)
                    .putAttributes(RuneCraftoryAttributes.MAGIC_ATTACK.asHolder(), 2).putLevelGains(RuneCraftoryAttributes.MAGIC_ATTACK.asHolder(), 187)
                    .putAttributes(RuneCraftoryAttributes.MAGIC_DEFENCE.asHolder(), 1).putLevelGains(RuneCraftoryAttributes.MAGIC_DEFENCE.asHolder(), 196)
                    .putAttributes(RuneCraftoryAttributes.DIZZY.asHolder(), 3)
                    .putAttributes(RuneCraftoryAttributes.CRITICAL.asHolder(), 1)
                    .putAttributes(RuneCraftoryAttributes.CRITICAL_RESISTANCE.asHolder(), 5)
                    .putAttributes(RuneCraftoryAttributes.EARTH_RESISTANCE.asHolder(), 10)
    ...
    public static final RegistryEntrySupplier<EntityType<?>, EntityType<GoblinPirate>> GOBLIN_CAPTAIN = regMonster(EntityType.Builder.of(GoblinPirate::new, MobCategory.MONSTER)
            ...
            0x452621, 0xe9e9e9,
            new EntityProperties.Builder()
                    .putAttributes(Attributes.MAX_HEALTH, 30).putLevelGains(Attributes.MAX_HEALTH, 744)
                    .putAttributes(Attributes.ATTACK_DAMAGE, 21).putLevelGains(Attributes.ATTACK_DAMAGE, 251)
                    .putAttributes(RuneCraftoryAttributes.DEFENCE.asHolder(), 2).putLevelGains(RuneCraftoryAttributes.DEFENCE.asHolder(), 205)
                    .putAttributes(RuneCraftoryAttributes.MAGIC_ATTACK.asHolder(), 14).putLevelGains(RuneCraftoryAttributes.MAGIC_ATTACK.asHolder(), 203)
                    .putAttributes(RuneCraftoryAttributes.MAGIC_DEFENCE.asHolder(), 1).putLevelGains(RuneCraftoryAttributes.MAGIC_DEFENCE.asHolder(), 199)
                    .putAttributes(RuneCraftoryAttributes.DIZZY.asHolder(), 3)
                    .putAttributes(RuneCraftoryAttributes.CRITICAL.asHolder(), 1)
                    .putAttributes(RuneCraftoryAttributes.CRITICAL_RESISTANCE.asHolder(), 5)
                    .putAttributes(RuneCraftoryAttributes.EARTH_RESISTANCE.asHolder(), 10)
    ...
    public static final RegistryEntrySupplier<EntityType<?>, EntityType<Duck>> DUCK = regMonster(EntityType.Builder.of(Duck::new, MobCategory.MONSTER)
            ...
            0xdabf33, 0x845242,
            new EntityProperties.Builder()
                    .putAttributes(Attributes.MAX_HEALTH, 23).putLevelGains(Attributes.MAX_HEALTH, 730)
                    .putAttributes(Attributes.ATTACK_DAMAGE, 13).putLevelGains(Attributes.ATTACK_DAMAGE, 213)
                    .putAttributes(RuneCraftoryAttributes.DEFENCE.asHolder(), 0).putLevelGains(RuneCraftoryAttributes.DEFENCE.asHolder(), 175)
                    .putAttributes(RuneCraftoryAttributes.MAGIC_ATTACK.asHolder(), 4).putLevelGains(RuneCraftoryAttributes.MAGIC_ATTACK.asHolder(), 190)
                    .putAttributes(RuneCraftoryAttributes.MAGIC_DEFENCE.asHolder(), 0).putLevelGains(RuneCraftoryAttributes.MAGIC_DEFENCE.asHolder(), 185)
                    .putAttributes(RuneCraftoryAttributes.DIZZY.asHolder(), 3)
                    .putAttributes(RuneCraftoryAttributes.CRITICAL.asHolder(), 1)
                    .putAttributes(RuneCraftoryAttributes.CRITICAL_RESISTANCE.asHolder(), 5)
                    .putAttributes(RuneCraftoryAttributes.EARTH_RESISTANCE.asHolder(), -10)
    ...
    public static final RegistryEntrySupplier<EntityType<?>, EntityType<Fairy>> FAIRY = regMonster(EntityType.Builder.of(Fairy::new, MobCategory.MONSTER)
            ...
            new EntityProperties.Builder()
                    .putAttributes(Attributes.MAX_HEALTH, 19).putLevelGains(Attributes.MAX_HEALTH, 585)
                    .putAttributes(Attributes.ATTACK_DAMAGE, 10).putLevelGains(Attributes.ATTACK_DAMAGE, 160)
                    .putAttributes(RuneCraftoryAttributes.DEFENCE.asHolder(), 0).putLevelGains(RuneCraftoryAttributes.DEFENCE.asHolder(), 165)
                    ...
                    .putAttributes(RuneCraftoryAttributes.MAGIC_DEFENCE.asHolder(), 2).putLevelGains(RuneCraftoryAttributes.MAGIC_DEFENCE.asHolder(), 178)
                    .putAttributes(RuneCraftoryAttributes.DIZZY.asHolder(), 3)
                    .putAttributes(RuneCraftoryAttributes.CRITICAL.asHolder(), 1)
                    .putAttributes(RuneCraftoryAttributes.CRITICAL_RESISTANCE.asHolder(), 5)
                    .putAttributes(RuneCraftoryAttributes.LOVE_RESISTANCE.asHolder(), 10)
    ...
    public static final RegistryEntrySupplier<EntityType<?>, EntityType<Ghost>> GHOST = regMonster(EntityType.Builder.of(Ghost::new, MobCategory.MONSTER)
            ...
            new EntityProperties.Builder()
                    .putAttributes(Attributes.MAX_HEALTH, 23).putLevelGains(Attributes.MAX_HEALTH, 710)
                    .putAttributes(Attributes.ATTACK_DAMAGE, 10).putLevelGains(Attributes.ATTACK_DAMAGE, 221)
                    .putAttributes(RuneCraftoryAttributes.DEFENCE.asHolder(), 1).putLevelGains(RuneCraftoryAttributes.DEFENCE.asHolder(), 163)
                    .putAttributes(RuneCraftoryAttributes.MAGIC_ATTACK.asHolder(), 10).putLevelGains(RuneCraftoryAttributes.MAGIC_ATTACK.asHolder(), 213)
                    .putAttributes(RuneCraftoryAttributes.MAGIC_DEFENCE.asHolder(), 1).putLevelGains(RuneCraftoryAttributes.MAGIC_DEFENCE.asHolder(), 170)
                    .putAttributes(RuneCraftoryAttributes.DIZZY.asHolder(), 3)
                    .putAttributes(RuneCraftoryAttributes.CRITICAL.asHolder(), 1)
                    .putAttributes(RuneCraftoryAttributes.CRITICAL_RESISTANCE.asHolder(), 5)
                    .putAttributes(RuneCraftoryAttributes.LIGHT_RESISTANCE.asHolder(), -10)
    ...
    public static final RegistryEntrySupplier<EntityType<?>, EntityType<Ghost>> GHOST_RAY = regMonster(EntityType.Builder.of(Ghost::new, MobCategory.MONSTER)
            ...
            new EntityProperties.Builder()
                    .putAttributes(Attributes.MAX_HEALTH, 45).putLevelGains(Attributes.MAX_HEALTH, 740)
                    .putAttributes(Attributes.ATTACK_DAMAGE, 18).putLevelGains(Attributes.ATTACK_DAMAGE, 246)
                    .putAttributes(RuneCraftoryAttributes.DEFENCE.asHolder(), 2).putLevelGains(RuneCraftoryAttributes.DEFENCE.asHolder(), 182)
                    .putAttributes(RuneCraftoryAttributes.MAGIC_ATTACK.asHolder(), 17).putLevelGains(RuneCraftoryAttributes.MAGIC_ATTACK.asHolder(), 239)
                    .putAttributes(RuneCraftoryAttributes.MAGIC_DEFENCE.asHolder(), 2).putLevelGains(RuneCraftoryAttributes.MAGIC_DEFENCE.asHolder(), 191)
                    .putAttributes(RuneCraftoryAttributes.DIZZY.asHolder(), 3)
                    .putAttributes(RuneCraftoryAttributes.CRITICAL.asHolder(), 1)
                    .putAttributes(RuneCraftoryAttributes.CRITICAL_RESISTANCE.asHolder(), 5)
                    .putAttributes(RuneCraftoryAttributes.LIGHT_RESISTANCE.asHolder(), -10)
    ...
    public static final RegistryEntrySupplier<EntityType<?>, EntityType<Spirit>> SPIRIT = regMonster(EntityType.Builder.of(Spirit::new, MobCategory.MONSTER)
            ...
            new EntityProperties.Builder()
                    .putAttributes(Attributes.MAX_HEALTH, 21).putLevelGains(Attributes.MAX_HEALTH, 597)
                    .putAttributes(Attributes.ATTACK_DAMAGE, 9).putLevelGains(Attributes.ATTACK_DAMAGE, 160)
                    .putAttributes(RuneCraftoryAttributes.DEFENCE.asHolder(), 1).putLevelGains(RuneCraftoryAttributes.DEFENCE.asHolder(), 160)
                    .putAttributes(RuneCraftoryAttributes.MAGIC_ATTACK.asHolder(), 15).putLevelGains(RuneCraftoryAttributes.MAGIC_ATTACK.asHolder(), 234)
                    .putAttributes(RuneCraftoryAttributes.MAGIC_DEFENCE.asHolder(), 2).putLevelGains(RuneCraftoryAttributes.MAGIC_DEFENCE.asHolder(), 174)
                    .putAttributes(RuneCraftoryAttributes.DIZZY.asHolder(), 3)
                    .putAttributes(RuneCraftoryAttributes.CRITICAL.asHolder(), 1)
                    .putAttributes(RuneCraftoryAttributes.CRITICAL_RESISTANCE.asHolder(), 5)
                    .putAttributes(RuneCraftoryAttributes.LIGHT_RESISTANCE.asHolder(), -10)
    ...
    public static final RegistryEntrySupplier<EntityType<?>, EntityType<Ignis>> IGNIS = regMonster(EntityType.Builder.of(Ignis::new, MobCategory.MONSTER)
            ...
            new EntityProperties.Builder()
                    .putAttributes(Attributes.MAX_HEALTH, 23).putLevelGains(Attributes.MAX_HEALTH, 702)
                    .putAttributes(Attributes.ATTACK_DAMAGE, 14).putLevelGains(Attributes.ATTACK_DAMAGE, 164)
                    .putAttributes(RuneCraftoryAttributes.DEFENCE.asHolder(), 2).putLevelGains(RuneCraftoryAttributes.DEFENCE.asHolder(), 169)
                    .putAttributes(RuneCraftoryAttributes.MAGIC_ATTACK.asHolder(), 17).putLevelGains(RuneCraftoryAttributes.MAGIC_ATTACK.asHolder(), 241)
                    .putAttributes(RuneCraftoryAttributes.MAGIC_DEFENCE.asHolder(), 3).putLevelGains(RuneCraftoryAttributes.MAGIC_DEFENCE.asHolder(), 178)
                    .putAttributes(RuneCraftoryAttributes.DIZZY.asHolder(), 3)
                    .putAttributes(RuneCraftoryAttributes.CRITICAL.asHolder(), 1)
                    .putAttributes(RuneCraftoryAttributes.CRITICAL_RESISTANCE.asHolder(), 5)
                    .putAttributes(RuneCraftoryAttributes.FIRE_RESISTANCE.asHolder(), 25)
    ...
    public static final RegistryEntrySupplier<EntityType<?>, EntityType<Spider>> SPIDER = regMonster(EntityType.Builder.of(Spider::new, MobCategory.MONSTER)
            ...
            0x6f6751, 0x404148,
            new EntityProperties.Builder()
                    .putAttributes(Attributes.MAX_HEALTH, 19).putLevelGains(Attributes.MAX_HEALTH, 589)
                    .putAttributes(Attributes.ATTACK_DAMAGE, 13).putLevelGains(Attributes.ATTACK_DAMAGE, 217)
                    .putAttributes(RuneCraftoryAttributes.DEFENCE.asHolder(), 0).putLevelGains(RuneCraftoryAttributes.DEFENCE.asHolder(), 177)
                    .putAttributes(RuneCraftoryAttributes.MAGIC_ATTACK.asHolder(), 9).putLevelGains(RuneCraftoryAttributes.MAGIC_ATTACK.asHolder(), 159)
                    .putAttributes(RuneCraftoryAttributes.MAGIC_DEFENCE.asHolder(), 0).putLevelGains(RuneCraftoryAttributes.MAGIC_DEFENCE.asHolder(), 172)
                    .putAttributes(RuneCraftoryAttributes.DIZZY.asHolder(), 3)
                    .putAttributes(RuneCraftoryAttributes.CRITICAL.asHolder(), 1)
                    .putAttributes(RuneCraftoryAttributes.CRITICAL_RESISTANCE.asHolder(), 5)
    ...
    public static final RegistryEntrySupplier<EntityType<?>, EntityType<Panther>> SHADOW_PANTHER = regMonster(EntityType.Builder.of(Panther::new, MobCategory.MONSTER)
            ...
            0x27375b, 0x733838,
            new EntityProperties.Builder()
                    .putAttributes(Attributes.MAX_HEALTH, 28).putLevelGains(Attributes.MAX_HEALTH, 715)
                    .putAttributes(Attributes.ATTACK_DAMAGE, 17).putLevelGains(Attributes.ATTACK_DAMAGE, 225)
                    .putAttributes(RuneCraftoryAttributes.DEFENCE.asHolder(), 2).putLevelGains(RuneCraftoryAttributes.DEFENCE.asHolder(), 175)
                    .putAttributes(RuneCraftoryAttributes.MAGIC_ATTACK.asHolder(), 8).putLevelGains(RuneCraftoryAttributes.MAGIC_ATTACK.asHolder(), 188)
                    .putAttributes(RuneCraftoryAttributes.MAGIC_DEFENCE.asHolder(), 2).putLevelGains(RuneCraftoryAttributes.MAGIC_DEFENCE.asHolder(), 183)
                    .putAttributes(RuneCraftoryAttributes.DIZZY.asHolder(), 3)
                    .putAttributes(RuneCraftoryAttributes.CRITICAL.asHolder(), 1)
                    .putAttributes(RuneCraftoryAttributes.CRITICAL_RESISTANCE.asHolder(), 5)
                    .putAttributes(RuneCraftoryAttributes.LIGHT_RESISTANCE.asHolder(), -10)
    ...
    public static final RegistryEntrySupplier<EntityType<?>, EntityType<Mimic>> MONSTER_BOX = regMonster(EntityType.Builder.of(Mimic::new, MobCategory.MONSTER)
            ...
            0xac935e, 0x462f10,
            new EntityProperties.Builder()
                    .putAttributes(Attributes.MAX_HEALTH, 30).putLevelGains(Attributes.MAX_HEALTH, 730)
                    .putAttributes(Attributes.ATTACK_DAMAGE, 15).putLevelGains(Attributes.ATTACK_DAMAGE, 215)
                    .putAttributes(RuneCraftoryAttributes.DEFENCE.asHolder(), 2).putLevelGains(RuneCraftoryAttributes.DEFENCE.asHolder(), 185)
                    .putAttributes(RuneCraftoryAttributes.MAGIC_ATTACK.asHolder(), 11).putLevelGains(RuneCraftoryAttributes.MAGIC_ATTACK.asHolder(), 215)
                    .putAttributes(RuneCraftoryAttributes.MAGIC_DEFENCE.asHolder(), 1).putLevelGains(RuneCraftoryAttributes.MAGIC_DEFENCE.asHolder(), 185)
                    .putAttributes(RuneCraftoryAttributes.DIZZY.asHolder(), 3)
                    .putAttributes(RuneCraftoryAttributes.CRITICAL.asHolder(), 1)
                    .putAttributes(RuneCraftoryAttributes.CRITICAL_RESISTANCE.asHolder(), 5)
                    .putAttributes(RuneCraftoryAttributes.LIGHT_RESISTANCE.asHolder(), 10)
    ...
    public static final RegistryEntrySupplier<EntityType<?>, EntityType<Mimic>> GOBBLE_BOX = regMonster(EntityType.Builder.of(Mimic::new, MobCategory.MONSTER)
            ...
            0x8f9cc4, 0x343843,
            new EntityProperties.Builder()
                    .putAttributes(Attributes.MAX_HEALTH, 50).putLevelGains(Attributes.MAX_HEALTH, 750)
                    .putAttributes(Attributes.ATTACK_DAMAGE, 20).putLevelGains(Attributes.ATTACK_DAMAGE, 229)
                    .putAttributes(RuneCraftoryAttributes.DEFENCE.asHolder(), 3).putLevelGains(RuneCraftoryAttributes.DEFENCE.asHolder(), 204)
                    .putAttributes(RuneCraftoryAttributes.MAGIC_ATTACK.asHolder(), 14).putLevelGains(RuneCraftoryAttributes.MAGIC_ATTACK.asHolder(), 229)
                    .putAttributes(RuneCraftoryAttributes.MAGIC_DEFENCE.asHolder(), 2).putLevelGains(RuneCraftoryAttributes.MAGIC_DEFENCE.asHolder(), 204)
                    .putAttributes(RuneCraftoryAttributes.DIZZY.asHolder(), 3)
                    .putAttributes(RuneCraftoryAttributes.CRITICAL.asHolder(), 1)
                    .putAttributes(RuneCraftoryAttributes.CRITICAL_RESISTANCE.asHolder(), 5)
    ...
    public static final RegistryEntrySupplier<EntityType<?>, EntityType<Hornet>> HORNET = regMonster(EntityType.Builder.of(Hornet::new, MobCategory.MONSTER)
            ...
            new EntityProperties.Builder()
                    .putAttributes(Attributes.MAX_HEALTH, 19).putLevelGains(Attributes.MAX_HEALTH, 599)
                    .putAttributes(Attributes.ATTACK_DAMAGE, 11).putLevelGains(Attributes.ATTACK_DAMAGE, 208)
                    .putAttributes(RuneCraftoryAttributes.DEFENCE.asHolder(), 3).putLevelGains(RuneCraftoryAttributes.DEFENCE.asHolder(), 176)
                    .putAttributes(RuneCraftoryAttributes.MAGIC_ATTACK.asHolder(), 6).putLevelGains(RuneCraftoryAttributes.MAGIC_ATTACK.asHolder(), 160)
                    .putAttributes(RuneCraftoryAttributes.MAGIC_DEFENCE.asHolder(), 4).putLevelGains(RuneCraftoryAttributes.MAGIC_DEFENCE.asHolder(), 179)
                    .putAttributes(RuneCraftoryAttributes.DIZZY.asHolder(), 3)
                    .putAttributes(RuneCraftoryAttributes.CRITICAL.asHolder(), 1)
                    .putAttributes(RuneCraftoryAttributes.CRITICAL_RESISTANCE.asHolder(), 5)
    ...
    public static final RegistryEntrySupplier<EntityType<?>, EntityType<Wolf>> SILVER_WOLF = regMonster(EntityType.Builder.of(Wolf::new, MobCategory.MONSTER)
            ...
            0x9bb9c3, 0x436ea1,
            new EntityProperties.Builder()
                    .putAttributes(Attributes.MAX_HEALTH, 23).putLevelGains(Attributes.MAX_HEALTH, 715)
                    .putAttributes(Attributes.ATTACK_DAMAGE, 12).putLevelGains(Attributes.ATTACK_DAMAGE, 217)
                    .putAttributes(RuneCraftoryAttributes.DEFENCE.asHolder(), 4).putLevelGains(RuneCraftoryAttributes.DEFENCE.asHolder(), 175)
                    .putAttributes(RuneCraftoryAttributes.MAGIC_ATTACK.asHolder(), 5).putLevelGains(RuneCraftoryAttributes.MAGIC_ATTACK.asHolder(), 160)
                    .putAttributes(RuneCraftoryAttributes.MAGIC_DEFENCE.asHolder(), 2).putLevelGains(RuneCraftoryAttributes.MAGIC_DEFENCE.asHolder(), 175)
                    .putAttributes(RuneCraftoryAttributes.DIZZY.asHolder(), 3)
                    .putAttributes(RuneCraftoryAttributes.CRITICAL.asHolder(), 1)
                    .putAttributes(RuneCraftoryAttributes.CRITICAL_RESISTANCE.asHolder(), 5)
    ...
    public static final RegistryEntrySupplier<EntityType<?>, EntityType<LeafBall>> LEAF_BALL = regMonster(EntityType.Builder.of(LeafBall::new, MobCategory.MONSTER)
            ...
            new EntityProperties.Builder()
                    .putAttributes(Attributes.MAX_HEALTH, 24).putLevelGains(Attributes.MAX_HEALTH, 720)
                    .putAttributes(Attributes.ATTACK_DAMAGE, 9).putLevelGains(Attributes.ATTACK_DAMAGE, 200)
                    .putAttributes(RuneCraftoryAttributes.DEFENCE.asHolder(), 3).putLevelGains(RuneCraftoryAttributes.DEFENCE.asHolder(), 165)
                    .putAttributes(RuneCraftoryAttributes.MAGIC_ATTACK.asHolder(), 12).putLevelGains(RuneCraftoryAttributes.MAGIC_ATTACK.asHolder(), 227)
                    .putAttributes(RuneCraftoryAttributes.MAGIC_DEFENCE.asHolder(), 4).putLevelGains(RuneCraftoryAttributes.MAGIC_DEFENCE.asHolder(), 165)
                    .putAttributes(RuneCraftoryAttributes.DIZZY.asHolder(), 3)
                    .putAttributes(RuneCraftoryAttributes.CRITICAL.asHolder(), 1)
                    .putAttributes(RuneCraftoryAttributes.CRITICAL_RESISTANCE.asHolder(), 5)
                    .putAttributes(RuneCraftoryAttributes.FIRE_RESISTANCE.asHolder(), -15)
    ...
    public static final RegistryEntrySupplier<EntityType<?>, EntityType<PalmCat>> PALM_CAT = regMonster(EntityType.Builder.of(PalmCat::new, MobCategory.MONSTER)
            ...
            0xc98f2d, 0xb46d28,
            new EntityProperties.Builder()
                    .putAttributes(Attributes.MAX_HEALTH, 24).putLevelGains(Attributes.MAX_HEALTH, 709)
                    .putAttributes(Attributes.ATTACK_DAMAGE, 13).putLevelGains(Attributes.ATTACK_DAMAGE, 230)
                    .putAttributes(RuneCraftoryAttributes.DEFENCE.asHolder(), 2).putLevelGains(RuneCraftoryAttributes.DEFENCE.asHolder(), 183)
                    .putAttributes(RuneCraftoryAttributes.MAGIC_ATTACK.asHolder(), 6).putLevelGains(RuneCraftoryAttributes.MAGIC_ATTACK.asHolder(), 180)
                    .putAttributes(RuneCraftoryAttributes.MAGIC_DEFENCE.asHolder(), 4).putLevelGains(RuneCraftoryAttributes.MAGIC_DEFENCE.asHolder(), 183)
                    .putAttributes(RuneCraftoryAttributes.DIZZY.asHolder(), 3)
                    .putAttributes(RuneCraftoryAttributes.CRITICAL.asHolder(), 1)
                    .putAttributes(RuneCraftoryAttributes.CRITICAL_RESISTANCE.asHolder(), 5)
                    .putAttributes(RuneCraftoryAttributes.EARTH_RESISTANCE.asHolder(), 15)
    ...
    public static final RegistryEntrySupplier<EntityType<?>, EntityType<PalmCat>> MALM_TIGER = regMonster(EntityType.Builder.of(PalmCat::new, MobCategory.MONSTER)
            ...
            0x8596ae, 0x3a5573,
            new EntityProperties.Builder()
                    .putAttributes(Attributes.MAX_HEALTH, 29).putLevelGains(Attributes.MAX_HEALTH, 711)
                    .putAttributes(Attributes.ATTACK_DAMAGE, 20).putLevelGains(Attributes.ATTACK_DAMAGE, 231)
                    .putAttributes(RuneCraftoryAttributes.DEFENCE.asHolder(), 3).putLevelGains(RuneCraftoryAttributes.DEFENCE.asHolder(), 177)
                    .putAttributes(RuneCraftoryAttributes.MAGIC_ATTACK.asHolder(), 11).putLevelGains(RuneCraftoryAttributes.MAGIC_ATTACK.asHolder(), 180)
                    .putAttributes(RuneCraftoryAttributes.MAGIC_DEFENCE.asHolder(), 4).putLevelGains(RuneCraftoryAttributes.MAGIC_DEFENCE.asHolder(), 188)
                    .putAttributes(RuneCraftoryAttributes.DIZZY.asHolder(), 3)
                    .putAttributes(RuneCraftoryAttributes.CRITICAL.asHolder(), 1)
                    .putAttributes(RuneCraftoryAttributes.CRITICAL_RESISTANCE.asHolder(), 5)
    ...
    public static final RegistryEntrySupplier<EntityType<?>, EntityType<FlowerLily>> FLOWER_LILY = regMonster(EntityType.Builder.of(FlowerLily::new, MobCategory.MONSTER)
            ...
            0xe8b3e7, 0x156e12,
            new EntityProperties.Builder()
                    .putAttributes(Attributes.MAX_HEALTH, 23).putLevelGains(Attributes.MAX_HEALTH, 713)
                    .putAttributes(Attributes.ATTACK_DAMAGE, 16).putLevelGains(Attributes.ATTACK_DAMAGE, 223)
                    .putAttributes(RuneCraftoryAttributes.DEFENCE.asHolder(), 1).putLevelGains(RuneCraftoryAttributes.DEFENCE.asHolder(), 198)
                    .putAttributes(RuneCraftoryAttributes.MAGIC_ATTACK.asHolder(), 12).putLevelGains(RuneCraftoryAttributes.MAGIC_ATTACK.asHolder(), 188)
                    .putAttributes(RuneCraftoryAttributes.MAGIC_DEFENCE.asHolder(), 1).putLevelGains(RuneCraftoryAttributes.MAGIC_DEFENCE.asHolder(), 182)
                    .putAttributes(RuneCraftoryAttributes.DIZZY.asHolder(), 3)
                    .putAttributes(RuneCraftoryAttributes.CRITICAL.asHolder(), 1)
                    .putAttributes(RuneCraftoryAttributes.CRITICAL_RESISTANCE.asHolder(), 5)
    ...
    public static final RegistryEntrySupplier<EntityType<?>, EntityType<FlowerLion>> FLOWER_LION = regMonster(EntityType.Builder.of(FlowerLion::new, MobCategory.MONSTER)
            ...
            0xf2ad7a, 0x893a1d,
            new EntityProperties.Builder()
                    .putAttributes(Attributes.MAX_HEALTH, 26).putLevelGains(Attributes.MAX_HEALTH, 720)
                    .putAttributes(Attributes.ATTACK_DAMAGE, 18).putLevelGains(Attributes.ATTACK_DAMAGE, 235)
                    .putAttributes(RuneCraftoryAttributes.DEFENCE.asHolder(), 2).putLevelGains(RuneCraftoryAttributes.DEFENCE.asHolder(), 208)
                    .putAttributes(RuneCraftoryAttributes.MAGIC_ATTACK.asHolder(), 14).putLevelGains(RuneCraftoryAttributes.MAGIC_ATTACK.asHolder(), 195)
                    .putAttributes(RuneCraftoryAttributes.MAGIC_DEFENCE.asHolder(), 2).putLevelGains(RuneCraftoryAttributes.MAGIC_DEFENCE.asHolder(), 201)
                    .putAttributes(RuneCraftoryAttributes.DIZZY.asHolder(), 3)
                    .putAttributes(RuneCraftoryAttributes.CRITICAL.asHolder(), 1)
                    .putAttributes(RuneCraftoryAttributes.CRITICAL_RESISTANCE.asHolder(), 5)
                    .putAttributes(RuneCraftoryAttributes.FIRE_RESISTANCE.asHolder(), -5)
    ...
    public static final RegistryEntrySupplier<EntityType<?>, EntityType<Scorpion>> SCORPION = regMonster(EntityType.Builder.of(Scorpion::new, MobCategory.MONSTER)
            ...
            0x606060, 0xacacac,
            new EntityProperties.Builder()
                    .putAttributes(Attributes.MAX_HEALTH, 21).putLevelGains(Attributes.MAX_HEALTH, 705)
                    .putAttributes(Attributes.ATTACK_DAMAGE, 13).putLevelGains(Attributes.ATTACK_DAMAGE, 221)
                    .putAttributes(RuneCraftoryAttributes.DEFENCE.asHolder(), 2).putLevelGains(RuneCraftoryAttributes.DEFENCE.asHolder(), 194)
                    .putAttributes(RuneCraftoryAttributes.MAGIC_ATTACK.asHolder(), 7).putLevelGains(RuneCraftoryAttributes.MAGIC_ATTACK.asHolder(), 170)
                    .putAttributes(RuneCraftoryAttributes.MAGIC_DEFENCE.asHolder(), 0).putLevelGains(RuneCraftoryAttributes.MAGIC_DEFENCE.asHolder(), 188)
                    .putAttributes(RuneCraftoryAttributes.DIZZY.asHolder(), 3)
                    .putAttributes(RuneCraftoryAttributes.CRITICAL.asHolder(), 1)
                    .putAttributes(RuneCraftoryAttributes.CRITICAL_RESISTANCE.asHolder(), 5)
    ...
    public static final RegistryEntrySupplier<EntityType<?>, EntityType<Troll>> TROLL = regMonster(EntityType.Builder.of(Troll::new, MobCategory.MONSTER)
            ...
            0xac924b, 0xcfcbbc,
            new EntityProperties.Builder()
                    .putAttributes(Attributes.MAX_HEALTH, 35).putLevelGains(Attributes.MAX_HEALTH, 740)
                    .putAttributes(Attributes.ATTACK_DAMAGE, 21).putLevelGains(Attributes.ATTACK_DAMAGE, 240)
                    .putAttributes(RuneCraftoryAttributes.DEFENCE.asHolder(), 3).putLevelGains(RuneCraftoryAttributes.DEFENCE.asHolder(), 195)
                    .putAttributes(RuneCraftoryAttributes.MAGIC_ATTACK.asHolder(), 2).putLevelGains(RuneCraftoryAttributes.MAGIC_ATTACK.asHolder(), 150)
                    .putAttributes(RuneCraftoryAttributes.MAGIC_DEFENCE.asHolder(), 2).putLevelGains(RuneCraftoryAttributes.MAGIC_DEFENCE.asHolder(), 185)
    ...
    public static final RegistryEntrySupplier<EntityType<?>, EntityType<VeggieGhost>> TOMATO_GHOST = regMonster(EntityType.Builder.of(VeggieGhost::new, MobCategory.MONSTER)
            ...
            new EntityProperties.Builder()
                    .putAttributes(Attributes.MAX_HEALTH, 22).putLevelGains(Attributes.MAX_HEALTH, 710)
                    .putAttributes(Attributes.ATTACK_DAMAGE, 16).putLevelGains(Attributes.ATTACK_DAMAGE, 210)
                    .putAttributes(RuneCraftoryAttributes.DEFENCE.asHolder(), 1).putLevelGains(RuneCraftoryAttributes.DEFENCE.asHolder(), 180)
                    .putAttributes(RuneCraftoryAttributes.MAGIC_ATTACK.asHolder(), 16).putLevelGains(RuneCraftoryAttributes.MAGIC_ATTACK.asHolder(), 210)
                    .putAttributes(RuneCraftoryAttributes.MAGIC_DEFENCE.asHolder(), 2).putLevelGains(RuneCraftoryAttributes.MAGIC_DEFENCE.asHolder(), 180)
                    .putAttributes(RuneCraftoryAttributes.DIZZY.asHolder(), 3)
                    .putAttributes(RuneCraftoryAttributes.CRITICAL.asHolder(), 1)
                    .putAttributes(RuneCraftoryAttributes.CRITICAL_RESISTANCE.asHolder(), 5)
                    .putAttributes(RuneCraftoryAttributes.WIND_RESISTANCE.asHolder(), -5)
    ...
    public static final RegistryEntrySupplier<EntityType<?>, EntityType<Mage>> LITTLE_EMPEROR = regMonster(EntityType.Builder.of(Mage::new, MobCategory.MONSTER)
            ...
            0x49ab5f, 0xdedede,
            new EntityProperties.Builder()
                    .putAttributes(Attributes.MAX_HEALTH, 21).putLevelGains(Attributes.MAX_HEALTH, 720)
                    .putAttributes(Attributes.ATTACK_DAMAGE, 13).putLevelGains(Attributes.ATTACK_DAMAGE, 208)
                    .putAttributes(RuneCraftoryAttributes.DEFENCE.asHolder(), 1).putLevelGains(RuneCraftoryAttributes.DEFENCE.asHolder(), 175)
                    .putAttributes(RuneCraftoryAttributes.MAGIC_ATTACK.asHolder(), 17).putLevelGains(RuneCraftoryAttributes.MAGIC_ATTACK.asHolder(), 221)
                    .putAttributes(RuneCraftoryAttributes.MAGIC_DEFENCE.asHolder(), 4).putLevelGains(RuneCraftoryAttributes.MAGIC_DEFENCE.asHolder(), 202)
                    .putAttributes(RuneCraftoryAttributes.DIZZY.asHolder(), 3)
                    .putAttributes(RuneCraftoryAttributes.CRITICAL.asHolder(), 1)
                    .putAttributes(RuneCraftoryAttributes.CRITICAL_RESISTANCE.asHolder(), 5)
                    .putAttributes(RuneCraftoryAttributes.LIGHT_RESISTANCE.asHolder(), 15)
    ...
    public static final RegistryEntrySupplier<EntityType<?>, EntityType<Demon>> DEMON = regMonster(EntityType.Builder.of(Demon::new, MobCategory.MONSTER)
            ...
            0xba8b84, 0x6a5450,
            new EntityProperties.Builder()
                    .putAttributes(Attributes.MAX_HEALTH, 27).putLevelGains(Attributes.MAX_HEALTH, 715)
                    .putAttributes(Attributes.ATTACK_DAMAGE, 19).putLevelGains(Attributes.ATTACK_DAMAGE, 214)
                    .putAttributes(RuneCraftoryAttributes.DEFENCE.asHolder(), 3).putLevelGains(RuneCraftoryAttributes.DEFENCE.asHolder(), 185)
                    .putAttributes(RuneCraftoryAttributes.MAGIC_ATTACK.asHolder(), 16).putLevelGains(RuneCraftoryAttributes.MAGIC_ATTACK.asHolder(), 219)
                    .putAttributes(RuneCraftoryAttributes.MAGIC_DEFENCE.asHolder(), 4).putLevelGains(RuneCraftoryAttributes.MAGIC_DEFENCE.asHolder(), 185)
                    .putAttributes(RuneCraftoryAttributes.DIZZY.asHolder(), 3)
                    .putAttributes(RuneCraftoryAttributes.CRITICAL.asHolder(), 1)
                    .putAttributes(RuneCraftoryAttributes.CRITICAL_RESISTANCE.asHolder(), 5)
                    .putAttributes(RuneCraftoryAttributes.LIGHT_RESISTANCE.asHolder(), -15)
    ...
    public static final RegistryEntrySupplier<EntityType<?>, EntityType<Demon>> ARCH_DEMON = regMonster(EntityType.Builder.of(Demon::new, MobCategory.MONSTER)
            ...
            0x9f6a63, 0x372321,
            new EntityProperties.Builder()
                    .putAttributes(Attributes.MAX_HEALTH, 40).putLevelGains(Attributes.MAX_HEALTH, 740)
                    .putAttributes(Attributes.ATTACK_DAMAGE, 22).putLevelGains(Attributes.ATTACK_DAMAGE, 229)
                    .putAttributes(RuneCraftoryAttributes.DEFENCE.asHolder(), 3).putLevelGains(RuneCraftoryAttributes.DEFENCE.asHolder(), 194)
                    .putAttributes(RuneCraftoryAttributes.MAGIC_ATTACK.asHolder(), 18).putLevelGains(RuneCraftoryAttributes.MAGIC_ATTACK.asHolder(), 234)
                    .putAttributes(RuneCraftoryAttributes.MAGIC_DEFENCE.asHolder(), 5).putLevelGains(RuneCraftoryAttributes.MAGIC_DEFENCE.asHolder(), 194)
                    .putAttributes(RuneCraftoryAttributes.DIZZY.asHolder(), 3)
                    .putAttributes(RuneCraftoryAttributes.CRITICAL.asHolder(), 1)
                    .putAttributes(RuneCraftoryAttributes.CRITICAL_RESISTANCE.asHolder(), 5)
                    .putAttributes(RuneCraftoryAttributes.LIGHT_RESISTANCE.asHolder(), -10)
    ...
    public static final RegistryEntrySupplier<EntityType<?>, EntityType<Minotaur>> MINOTAUR = regMonster(EntityType.Builder.of(Minotaur::new, MobCategory.MONSTER)
            ...
            0x61423d, 0x2c2825,
            new EntityProperties.Builder()
                    .putAttributes(Attributes.MAX_HEALTH, 40).putLevelGains(Attributes.MAX_HEALTH, 725)
                    .putAttributes(Attributes.ATTACK_DAMAGE, 23).putLevelGains(Attributes.ATTACK_DAMAGE, 240)
                    .putAttributes(RuneCraftoryAttributes.DEFENCE.asHolder(), 4).putLevelGains(RuneCraftoryAttributes.DEFENCE.asHolder(), 195)
                    .putAttributes(RuneCraftoryAttributes.MAGIC_ATTACK.asHolder(), 12).putLevelGains(RuneCraftoryAttributes.MAGIC_ATTACK.asHolder(), 180)
                    .putAttributes(RuneCraftoryAttributes.MAGIC_DEFENCE.asHolder(), 3).putLevelGains(RuneCraftoryAttributes.MAGIC_DEFENCE.asHolder(), 185)
                    .putAttributes(RuneCraftoryAttributes.DIZZY.asHolder(), 3)
                    .putAttributes(RuneCraftoryAttributes.CRITICAL.asHolder(), 1)
                    .putAttributes(RuneCraftoryAttributes.CRITICAL_RESISTANCE.asHolder(), 5)
                    .xp(35).tamingChance(0.05f),
    ...
    public static final RegistryEntrySupplier<EntityType<?>, EntityType<Minotaur>> MINOTAUR_KING = regMonster(EntityType.Builder.of(Minotaur::new, MobCategory.MONSTER)
            ...
            0x344a53, 0x907822,
            new EntityProperties.Builder()
                    .putAttributes(Attributes.MAX_HEALTH, 70).putLevelGains(Attributes.MAX_HEALTH, 750)
                    .putAttributes(Attributes.ATTACK_DAMAGE, 30).putLevelGains(Attributes.ATTACK_DAMAGE, 255)
                    .putAttributes(RuneCraftoryAttributes.DEFENCE.asHolder(), 5).putLevelGains(RuneCraftoryAttributes.DEFENCE.asHolder(), 206)
                    .putAttributes(RuneCraftoryAttributes.MAGIC_ATTACK.asHolder(), 12).putLevelGains(RuneCraftoryAttributes.MAGIC_ATTACK.asHolder(), 185)
                    .putAttributes(RuneCraftoryAttributes.MAGIC_DEFENCE.asHolder(), 5).putLevelGains(RuneCraftoryAttributes.MAGIC_DEFENCE.asHolder(), 198)
                    .putAttributes(RuneCraftoryAttributes.DIZZY.asHolder(), 3)
                    .putAttributes(RuneCraftoryAttributes.CRITICAL.asHolder(), 1)
                    .putAttributes(RuneCraftoryAttributes.CRITICAL_RESISTANCE.asHolder(), 5)
                    .xp(35).tamingChance(0.05f),
    ...
    public static final RegistryEntrySupplier<EntityType<?>, EntityType<Chimera>> CHIMERA = regBoss(EntityType.Builder.of(Chimera::new, MobCategory.MONSTER)
            ...
            0x536983, 0xaaa7c8,
            new EntityProperties.Builder()
                    .putAttributes(Attributes.MAX_HEALTH, 315).putLevelGains(Attributes.MAX_HEALTH, 915)
                    .putAttributes(Attributes.ATTACK_DAMAGE, 17).putLevelGains(Attributes.ATTACK_DAMAGE, 252)
                    .putAttributes(RuneCraftoryAttributes.DEFENCE.asHolder(), 4).putLevelGains(RuneCraftoryAttributes.DEFENCE.asHolder(), 192)
                    .putAttributes(RuneCraftoryAttributes.MAGIC_ATTACK.asHolder(), 11).putLevelGains(RuneCraftoryAttributes.MAGIC_ATTACK.asHolder(), 239)
                    .putAttributes(RuneCraftoryAttributes.MAGIC_DEFENCE.asHolder(), 3).putLevelGains(RuneCraftoryAttributes.MAGIC_DEFENCE.asHolder(), 198)
    ...
    public static final RegistryEntrySupplier<EntityType<?>, EntityType<Rafflesia>> RAFFLESIA = regBoss(EntityType.Builder.of(Rafflesia::new, MobCategory.MONSTER)
            ...
            0x9b58ba, 0x0a8414,
            new EntityProperties.Builder()
                    .putAttributes(Attributes.MAX_HEALTH, 330).putLevelGains(Attributes.MAX_HEALTH, 925)
                    .putAttributes(Attributes.ATTACK_DAMAGE, 13).putLevelGains(Attributes.ATTACK_DAMAGE, 221)
                    .putAttributes(RuneCraftoryAttributes.DEFENCE.asHolder(), 4).putLevelGains(RuneCraftoryAttributes.DEFENCE.asHolder(), 188)
                    .putAttributes(RuneCraftoryAttributes.MAGIC_ATTACK.asHolder(), 14).putLevelGains(RuneCraftoryAttributes.MAGIC_ATTACK.asHolder(), 241)
                    .putAttributes(RuneCraftoryAttributes.MAGIC_DEFENCE.asHolder(), 6).putLevelGains(RuneCraftoryAttributes.MAGIC_DEFENCE.asHolder(), 199)
                    .putAttributes(Attributes.ARMOR, 5).putAttributes(Attributes.ARMOR_TOUGHNESS, 3)
                    .putAttributes(RuneCraftoryAttributes.EARTH_RESISTANCE.asHolder(), 15)
                    .putAttributes(RuneCraftoryAttributes.WATER_RESISTANCE.asHolder(), 15)
                    .putAttributes(RuneCraftoryAttributes.FIRE_RESISTANCE.asHolder(), 15)
                    .putAttributes(RuneCraftoryAttributes.WIND_RESISTANCE.asHolder(), -25)
    ...
    public static final RegistryEntrySupplier<EntityType<?>, EntityType<Grimoire>> GRIMOIRE = regBoss(EntityType.Builder.of(Grimoire::new, MobCategory.MONSTER)
            ...
            0x3b785c, 0x2e4d3f,
            new EntityProperties.Builder()
                    .putAttributes(Attributes.MAX_HEALTH, 350).putLevelGains(Attributes.MAX_HEALTH, 925)
                    .putAttributes(Attributes.ATTACK_DAMAGE, 18).putLevelGains(Attributes.ATTACK_DAMAGE, 242)
                    .putAttributes(RuneCraftoryAttributes.DEFENCE.asHolder(), 5.5).putLevelGains(RuneCraftoryAttributes.DEFENCE.asHolder(), 203)
                    .putAttributes(RuneCraftoryAttributes.MAGIC_ATTACK.asHolder(), 14).putLevelGains(RuneCraftoryAttributes.MAGIC_ATTACK.asHolder(), 228)
                    .putAttributes(RuneCraftoryAttributes.MAGIC_DEFENCE.asHolder(), 4).putLevelGains(RuneCraftoryAttributes.MAGIC_DEFENCE.asHolder(), 203)
    ...
    public static final RegistryEntrySupplier<EntityType<?>, EntityType<DeadTree>> DEAD_TREE = regBoss(EntityType.Builder.of(DeadTree::new, MobCategory.MONSTER)
            ...
            0x3e4a40, 0x227904,
            new EntityProperties.Builder()
                    .putAttributes(Attributes.MAX_HEALTH, 300).putLevelGains(Attributes.MAX_HEALTH, 940)
                    .putAttributes(Attributes.ATTACK_DAMAGE, 17).putLevelGains(Attributes.ATTACK_DAMAGE, 237)
                    .putAttributes(RuneCraftoryAttributes.DEFENCE.asHolder(), 4).putLevelGains(RuneCraftoryAttributes.DEFENCE.asHolder(), 196)
                    .putAttributes(RuneCraftoryAttributes.MAGIC_ATTACK.asHolder(), 13).putLevelGains(RuneCraftoryAttributes.MAGIC_ATTACK.asHolder(), 232)
                    .putAttributes(RuneCraftoryAttributes.MAGIC_DEFENCE.asHolder(), 3).putLevelGains(RuneCraftoryAttributes.MAGIC_DEFENCE.asHolder(), 196)
    ...
    public static final RegistryEntrySupplier<EntityType<?>, EntityType<Raccoon>> RACCOON = regBoss(EntityType.Builder.of(Raccoon::new, MobCategory.MONSTER)
            ...
            0xcb8055, 0x6d4342,
            new EntityProperties.Builder()
                    .putAttributes(Attributes.MAX_HEALTH, 290).putLevelGains(Attributes.MAX_HEALTH, 915)
                    .putAttributes(Attributes.ATTACK_DAMAGE, 17).putLevelGains(Attributes.ATTACK_DAMAGE, 233)
                    .putAttributes(RuneCraftoryAttributes.DEFENCE.asHolder(), 4.5).putLevelGains(RuneCraftoryAttributes.DEFENCE.asHolder(), 199)
                    .putAttributes(RuneCraftoryAttributes.MAGIC_ATTACK.asHolder(), 12).putLevelGains(RuneCraftoryAttributes.MAGIC_ATTACK.asHolder(), 228)
                    .putAttributes(RuneCraftoryAttributes.MAGIC_DEFENCE.asHolder(), 3).putLevelGains(RuneCraftoryAttributes.MAGIC_DEFENCE.asHolder(), 205)
    ...
    public static final RegistryEntrySupplier<EntityType<?>, EntityType<Skelefang>> SKELEFANG = regBoss(EntityType.Builder.of(Skelefang::new, MobCategory.MONSTER)
            ...
            0x615237, 0xc2a982,
            new EntityProperties.Builder()
                    .putAttributes(Attributes.MAX_HEALTH, 225).putLevelGains(Attributes.MAX_HEALTH, 900)
                    .putAttributes(Attributes.ATTACK_DAMAGE, 18).putLevelGains(Attributes.ATTACK_DAMAGE, 244)
                    .putAttributes(RuneCraftoryAttributes.DEFENCE.asHolder(), 5).putLevelGains(RuneCraftoryAttributes.DEFENCE.asHolder(), 211)
                    .putAttributes(RuneCraftoryAttributes.MAGIC_ATTACK.asHolder(), 14).putLevelGains(RuneCraftoryAttributes.MAGIC_ATTACK.asHolder(), 214)
                    .putAttributes(RuneCraftoryAttributes.MAGIC_DEFENCE.asHolder(), 4).putLevelGains(RuneCraftoryAttributes.MAGIC_DEFENCE.asHolder(), 187)
    ...
    public static final RegistryEntrySupplier<EntityType<?>, EntityType<Ambrosia>> AMBROSIA = regBoss(EntityType.Builder.of(Ambrosia::new, MobCategory.MONSTER)
            ...
            0x00ff00, 0xe600e6,
            new EntityProperties.Builder()
                    .putAttributes(Attributes.MAX_HEALTH, 300).putLevelGains(Attributes.MAX_HEALTH, 930)
                    .putAttributes(Attributes.ATTACK_DAMAGE, 16).putLevelGains(Attributes.ATTACK_DAMAGE, 225)
                    .putAttributes(RuneCraftoryAttributes.DEFENCE.asHolder(), 4).putLevelGains(RuneCraftoryAttributes.DEFENCE.asHolder(), 180)
                    .putAttributes(RuneCraftoryAttributes.MAGIC_ATTACK.asHolder(), 11).putLevelGains(RuneCraftoryAttributes.MAGIC_ATTACK.asHolder(), 230)
                    .putAttributes(RuneCraftoryAttributes.MAGIC_DEFENCE.asHolder(), 4).putLevelGains(RuneCraftoryAttributes.MAGIC_DEFENCE.asHolder(), 195)
                    .putAttributes(Attributes.ARMOR, 4).putAttributes(Attributes.ARMOR_TOUGHNESS, 2)
                    .putAttributes(RuneCraftoryAttributes.EARTH_RESISTANCE.asHolder(), 25)
                    .putAttributes(RuneCraftoryAttributes.WIND_RESISTANCE.asHolder(), -25)
                    .putAttributes(RuneCraftoryAttributes.LOVE_RESISTANCE.asHolder(), -25)
    ...
    public static final RegistryEntrySupplier<EntityType<?>, EntityType<Thunderbolt>> THUNDERBOLT = regBoss(EntityType.Builder.of(Thunderbolt::new, MobCategory.MONSTER)
            ...
            0x212121, 0x2f1177,
            new EntityProperties.Builder()
                    .putAttributes(Attributes.MAX_HEALTH, 325).putLevelGains(Attributes.MAX_HEALTH, 910)
                    .putAttributes(Attributes.ATTACK_DAMAGE, 19).putLevelGains(Attributes.ATTACK_DAMAGE, 230)
                    .putAttributes(RuneCraftoryAttributes.DEFENCE.asHolder(), 4).putLevelGains(RuneCraftoryAttributes.DEFENCE.asHolder(), 190)
                    .putAttributes(RuneCraftoryAttributes.MAGIC_ATTACK.asHolder(), 14).putLevelGains(RuneCraftoryAttributes.MAGIC_ATTACK.asHolder(), 222)
                    .putAttributes(RuneCraftoryAttributes.MAGIC_DEFENCE.asHolder(), 3).putLevelGains(RuneCraftoryAttributes.MAGIC_DEFENCE.asHolder(), 190)
    ...
    public static final RegistryEntrySupplier<EntityType<?>, EntityType<Marionetta>> MARIONETTA = regBoss(EntityType.Builder.of(Marionetta::new, MobCategory.MONSTER)
            ...
            0xb86b13, 0xd8d7d7,
            new EntityProperties.Builder()
                    .putAttributes(Attributes.MAX_HEALTH, 320).putLevelGains(Attributes.MAX_HEALTH, 920)
                    .putAttributes(Attributes.ATTACK_DAMAGE, 20).putLevelGains(Attributes.ATTACK_DAMAGE, 236)
                    .putAttributes(RuneCraftoryAttributes.DEFENCE.asHolder(), 5).putLevelGains(RuneCraftoryAttributes.DEFENCE.asHolder(), 197)
                    .putAttributes(RuneCraftoryAttributes.MAGIC_ATTACK.asHolder(), 15).putLevelGains(RuneCraftoryAttributes.MAGIC_ATTACK.asHolder(), 229)
                    .putAttributes(RuneCraftoryAttributes.MAGIC_DEFENCE.asHolder(), 4).putLevelGains(RuneCraftoryAttributes.MAGIC_DEFENCE.asHolder(), 197)
    ...
    public static final RegistryEntrySupplier<EntityType<?>, EntityType<Handonetta>> HANDONETTA = regBoss(EntityType.Builder.of(Handonetta::new, MobCategory.MONSTER)
            ...
            new EntityProperties.Builder()
                    .putAttributes(Attributes.MAX_HEALTH, 300).putLevelGains(Attributes.MAX_HEALTH, 910)
                    .putAttributes(Attributes.ATTACK_DAMAGE, 21).putLevelGains(Attributes.ATTACK_DAMAGE, 240)
                    .putAttributes(RuneCraftoryAttributes.DEFENCE.asHolder(), 4).putLevelGains(RuneCraftoryAttributes.DEFENCE.asHolder(), 195)
                    .putAttributes(RuneCraftoryAttributes.MAGIC_ATTACK.asHolder(), 15).putLevelGains(RuneCraftoryAttributes.MAGIC_ATTACK.asHolder(), 226)
                    .putAttributes(RuneCraftoryAttributes.MAGIC_DEFENCE.asHolder(), 4).putLevelGains(RuneCraftoryAttributes.MAGIC_DEFENCE.asHolder(), 195)
                    .putAttributes(Attributes.ARMOR, 4).putAttributes(Attributes.ARMOR_TOUGHNESS, 2)
                    .putAttributes(RuneCraftoryAttributes.DARK_RESISTANCE.asHolder(), 25)
                    .putAttributes(RuneCraftoryAttributes.LIGHT_RESISTANCE.asHolder(), -25)
    ...
    public static final RegistryEntrySupplier<EntityType<?>, EntityType<Sano>> SANO = regBoss(EntityType.Builder.of(Sano::new, MobCategory.MONSTER)
            ...
            0xa18c4a, 0xa82626,
            new EntityProperties.Builder()
                    .putAttributes(Attributes.MAX_HEALTH, 275).putLevelGains(Attributes.MAX_HEALTH, 950)
                    .putAttributes(Attributes.ATTACK_DAMAGE, 14).putLevelGains(Attributes.ATTACK_DAMAGE, 210)
                    .putAttributes(RuneCraftoryAttributes.DEFENCE.asHolder(), 6).putLevelGains(RuneCraftoryAttributes.DEFENCE.asHolder(), 209)
                    .putAttributes(RuneCraftoryAttributes.MAGIC_ATTACK.asHolder(), 15).putLevelGains(RuneCraftoryAttributes.MAGIC_ATTACK.asHolder(), 232)
                    .putAttributes(RuneCraftoryAttributes.MAGIC_DEFENCE.asHolder(), 5).putLevelGains(RuneCraftoryAttributes.MAGIC_DEFENCE.asHolder(), 199)
    ...
    public static final RegistryEntrySupplier<EntityType<?>, EntityType<Uno>> UNO = regBoss(EntityType.Builder.of(Uno::new, MobCategory.MONSTER)
            ...
            new EntityProperties.Builder()
                    .putAttributes(Attributes.MAX_HEALTH, 275).putLevelGains(Attributes.MAX_HEALTH, 950)
                    .putAttributes(Attributes.ATTACK_DAMAGE, 14).putLevelGains(Attributes.ATTACK_DAMAGE, 210)
                    .putAttributes(RuneCraftoryAttributes.DEFENCE.asHolder(), 5).putLevelGains(RuneCraftoryAttributes.DEFENCE.asHolder(), 209)
                    .putAttributes(RuneCraftoryAttributes.MAGIC_ATTACK.asHolder(), 15).putLevelGains(RuneCraftoryAttributes.MAGIC_ATTACK.asHolder(), 232)
                    .putAttributes(RuneCraftoryAttributes.MAGIC_DEFENCE.asHolder(), 6).putLevelGains(RuneCraftoryAttributes.MAGIC_DEFENCE.asHolder(), 199)
                    .putAttributes(Attributes.ARMOR, 8).putAttributes(Attributes.ARMOR_TOUGHNESS, 5)
                    .putAttributes(RuneCraftoryAttributes.WATER_RESISTANCE.asHolder(), 50)
    ...
    public static final RegistryEntrySupplier<EntityType<?>, EntityType<Sarcophagus>> SARCOPHAGUS = regBoss(EntityType.Builder.of(Sarcophagus::new, MobCategory.MONSTER)
            ...
            0x482f27, 0xf3d07f,
            new EntityProperties.Builder()
                    .putAttributes(Attributes.MAX_HEALTH, 350).putLevelGains(Attributes.MAX_HEALTH, 933)
                    .putAttributes(Attributes.ATTACK_DAMAGE, 17).putLevelGains(Attributes.ATTACK_DAMAGE, 226)
                    .putAttributes(RuneCraftoryAttributes.DEFENCE.asHolder(), 6).putLevelGains(RuneCraftoryAttributes.DEFENCE.asHolder(), 193)
                    .putAttributes(RuneCraftoryAttributes.MAGIC_ATTACK.asHolder(), 18).putLevelGains(RuneCraftoryAttributes.MAGIC_ATTACK.asHolder(), 230)
                    .putAttributes(RuneCraftoryAttributes.MAGIC_DEFENCE.asHolder(), 6).putLevelGains(RuneCraftoryAttributes.MAGIC_DEFENCE.asHolder(), 193)
