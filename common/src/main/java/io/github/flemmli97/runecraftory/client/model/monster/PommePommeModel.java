...
public class PommePommeModel<T extends PommePomme> extends ExtendedEntityModel<T> implements RideableModel<T> {
    ...
    public PommePommeModel(ResourceLocation location, ResourceLocation animation) {
        super(location, animation);
    }
