...
public class AppleProjectileRender extends ItemProjectileRenderer<AppleProjectileEntity> {
    ...
    public AppleProjectileRender(EntityRendererProvider.Context ctx) {
        super(ctx);
    }
    ...
    @Override
    public Type getRenderType(AppleProjectileEntity entity) {
        return Type.NORMAL;
    }

    @Override
    public ItemStack getRenderItemStack(AppleProjectileEntity entity) {
        return STACK;
    }
}