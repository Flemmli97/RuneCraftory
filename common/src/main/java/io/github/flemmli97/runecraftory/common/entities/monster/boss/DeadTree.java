...
public class DeadTree extends BossMonster {
    ...
    public ExtendedBehaviour<? extends BaseMonster> getCombatAI() {
        return AttackBehaviourBuilder.<DeadTree>create()
                ...
                .condition(m -> !m.isEnraged() && MonsterBehaviourUtils.ifCloserThan(16).test(m))
                .prepare(new SetWalkTargetToAttackTarget<DeadTree>().closeEnoughDist(MonsterBehaviourUtils.closeEnough(5)))
                .prepareOptional(MonsterBehaviourUtils.timedMovement())
                .end(9)
