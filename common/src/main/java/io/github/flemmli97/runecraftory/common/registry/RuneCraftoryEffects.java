...
public class RuneCraftoryEffects {
    ...
    public static final RegistryEntrySupplier<MobEffect, SyncedMobEffect> FATIGUE = EFFECTS.register("fatigue", () -> new SyncedMobEffect(MobEffectCategory.HARMFUL, 0, S2CEntityDataSync.DataType.FATIGUE));
    ...
    public static final RegistryEntrySupplier<MobEffect, SyncedMobEffect> SEAL = EFFECTS.register("sealed", () -> new SyncedMobEffect(MobEffectCategory.HARMFUL, 0, S2CEntityDataSync.DataType.SEAL));
