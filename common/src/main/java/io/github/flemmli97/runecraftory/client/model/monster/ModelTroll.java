...
public class ModelTroll<T extends EntityTroll> extends EntityModel<T> implements ExtendedModel, RideableModel<T> {
    ...
    public static final ModelLayerLocation LAYER_LOCATION = new ModelLayerLocation(RuneCraftory.modRes("troll"), "main");
    ...
    public ModelTroll(ModelPart root) {
        ...
        this.anim = AnimationManager.getInstance().getAnimation(RuneCraftory.modRes("troll"));
