...
public class ModelMage<T extends EntityMage> extends EntityModel<T> implements ExtendedModel, RideableModel<T> {
    ...
    public static final ModelLayerLocation LAYER_LOCATION = new ModelLayerLocation(RuneCraftory.modRes("mage"), "main");
    ...
    public ModelMage(ModelPart root) {
        ...
        this.anim = AnimationManager.getInstance().getAnimation(RuneCraftory.modRes("mage"));
