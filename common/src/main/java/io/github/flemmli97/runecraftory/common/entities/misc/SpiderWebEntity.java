...
public class SpiderWebEntity extends BaseProjectile {

    public SpiderWebEntity(EntityType<? extends SpiderWebEntity> type, Level level) {
        super(type, level);
    }

    public SpiderWebEntity(Level level, LivingEntity shooter) {
        super(RuneCraftoryEntities.SPIDER_WEB.get(), level, shooter);
    }
