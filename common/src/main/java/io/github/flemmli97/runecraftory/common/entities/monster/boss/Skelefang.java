...
public class Skelefang extends BossMonster {
    ...
    public ExtendedBehaviour<? extends BaseMonster> getCombatAI() {
        return AttackBehaviourBuilder.<Skelefang>create()
                ...
                .prepare(new SetWalkTargetToAttackTarget<Skelefang>().closeEnoughDist(MonsterBehaviourUtils.closeEnough(8)))
                .prepareOptional(new MoveToAttackTarget<>())
                .end(9)
                ...
                .prepare(new SetWalkTargetToAttackTarget<Skelefang>().closeEnoughDist(MonsterBehaviourUtils.closeEnough(7)))
                .prepareOptional(new MoveToAttackTarget<>())
                .end(11)
                .build();
    }
