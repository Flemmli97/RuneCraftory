...
public class ChemistryBlock extends CraftingBlock {

    public static final MapCodec<ChemistryBlock> CODEC = simpleCodec(ChemistryBlock::new);
    ...
    public ChemistryBlock(Properties props) {
        super(props);
    }

    @Override
    public MapCodec<ChemistryBlock> codec() {
        return CODEC;
    }
