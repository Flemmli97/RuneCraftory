...
public class RaccoonBerserkModel<T extends Raccoon> extends RaccoonBaseModel<T> {

    public static final ResourceLocation LOCATION = RuneCraftory.modRes("entity/raccoon_berserk");
