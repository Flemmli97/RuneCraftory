...
public class FeatureModel<T extends Entity> extends EntityModel<T> implements ExtendedModel {
    ...
    public void setupAnim(T entity, float limbSwing, float limbSwingAmount, float ageInTicks, float netHeadYaw, float headPitch) {
        ...
        if (this.animations != null) {
            ...
            animations.doAnimation(this, "idle", entity.tickCount, this.partialTicks);
            if (this.main.swimAmount == 0) {
                animations.doAnimation(this, "walk", entity.tickCount, this.partialTicks, 1, false, true);
            } else {
                animations.doAnimation(this, "swim", entity.tickCount, this.partialTicks, 1, false, true);
            }
            if (this.main.crouching) {
                animations.doAnimation(this, "crouching", entity.tickCount, this.partialTicks, 1, false, true);
            }
            if (this.main.riding) {
                animations.doAnimation(this, "riding", entity.tickCount, this.partialTicks, 1, false, true);
            }
        }
    }
