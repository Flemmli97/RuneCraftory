...
public class ModelBuffamoo<T extends EntityBuffamoo> extends EntityModel<T> implements ExtendedModel, RideableModel<T> {
    ...
    public static final ModelLayerLocation LAYER_LOCATION = new ModelLayerLocation(RuneCraftory.modRes("buffamoo"), "main");
    ...
    public ModelBuffamoo(ModelPart root) {
        ...
        this.anim = AnimationManager.getInstance().getAnimation(RuneCraftory.modRes("buffamoo"));
