...
import io.github.flemmli97.runecraftory.client.model.monster.WispModel;
...
public class WispRender<T extends WispBase> extends RenderMonster<T, WispModel<T>> {

    public WispRender(EntityRendererProvider.Context ctx, ResourceLocation tex) {
        super(ctx, new WispModel<>(), tex, 0);
    }
    ...
    public boolean shouldRender(T entity, Frustum camera, double camX, double camY, double camZ) {
        ...
        if (anim != null && anim.is(WispBase.VANISH)) {
