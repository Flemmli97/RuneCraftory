...
public class MarionettaModel<T extends Marionetta> extends ExtendedEntityModel<T> implements RideableModel<T> {
    ...
    public void setupAnim(T entity, float limbSwing, float limbSwingAmount, float ageInTicks, float netHeadYaw, float headPitch) {
        ...
        this.animation.get().doAnimation(this, entity.getAnimationHandler(), partialTick, a -> false, a -> a.is(Marionetta.CHEST_ATTACK) && entity.caughtTarget() ? "chest_attack_hit" : a.getAnimation());
    }
