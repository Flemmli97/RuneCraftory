...
public class TreasureChestSpawnegg extends SpawnEgg {
    ...
    public void appendHoverText(ItemStack stack, @Nullable Level level, List<Component> tooltipComponents, TooltipFlag isAdvanced) {
        tooltipComponents.add(new TranslatableComponent("tooltip.item.treasure_chest").withStyle(ChatFormatting.GOLD));
        tooltipComponents.add(new TranslatableComponent("tooltip.item.treasure_level", this.getTier(stack) + 1).withStyle(ChatFormatting.AQUA));
