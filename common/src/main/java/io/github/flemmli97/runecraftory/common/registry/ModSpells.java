...
public class ModSpells {
    ...
    public static final RegistryEntrySupplier<Spell> FIREBALL = registerSpell("fireball", () -> new FireballSpell(false), new SpellProperties.Builder(20, 10).withXPGain(EnumSkills.FIRE, 2).affectedSkill(EnumSkills.FIRE));
    public static final RegistryEntrySupplier<Spell> BIG_FIREBALL = registerSpell("big_fireball", () -> new FireballSpell(true), new SpellProperties.Builder(20, 15).withXPGain(EnumSkills.FIRE, 4).affectedSkill(EnumSkills.FIRE));
    public static final RegistryEntrySupplier<Spell> EXPLOSION = registerSpell("explosion", ExplosionSpell::new, new SpellProperties.Builder(25, 45).withXPGain(EnumSkills.FIRE, 10).affectedSkill(EnumSkills.FIRE));
    public static final RegistryEntrySupplier<Spell> WATER_LASER = registerSpell("water_laser", WaterLaserSpell::new, new SpellProperties.Builder(40, 10).withXPGain(EnumSkills.WATER, 6).affectedSkill(EnumSkills.WATER));
    public static final RegistryEntrySupplier<Spell> PARALLEL_LASER = registerSpell("parallel_laser", DoubleWaterLaserSpell::new, new SpellProperties.Builder(40, 20).withXPGain(EnumSkills.WATER, 8).affectedSkill(EnumSkills.WATER));
    public static final RegistryEntrySupplier<Spell> DELTA_LASER = registerSpell("delta_laser", TripleWaterLaserSpell::new, new SpellProperties.Builder(40, 40).withXPGain(EnumSkills.WATER, 10).affectedSkill(EnumSkills.WATER));
    public static final RegistryEntrySupplier<Spell> SCREW_ROCK = registerSpell("screw_rock", () -> new RockSpearSpell(false), new SpellProperties.Builder(20, 10).withXPGain(EnumSkills.EARTH, 6).affectedSkill(EnumSkills.EARTH));
    public static final RegistryEntrySupplier<Spell> EARTH_SPIKE = registerSpell("earth_spike", EarthSpikeSpell::new, new SpellProperties.Builder(20, 20).withXPGain(EnumSkills.EARTH, 8).affectedSkill(EnumSkills.EARTH));
    public static final RegistryEntrySupplier<Spell> AVENGER_ROCK = registerSpell("avenger_rock", () -> new RockSpearSpell(true), new SpellProperties.Builder(20, 40).withXPGain(EnumSkills.EARTH, 10).affectedSkill(EnumSkills.EARTH));
    public static final RegistryEntrySupplier<Spell> SONIC = registerSpell("sonic", WindBladeSpell::new, new SpellProperties.Builder(20, 10).withXPGain(EnumSkills.WIND, 6).affectedSkill(EnumSkills.WIND));
    public static final RegistryEntrySupplier<Spell> DOUBLE_SONIC = registerSpell("double_sonic", DoubleWindBladeSpell::new, new SpellProperties.Builder(20, 20).withXPGain(EnumSkills.WIND, 8).affectedSkill(EnumSkills.WIND));
    public static final RegistryEntrySupplier<Spell> PENETRATE_SONIC = registerSpell("penetrate_sonic", PenetrateWindBladeSpell::new, new SpellProperties.Builder(20, 40).withXPGain(EnumSkills.WIND, 10).affectedSkill(EnumSkills.WIND));
    public static final RegistryEntrySupplier<Spell> LIGHT_BARRIER = registerSpell("light_barrier", LightBarrierSpell::new, new SpellProperties.Builder(20, 10).withXPGain(EnumSkills.LIGHT, 6).affectedSkill(EnumSkills.LIGHT));
    public static final RegistryEntrySupplier<Spell> SHINE = registerSpell("shine", ShineSpell::new, new SpellProperties.Builder(20, 20).withXPGain(EnumSkills.LIGHT, 8).affectedSkill(EnumSkills.LIGHT));
    public static final RegistryEntrySupplier<Spell> PRISM = registerSpell("prism", PrismSpell::new, new SpellProperties.Builder(20, 40).withXPGain(EnumSkills.LIGHT, 10).affectedSkill(EnumSkills.LIGHT));
    public static final RegistryEntrySupplier<Spell> DARK_SNAKE = registerSpell("dark_snake", () -> new DarkBallSpell(EntityDarkBall.Type.SNAKE), new SpellProperties.Builder(20, 10).withXPGain(EnumSkills.DARK, 6).affectedSkill(EnumSkills.DARK));
    public static final RegistryEntrySupplier<Spell> DARK_BALL = registerSpell("dark_ball", () -> new DarkBallSpell(EntityDarkBall.Type.BALL), new SpellProperties.Builder(20, 20).withXPGain(EnumSkills.DARK, 8).affectedSkill(EnumSkills.DARK));
    public static final RegistryEntrySupplier<Spell> DARKNESS = registerSpell("darkness", DarknessSpell::new, new SpellProperties.Builder(30, 40).withXPGain(EnumSkills.DARK, 10).affectedSkill(EnumSkills.DARK));
    public static final RegistryEntrySupplier<Spell> CURE = registerSpell("cure", HealT1Spell::new, new SpellProperties.Builder(20, 4).withXPGain(EnumSkills.LOVE, 8).affectedSkill(EnumSkills.LOVE).usePercentageCost());
    public static final RegistryEntrySupplier<Spell> CURE_ALL = registerSpell("cure_all", HealT2Spell::new, new SpellProperties.Builder(20, 15).withXPGain(EnumSkills.LOVE, 16).affectedSkill(EnumSkills.LOVE).usePercentageCost());
    public static final RegistryEntrySupplier<Spell> MASTER_CURE = registerSpell("master_cure", HealT3Spell::new, new SpellProperties.Builder(20, 45).withXPGain(EnumSkills.LOVE, 24).affectedSkill(EnumSkills.LOVE).usePercentageCost());
