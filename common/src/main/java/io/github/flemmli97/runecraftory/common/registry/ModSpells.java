...
public class ModSpells {
    ...
    public static final RegistryEntrySupplier<Spell> WIND_SLASH = registerSpell("wind_slash", () -> new WeaponSpell(ModAttackActions.WIND_SLASH, ModTags.LONGSWORDS), new SpellProperties.Builder(5, 10).withXPGain(EnumSkills.LONGSWORD, 10).affectedSkill(EnumSkills.LONGSWORD));
    public static final RegistryEntrySupplier<Spell> FLASH_STRIKE = registerSpell("flash_strike", () -> new WeaponSpell(ModAttackActions.FLASH_STRIKE, ModTags.LONGSWORDS), new SpellProperties.Builder(5, 10).withXPGain(EnumSkills.LONGSWORD, 10).affectedSkill(EnumSkills.LONGSWORD));
    public static final RegistryEntrySupplier<Spell> STEEL_HEART = registerSpell("steel_heart", () -> new WeaponSpell(ModAttackActions.STEEL_HEART, ModTags.LONGSWORDS), new SpellProperties.Builder(5, 10).withXPGain(EnumSkills.LONGSWORD, 10).affectedSkill(EnumSkills.LONGSWORD));
    public static final RegistryEntrySupplier<Spell> DELTA_STRIKE = registerSpell("delta_strike", () -> new WeaponSpell(ModAttackActions.DELTA_STRIKE, ModTags.LONGSWORDS), new SpellProperties.Builder(5, 10).withXPGain(EnumSkills.LONGSWORD, 10).affectedSkill(EnumSkills.LONGSWORD));
    public static final RegistryEntrySupplier<Spell> NAIVE_BLADE = registerSpell("naive_blade", () -> new WeaponSpell(ModAttackActions.NAIVE_BLADE, ModTags.LONGSWORDS), new SpellProperties.Builder(5, 10).withXPGain(EnumSkills.LONGSWORD, 10).affectedSkill(EnumSkills.LONGSWORD));
    public static final RegistryEntrySupplier<Spell> HURRICANE = registerSpell("hurricane", () -> new WeaponSpell(ModAttackActions.HURRICANE, ModTags.SPEARS), new SpellProperties.Builder(5, 10).withXPGain(EnumSkills.SPEAR, 10).affectedSkill(EnumSkills.SPEAR));
    ...
    public static final RegistryEntrySupplier<Spell> UPPER_CUT = registerSpell("upper_cut", () -> new WeaponSpell(ModAttackActions.UPPER_CUT, ModTags.FISTS), new SpellProperties.Builder(5, 10).withXPGain(EnumSkills.FIST, 10).affectedSkill(EnumSkills.FIST));
    public static final RegistryEntrySupplier<Spell> DOUBLE_KICK = registerSpell("double_kick", () -> new WeaponSpell(ModAttackActions.DOUBLE_KICK, ModTags.FISTS), new SpellProperties.Builder(5, 10).withXPGain(EnumSkills.FIST, 10).affectedSkill(EnumSkills.FIST));
    public static final RegistryEntrySupplier<Spell> STRAIGHT_PUNCH = registerSpell("straight_punch", () -> new WeaponSpell(ModAttackActions.STRAIGHT_PUNCH, ModTags.FISTS), new SpellProperties.Builder(5, 10).withXPGain(EnumSkills.FIST, 10).affectedSkill(EnumSkills.FIST));
    public static final RegistryEntrySupplier<Spell> NEKO_DAMASHI = registerSpell("neko_damashi", () -> new WeaponSpell(ModAttackActions.NEKO_DAMASHI, ModTags.FISTS), new SpellProperties.Builder(5, 10).withXPGain(EnumSkills.FIST, 10).affectedSkill(EnumSkills.FIST));
    public static final RegistryEntrySupplier<Spell> RUSH_PUNCH = registerSpell("rush_punch", () -> new WeaponSpell(ModAttackActions.RUSH_PUNCH, ModTags.FISTS), new SpellProperties.Builder(5, 10).withXPGain(EnumSkills.FIST, 10).affectedSkill(EnumSkills.FIST));
    public static final RegistryEntrySupplier<Spell> CYCLONE = registerSpell("cyclone", () -> new WeaponSpell(ModAttackActions.CYCLONE, ModTags.FISTS), new SpellProperties.Builder(5, 10).withXPGain(EnumSkills.FIST, 10).affectedSkill(EnumSkills.FIST));
    public static final RegistryEntrySupplier<Spell> RAPID_MOVE = registerSpell("rapid_move", () -> new WeaponSpell(ModAttackActions.RAPID_MOVE, ModTags.FISTS), new SpellProperties.Builder(5, 10).withXPGain(EnumSkills.FIST, 10).affectedSkill(EnumSkills.FIST));
