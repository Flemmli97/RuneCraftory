...
public class ModSpells {
    ...
    public static final RegistryEntrySupplier<Spell> DRAGON_FIREBALL = registerSpell("vanilla_dragon_fireball", () -> new SimpleVanillaProjectileSpell(SimpleVanillaProjectileSpell.DRAGON_FIREBALL, SoundEvents.ENDER_DRAGON_SHOOT), new SpellProperties.Builder(10, 3));
    ...
    public static final RegistryEntrySupplier<Spell> TRIPLE_FIRE_BALL = registerSpell("triple_fire_ball", () -> new MultiFireballSpell(3, 0.85f, 15), new SpellProperties.Builder(20, 30).withXPGain(EnumSkills.FIRE, 5).affectedSkill(EnumSkills.FIRE));
    public static final RegistryEntrySupplier<Spell> QUAD_FIRE_BALL = registerSpell("quad_fire_ball", () -> new MultiFireballSpell(4, 0.85f, 20), new SpellProperties.Builder(20, 30).withXPGain(EnumSkills.FIRE, 5).affectedSkill(EnumSkills.FIRE));
    ...
    public static final RegistryEntrySupplier<Spell> EXPANDING_DOUBLE_LIGHT = registerSpell("expanding_double_light", () -> new ExpandingLight(2), new SpellProperties.Builder(30, 40).withXPGain(EnumSkills.LIGHT, 10).affectedSkill(EnumSkills.LIGHT));
    public static final RegistryEntrySupplier<Spell> EXPANDING_QUAD_LIGHT = registerSpell("expanding_quad_light", () -> new ExpandingLight(4), new SpellProperties.Builder(30, 40).withXPGain(EnumSkills.LIGHT, 10).affectedSkill(EnumSkills.LIGHT));
    ...
    public static final RegistryEntrySupplier<Spell> WATER_SWIPE = registerSpell("water_swipe", WaterLaserSwipe::new, new SpellProperties.Builder(10, 0).withXPGain(EnumSkills.WATER, 5));
    public static final RegistryEntrySupplier<Spell> FIRE_WALL = registerSpell("fire_wall", FireWallSpell::new, new SpellProperties.Builder(10, 0).withXPGain(EnumSkills.FIRE, 5));
    public static final RegistryEntrySupplier<Spell> ICE_BALL_DROP = registerSpell("ice_ball_drop", IceBallDropSpell::new, new SpellProperties.Builder(10, 0).withXPGain(EnumSkills.WATER, 5));
    public static final RegistryEntrySupplier<Spell> ICE_TRAIL = registerSpell("ice_trail", () -> new IceTrailSpell(true), new SpellProperties.Builder(10, 0).withXPGain(EnumSkills.WATER, 5));
    public static final RegistryEntrySupplier<Spell> FIRE_CIRCLE = registerSpell("fire_circle", () -> new ElementalCircleSpell(EnumElement.FIRE), new SpellProperties.Builder(10, 0).withXPGain(EnumSkills.FIRE, 5));
    public static final RegistryEntrySupplier<Spell> WIND_CIRCLE = registerSpell("wind_circle", () -> new ElementalCircleSpell(EnumElement.WIND), new SpellProperties.Builder(10, 0).withXPGain(EnumSkills.WIND, 5));
    public static final RegistryEntrySupplier<Spell> ICE_CIRCLE = registerSpell("ice_circle", () -> new ElementalCircleSpell(EnumElement.WATER), new SpellProperties.Builder(10, 0).withXPGain(EnumSkills.WATER, 5));
    public static final RegistryEntrySupplier<Spell> EARTH_CIRCLE = registerSpell("earth_circle", () -> new ElementalCircleSpell(EnumElement.EARTH), new SpellProperties.Builder(10, 0).withXPGain(EnumSkills.EARTH, 5));
    public static final RegistryEntrySupplier<Spell> PRISM_LONG = registerSpell("prism_long", () -> new PrismSpell(true), new SpellProperties.Builder(20, 24).withXPGain(EnumSkills.LIGHT, 10).affectedSkill(EnumSkills.LIGHT));
    ...
    public static final RegistryEntrySupplier<Spell> MISSILE_2X = registerSpell("missile_2x", () -> new MissileSpell(2), new SpellProperties.Builder(25, 75).withXPGain(EnumSkills.LIGHT, 5).affectedSkill(EnumSkills.LIGHT));
    public static final RegistryEntrySupplier<Spell> MISSILE_8X = registerSpell("missile_8x", () -> new MissileSpell(8), new SpellProperties.Builder(25, 75).withXPGain(EnumSkills.LIGHT, 5).affectedSkill(EnumSkills.LIGHT));
    public static final RegistryEntrySupplier<Spell> STARFALL = registerSpell("starfall", () -> new StarFallSpell(false), new SpellProperties.Builder(25, 75).withXPGain(EnumSkills.LIGHT, 5).affectedSkill(EnumSkills.LIGHT));
    public static final RegistryEntrySupplier<Spell> STARFALL_LONG = registerSpell("starfall_long", () -> new StarFallSpell(true), new SpellProperties.Builder(25, 75).withXPGain(EnumSkills.LIGHT, 5).affectedSkill(EnumSkills.LIGHT));
