...
public class ModelSarcophagus<T extends EntitySarcophagus> extends EntityModel<T> implements ExtendedModel, RideableModel<T> {
    ...
    public static final ModelLayerLocation LAYER_LOCATION = new ModelLayerLocation(RuneCraftory.modRes("sarcophagus"), "main");
    ...
    public ModelSarcophagus(ModelPart root) {
        ...
        this.anim = AnimationManager.getInstance().getAnimation(RuneCraftory.modRes("sarcophagus"));
