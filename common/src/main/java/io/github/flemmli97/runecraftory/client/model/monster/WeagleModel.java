...
public class WeagleModel<T extends Weagle> extends ExtendedEntityModel<T> implements RideableModel<T> {

    public static final ResourceLocation LOCATION = RuneCraftory.modRes("entity/weagle");
    ...
    public void setupAnim(T entity, float limbSwing, float limbSwingAmount, float ageInTicks, float netHeadYaw, float headPitch) {
        ...
        if (entity.deathTime <= 0 && !entity.playDeath() && !entity.getAnimationHandler().isCurrent(Weagle.SLEEP)) {
            ...
            this.animation.get().doAnimation(this, "fly", entity.tickCount, partialTick, entity.interpolatedMoveTick(partialTick));
        }
