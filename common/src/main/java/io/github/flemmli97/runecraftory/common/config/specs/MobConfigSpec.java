...
public class MobConfigSpec {
    ...
    public static final Pair<MobConfigSpec, ModConfigSpec> SPEC = new ModConfigSpec.Builder().configure(MobConfigSpec::new);

    public final ModConfigSpec.BooleanValue disableNaturalSpawn;
    public final ModConfigSpec.IntValue farmRadius;
    public final ModConfigSpec.BooleanValue mobAttackNPC;
    public final ModConfigSpec.BooleanValue vanillaGiveXp;
    public final ModConfigSpec.BooleanValue monsterNeedBarn;

    public final ModConfigSpec.IntValue bellRadius;
    public final ModConfigSpec.DoubleValue gateHealth;
    public final ModConfigSpec.DoubleValue gateDef;
    public final ModConfigSpec.DoubleValue gateMDef;
    public final ModConfigSpec.DoubleValue gateHealthGain;
    public final ModConfigSpec.DoubleValue gateDefGain;
    public final ModConfigSpec.DoubleValue gateMDefGain;
    public final ModConfigSpec.IntValue gateXP;
    public final ModConfigSpec.IntValue gateMoney;
    public final ModConfigSpec.IntValue minSpawnDelay;
    public final ModConfigSpec.IntValue maxSpawnDelay;
    public final ModConfigSpec.DoubleValue minDist;
    public final ModConfigSpec.IntValue maxGroup;
    public final ModConfigSpec.IntValue minNearby;
    public final ModConfigSpec.IntValue maxNearby;
    public final ModConfigSpec.IntValue baseGateLevel;
    public final ModConfigSpec.EnumValue<MobConfig.GateLevelType> gateLevelType;
    public final ModConfigSpec.ConfigValue<List<String>> levelZones;
    public final ModConfigSpec.EnumValue<MobConfig.PlayerLevelType> playerLevelType;
    public final ModConfigSpec.DoubleValue treasureChance;
    public final ModConfigSpec.DoubleValue mimicChance;
    public final ModConfigSpec.DoubleValue mimicStrongChance;

    public final ModConfigSpec.IntValue npcSpawnRateMin;
    public final ModConfigSpec.IntValue npcSpawnRateMax;
    public final ModConfigSpec.IntValue initialProcreationCooldown;
    public final ModConfigSpec.IntValue procreationCooldown;

    public MobConfigSpec(ModConfigSpec.Builder builder) {
