...
public class BlitzSpell extends WeaponSpell {
    ...
    public BlitzSpell() {
        super(RuneCraftoryAttackActions.BLITZ, RunecraftoryTags.Items.DUALBLADES);
    }
    ...
    public boolean use(ServerLevel level, LivingEntity entity, ItemStack stack, float rpUseMultiplier, int amount, int lvl) {
        ...
        if (result) {
            entity.addEffect(new MobEffectInstance(RuneCraftoryEffects.BLITZ.asHolder(), 450 + 30 * lvl, 0));
