...
public class LibEntities {
    ...
    public static final ResourceLocation gate = new ResourceLocation(RuneCraftory.MODID, "gate");
    ...
    public static final ResourceLocation buffamoo = new ResourceLocation(RuneCraftory.MODID, "buffamoo");
    ...
    public static final ResourceLocation stone = new ResourceLocation(RuneCraftory.MODID, "stone");
