...
public class StaffData {
    ...
    public Spell getTier1Spell(ItemStack stack) {
        return this.tier1 != null ? this.tier1 : DataPackHandler.itemStatManager().get(stack.getItem()).map(ItemStat::getTier1Spell).orElse(null);
    }
    ...
    public Spell getTier2Spell(ItemStack stack) {
        return this.tier2 != null ? this.tier2 : DataPackHandler.itemStatManager().get(stack.getItem()).map(ItemStat::getTier2Spell).orElse(null);
    }
    ...
    public Spell getTier3Spell(ItemStack stack) {
        return this.tier3 != null ? this.tier3 : DataPackHandler.itemStatManager().get(stack.getItem()).map(ItemStat::getTier3Spell).orElse(null);
    }
