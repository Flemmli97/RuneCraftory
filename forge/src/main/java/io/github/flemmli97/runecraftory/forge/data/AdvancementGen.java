...
public class AdvancementGen implements DataProvider {
    ...
    public List<Consumer<Consumer<Advancement>>> advancements() {
        Consumer<Consumer<Advancement>> c = cons -> {
            Advancement root = Advancement.Builder.advancement().display(ModItems.medicinalHerb.get(), new TranslatableComponent("runecraftory.advancements.root.title"), new TranslatableComponent("runecraftory.advancements.root.description"), new ResourceLocation("textures/block/dirt.png"), FrameType.TASK, false, false, false).addCriterion("crafting_table", InventoryChangeTrigger.TriggerInstance.hasItems(Blocks.CRAFTING_TABLE)).save(cons, id("root"));
            ...
            Advancement shipping = Advancement.Builder.advancement().parent(root).display(ModItems.shippingBin.get(), new TranslatableComponent("runecraftory.advancements.shipping.title"), new TranslatableComponent("runecraftory.advancements.shipping.description"), null, FrameType.GOAL, true, true, false).addCriterion("ship_item", ShippingTrigger.TriggerInstance.shipAny()).save(cons, id("shipping"));
            ...
            Advancement upgradeItem = Advancement.Builder.advancement().parent(root).display(ModItems.cheapBracelet.get(), new TranslatableComponent("runecraftory.advancements.upgrade.title"), new TranslatableComponent("runecraftory.advancements.upgrade.description"), null, FrameType.TASK, true, true, false).addCriterion("upgrade", SimpleTrigger.TriggerInstance.of(ModCriteria.UPGRADE_ITEM)).save(cons, id("upgrade"));
            Advancement changeElement = Advancement.Builder.advancement().parent(upgradeItem).display(ModItems.crystalLove.get(), new TranslatableComponent("runecraftory.advancements.change.element.title"), new TranslatableComponent("runecraftory.advancements.change.element.description"), null, FrameType.TASK, true, true, false).addCriterion("element", SimpleTrigger.TriggerInstance.of(ModCriteria.CHANGE_ELEMENT)).save(cons, id("change_element"));
            Advancement spell = Advancement.Builder.advancement().parent(upgradeItem).display(ModItems.fireBallSmall.get(), new TranslatableComponent("runecraftory.advancements.spell.title"), new TranslatableComponent("runecraftory.advancements.spell.description"), null, FrameType.TASK, true, true, false).addCriterion("spell", InventoryChangeTrigger.TriggerInstance.hasItems(ItemPredicate.Builder.item().of(ModTags.SPELLS).build())).save(cons, id("spell"));
            ...
            Advancement fertilizer = Advancement.Builder.advancement().parent(root).display(ModItems.formularA.get(), new TranslatableComponent("runecraftory.advancements.fertilizer.title"), new TranslatableComponent("runecraftory.advancements.fertilizer.description"), null, FrameType.TASK, true, true, false).addCriterion("fertilizer", SimpleTrigger.TriggerInstance.of(ModCriteria.FERTILIZE_FARM)).save(cons, id("fertilizer"));
            Advancement helper = Advancement.Builder.advancement().parent(fertilizer).display(ModItems.inspector.get(), new TranslatableComponent("runecraftory.advancements.monster.help.title"), new TranslatableComponent("runecraftory.advancements.monster.help.description"), null, FrameType.TASK, true, true, false).addCriterion("farming", SimpleTrigger.TriggerInstance.of(ModCriteria.COMMAND_FARMING)).save(cons, id("monster_help"));
            Advancement hightTierTool = Advancement.Builder.advancement().parent(helper).display(ModItems.wateringCanPlatinum.get(), new TranslatableComponent("runecraftory.advancements.final.tool.title"), new TranslatableComponent("runecraftory.advancements.final.tool.description"), null, FrameType.CHALLENGE, true, true, false).addCriterion("final_tool", InventoryChangeTrigger.TriggerInstance.hasItems(ItemPredicate.Builder.item().of(ModTags.HIGH_TIER_TOOLS).build())).save(cons, id("final_tool"));
        };
        return List.of(c);
    }
