...
public class AdvancementGen implements DataProvider {
    ...
    public List<Consumer<Consumer<Advancement>>> advancements() {
        Consumer<Consumer<Advancement>> c = cons -> {
            ...
            Advancement helper = Advancement.Builder.advancement().parent(fertilizer).display(ModItems.mobStaff.get(), new TranslatableComponent("runecraftory.advancements.monster.help.title"), new TranslatableComponent("runecraftory.advancements.monster.help.description"), null, FrameType.TASK, true, true, false).addCriterion("farming", SimpleTrigger.TriggerInstance.of(ModCriteria.COMMAND_FARMING)).save(cons, id("monster_help"));
