...
public class FoodGen extends FoodProvider {
    ...
    @Override
    protected void add() {
        this.addStat("fish", Items.COD, new FoodProperties.MutableFoodProps(600).setHPRegen(1, 0).setRPRegen(2, 0));
        this.addStat("salmon", Items.SALMON, new FoodProperties.MutableFoodProps(600).setHPRegen(1, 0).setRPRegen(2, 0));
        this.addStat("sweet_berry", Items.SWEET_BERRIES, new FoodProperties.MutableFoodProps(600).setHPRegen(1, 0).setRPRegen(2, 0));
        this.addStat("cookie", Items.COOKIE, new FoodProperties.MutableFoodProps(600).setHPRegen(1, 0).setRPRegen(7, 0));
        this.addStat("honey_bottle", Items.HONEY_BOTTLE, new FoodProperties.MutableFoodProps(600).setHPRegen(1, 0).setRPRegen(4, 1));
        this.addStat("apple", Items.APPLE, new FoodProperties.MutableFoodProps(600).setHPRegen(1, 0).setRPRegen(3, 0));

        this.addStat("chorus_fruit", Items.CHORUS_FRUIT, new FoodProperties.MutableFoodProps(600).setHPRegen(1, 0).setRPRegen(2, 0));
        this.addStat("kelp", Items.DRIED_KELP, new FoodProperties.MutableFoodProps(600).setHPRegen(1, 0).setRPRegen(3, 0));
        this.addStat("melon", Items.MELON_SLICE, new FoodProperties.MutableFoodProps(600).setHPRegen(1, 0).setRPRegen(1, 0));
        this.addStat("potato", Items.POTATO, new FoodProperties.MutableFoodProps(600).setHPRegen(1, 0).setRPRegen(2, 0));
        this.addStat("carrot", Items.CARROT, new FoodProperties.MutableFoodProps(600).setHPRegen(1, 0).setRPRegen(2, 0));
