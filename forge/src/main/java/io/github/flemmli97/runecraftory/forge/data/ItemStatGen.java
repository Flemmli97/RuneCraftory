...
public class ItemStatGen extends ItemStatProvider {
    ...
    protected void add() {
        ...
        this.addStat(ModItems.powerWave.get(), new ItemStat.Builder(1000, 50, 0));
        this.addStat(ModItems.dashSlash.get(), new ItemStat.Builder(2000, 100, 0));
        this.addStat(ModItems.rushAttack.get(), new ItemStat.Builder(3500, 175, 0));
        this.addStat(ModItems.roundBreak.get(), new ItemStat.Builder(6500, 325, 0));
        this.addStat(ModItems.mindThrust.get(), new ItemStat.Builder(2500, 125, 0));
        ...
        this.addStat(ModItems.twinAttack.get(), new ItemStat.Builder(1500, 75, 0));
        this.addStat(ModItems.railStrike.get(), new ItemStat.Builder(4700, 235, 0));
        this.addStat(ModItems.windSlash.get(), new ItemStat.Builder(3500, 175, 0));
        this.addStat(ModItems.flashStrike.get(), new ItemStat.Builder(10000, 500, 0));
        this.addStat(ModItems.naiveBlade.get(), new ItemStat.Builder(6000, 300, 0));
        this.addStat(ModItems.steelHeart.get(), new ItemStat.Builder(4000, 200, 0));
        this.addStat(ModItems.deltaStrike.get(), new ItemStat.Builder(1500, 75, 0));
        this.addStat(ModItems.hurricane.get(), new ItemStat.Builder(2000, 200, 0));
        this.addStat(ModItems.reaperSlash.get(), new ItemStat.Builder(2500, 125, 0));
        this.addStat(ModItems.millionStrike.get(), new ItemStat.Builder(9000, 450, 0));
        this.addStat(ModItems.axelDisaster.get(), new ItemStat.Builder(5000, 250, 0));
        this.addStat(ModItems.stardustUpper.get(), new ItemStat.Builder(1800, 90, 0));
        this.addStat(ModItems.tornadoSwing.get(), new ItemStat.Builder(3500, 175, 0));
        this.addStat(ModItems.grandImpact.get(), new ItemStat.Builder(6000, 300, 0));
        this.addStat(ModItems.gigaSwing.get(), new ItemStat.Builder(9500, 475, 0));
        this.addStat(ModItems.upperCut.get(), new ItemStat.Builder(2500, 125, 0));
        this.addStat(ModItems.doubleKick.get(), new ItemStat.Builder(8000, 400, 0));
        this.addStat(ModItems.straightPunch.get(), new ItemStat.Builder(8500, 425, 0));
        this.addStat(ModItems.nekoDamashi.get(), new ItemStat.Builder(5500, 275, 0));
        this.addStat(ModItems.rushPunch.get(), new ItemStat.Builder(7000, 350, 0));
        this.addStat(ModItems.cyclone.get(), new ItemStat.Builder(13000, 650, 0));
        this.addStat(ModItems.rapidMove.get(), new ItemStat.Builder(4000, 200, 0));
        this.addStat(ModItems.bonusConcerto.get(), new ItemStat.Builder(3000, 150, 0));
        this.addStat(ModItems.strikingMarch.get(), new ItemStat.Builder(8500, 425, 0));
        this.addStat(ModItems.ironWaltz.get(), new ItemStat.Builder(8500, 425, 0));
