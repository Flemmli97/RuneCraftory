...
public class ItemStatGen extends ItemStatProvider {
    ...
    protected void add() {
        ...
        this.addStat(ModItems.inspector.get(), new ItemStat.MutableItemStat(1500, 300, 0));
        this.addStat(ModItems.brush.get(), new ItemStat.MutableItemStat(1500, 300, 0));
        this.addStat(ModItems.glass.get(), new ItemStat.MutableItemStat(2000, 400, 1));
        ...
        this.addStat(ModItems.turnipSeeds.get(), new ItemStat.MutableItemStat(100, 10, 0));
        this.addStat(ModItems.turnipPinkSeeds.get(), new ItemStat.MutableItemStat(140, 14, 0));
        this.addStat(ModItems.cabbageSeeds.get(), new ItemStat.MutableItemStat(500, 50, 0));
        this.addStat(ModItems.pinkMelonSeeds.get(), new ItemStat.MutableItemStat(1000, 100, 0));
        this.addStat(ModItems.hotHotSeeds.get(), new ItemStat.MutableItemStat(750, 75, 0));
        this.addStat(ModItems.goldTurnipSeeds.get(), new ItemStat.MutableItemStat(5000, 500, 0));
        this.addStat(ModItems.goldPotatoSeeds.get(), new ItemStat.MutableItemStat(3000, 300, 0));
        this.addStat(ModItems.goldPumpkinSeeds.get(), new ItemStat.MutableItemStat(3500, 3500, 0));
        this.addStat(ModItems.goldCabbageSeeds.get(), new ItemStat.MutableItemStat(2500, 250, 0));
        this.addStat(ModItems.bokChoySeeds.get(), new ItemStat.MutableItemStat(600, 60, 0));
        this.addStat(ModItems.leekSeeds.get(), new ItemStat.MutableItemStat(450, 45, 0));
        this.addStat(ModItems.radishSeeds.get(), new ItemStat.MutableItemStat(660, 66, 0));
        this.addStat(ModItems.greenPepperSeeds.get(), new ItemStat.MutableItemStat(400, 40, 0));
        this.addStat(ModItems.spinachSeeds.get(), new ItemStat.MutableItemStat(120, 12, 0));
        this.addStat(ModItems.yamSeeds.get(), new ItemStat.MutableItemStat(250, 25, 0));
        this.addStat(ModItems.eggplantSeeds.get(), new ItemStat.MutableItemStat(700, 70, 0));
        this.addStat(ModItems.pineappleSeeds.get(), new ItemStat.MutableItemStat(1300, 130, 0));
        this.addStat(ModItems.pumpkinSeeds.get(), new ItemStat.MutableItemStat(800, 80, 0));
        this.addStat(ModItems.onionSeeds.get(), new ItemStat.MutableItemStat(900, 90, 0));
        this.addStat(ModItems.cornSeeds.get(), new ItemStat.MutableItemStat(830, 83, 0));
        this.addStat(ModItems.tomatoSeeds.get(), new ItemStat.MutableItemStat(990, 99, 0));
        this.addStat(ModItems.strawberrySeeds.get(), new ItemStat.MutableItemStat(330, 33, 0));
        this.addStat(ModItems.cucumberSeeds.get(), new ItemStat.MutableItemStat(230, 23, 0));
        this.addStat(ModItems.fodderSeeds.get(), new ItemStat.MutableItemStat(50, 5, 0));

        this.addStat(ModItems.fodder.get(), new ItemStat.MutableItemStat(250, 35, 0));

        this.addStat(ModItems.turnip.get(), new ItemStat.MutableItemStat(230, 60, 1));
        this.addStat(ModItems.turnipGiant.get(), new ItemStat.MutableItemStat(0, 250, 20));
        this.addStat(ModItems.turnipPink.get(), new ItemStat.MutableItemStat(320, 130, 5));
        this.addStat(ModItems.turnipPinkGiant.get(), new ItemStat.MutableItemStat(0, 460, 23));
        this.addStat(ModItems.cabbage.get(), new ItemStat.MutableItemStat(1200, 330, 14));
        this.addStat(ModItems.cabbageGiant.get(), new ItemStat.MutableItemStat(0, 780, 31));
        this.addStat(ModItems.pinkMelon.get(), new ItemStat.MutableItemStat(3300, 660, 19));
        this.addStat(ModItems.pinkMelonGiant.get(), new ItemStat.MutableItemStat(0, 1850, 29));
        this.addStat(ModItems.pineapple.get(), new ItemStat.MutableItemStat(7500, 2360, 53));
        this.addStat(ModItems.pineappleGiant.get(), new ItemStat.MutableItemStat(0, 6500, 76));
        this.addStat(ModItems.strawberry.get(), new ItemStat.MutableItemStat(1300, 370, 30));
        this.addStat(ModItems.strawberryGiant.get(), new ItemStat.MutableItemStat(0, 900, 45));
        this.addStat(ModItems.goldenTurnip.get(), new ItemStat.MutableItemStat(50000, 15000, 88));
        this.addStat(ModItems.goldenTurnipGiant.get(), new ItemStat.MutableItemStat(0, 45000, 95));
        this.addStat(ModItems.goldenPotato.get(), new ItemStat.MutableItemStat(30000, 12500, 86));
        this.addStat(ModItems.goldenPotatoGiant.get(), new ItemStat.MutableItemStat(0, 30000, 90));
        this.addStat(ModItems.goldenPumpkin.get(), new ItemStat.MutableItemStat(25000, 10000, 87));
        this.addStat(ModItems.goldenPumpkinGiant.get(), new ItemStat.MutableItemStat(0, 23500, 93));
        this.addStat(ModItems.goldenCabbage.get(), new ItemStat.MutableItemStat(18500, 8000, 83));
        this.addStat(ModItems.goldenCabbageGiant.get(), new ItemStat.MutableItemStat(0, 20000, 89));
        this.addStat(ModItems.hotHotFruit.get(), new ItemStat.MutableItemStat(6000, 1000, 67));
        this.addStat(ModItems.hotHotFruitGiant.get(), new ItemStat.MutableItemStat(0, 2500, 79));
        this.addStat(ModItems.bokChoy.get(), new ItemStat.MutableItemStat(1300, 440, 34));
        this.addStat(ModItems.bokChoyGiant.get(), new ItemStat.MutableItemStat(0, 1100, 50));
        this.addStat(ModItems.leek.get(), new ItemStat.MutableItemStat(2300, 800, 23));
        this.addStat(ModItems.leekGiant.get(), new ItemStat.MutableItemStat(0, 1950, 37));
        this.addStat(ModItems.radish.get(), new ItemStat.MutableItemStat(3500, 1550, 40));
        this.addStat(ModItems.radishGiant.get(), new ItemStat.MutableItemStat(0, 4320, 49));
        this.addStat(ModItems.spinach.get(), new ItemStat.MutableItemStat(450, 120, 17));
        this.addStat(ModItems.spinachGiant.get(), new ItemStat.MutableItemStat(0, 350, 24));
        this.addStat(ModItems.greenPepper.get(), new ItemStat.MutableItemStat(500, 210, 19));
        this.addStat(ModItems.greenPepperGiant.get(), new ItemStat.MutableItemStat(0, 800, 28));
        this.addStat(ModItems.yam.get(), new ItemStat.MutableItemStat(5500, 220, 20));
        this.addStat(ModItems.yamGiant.get(), new ItemStat.MutableItemStat(0, 840, 28));
        this.addStat(ModItems.eggplant.get(), new ItemStat.MutableItemStat(970, 310, 23));
        this.addStat(ModItems.eggplantGiant.get(), new ItemStat.MutableItemStat(0, 850, 38));
        this.addStat(ModItems.tomato.get(), new ItemStat.MutableItemStat(800, 350, 25));
        this.addStat(ModItems.tomatoGiant.get(), new ItemStat.MutableItemStat(0, 1100, 34));
        this.addStat(ModItems.corn.get(), new ItemStat.MutableItemStat(2500, 1000, 37));
        this.addStat(ModItems.cornGiant.get(), new ItemStat.MutableItemStat(0, 2800, 56));
        this.addStat(ModItems.cucumber.get(), new ItemStat.MutableItemStat(350, 130, 12));
        this.addStat(ModItems.cucumberGiant.get(), new ItemStat.MutableItemStat(0, 250, 27));
        ...
        this.addStat(ModItems.onion.get(), new ItemStat.MutableItemStat(1350, 450, 23));
        this.addStat(ModItems.onionGiant.get(), new ItemStat.MutableItemStat(0, 1150, 45));

        this.addStat(Items.CARROT, new ItemStat.MutableItemStat(130, 100, 3));
        this.addStat(Items.POTATO, new ItemStat.MutableItemStat(130, 100, 3));
        this.addStat(ModItems.potatoGiant.get(), new ItemStat.MutableItemStat(0, 450, 19));
        this.addStat(ModItems.carrotGiant.get(), new ItemStat.MutableItemStat(0, 450, 19));

        this.addStat(ModItems.toyherbSeeds.get(), new ItemStat.MutableItemStat(80, 8, 0));
        this.addStat(ModItems.moondropSeeds.get(), new ItemStat.MutableItemStat(190, 19, 0));
        this.addStat(ModItems.pinkCatSeeds.get(), new ItemStat.MutableItemStat(150, 15, 0));
        this.addStat(ModItems.charmBlueSeeds.get(), new ItemStat.MutableItemStat(130, 13, 0));
        this.addStat(ModItems.lampGrassSeeds.get(), new ItemStat.MutableItemStat(550, 55, 0));
        this.addStat(ModItems.cherryGrassSeeds.get(), new ItemStat.MutableItemStat(380, 38, 0));
        this.addStat(ModItems.pomPomGrassSeeds.get(), new ItemStat.MutableItemStat(450, 45, 0));
        this.addStat(ModItems.autumnGrassSeeds.get(), new ItemStat.MutableItemStat(900, 90, 0));
        this.addStat(ModItems.noelGrassSeeds.get(), new ItemStat.MutableItemStat(1700, 170, 0));
        this.addStat(ModItems.fireflowerSeeds.get(), new ItemStat.MutableItemStat(2380, 238, 0));
        this.addStat(ModItems.fourLeafCloverSeeds.get(), new ItemStat.MutableItemStat(770, 77, 0));
        this.addStat(ModItems.ironleafSeeds.get(), new ItemStat.MutableItemStat(660, 66, 0));
        this.addStat(ModItems.whiteCrystalSeeds.get(), new ItemStat.MutableItemStat(25000, 1500, 0));
        this.addStat(ModItems.redCrystalSeeds.get(), new ItemStat.MutableItemStat(25000, 1500, 0));
        this.addStat(ModItems.greenCrystalSeeds.get(), new ItemStat.MutableItemStat(25000, 1500, 0));
        this.addStat(ModItems.blueCrystalSeeds.get(), new ItemStat.MutableItemStat(25000, 1500, 0));
        this.addStat(ModItems.emeryFlowerSeeds.get(), new ItemStat.MutableItemStat(50000, 2000, 0));

        this.addStat(ModItems.toyherb.get(), new ItemStat.MutableItemStat(240, 110, 2));
        this.addStat(ModItems.toyherbGiant.get(), new ItemStat.MutableItemStat(0, 300, 12));
        this.addStat(ModItems.moondropFlower.get(), new ItemStat.MutableItemStat(380, 160, 5));
        this.addStat(ModItems.moondropFlowerGiant.get(), new ItemStat.MutableItemStat(0, 360, 19));
        this.addStat(ModItems.pinkCat.get(), new ItemStat.MutableItemStat(450, 190, 6));
        this.addStat(ModItems.pinkCatGiant.get(), new ItemStat.MutableItemStat(0, 400, 17));
        this.addStat(ModItems.charmBlue.get(), new ItemStat.MutableItemStat(500, 210, 9));
        this.addStat(ModItems.charmBlueGiant.get(), new ItemStat.MutableItemStat(0, 450, 21));
        this.addStat(ModItems.lampGrass.get(), new ItemStat.MutableItemStat(1450, 660, 16));
        this.addStat(ModItems.lampGrassGiant.get(), new ItemStat.MutableItemStat(0, 1300, 34));
        this.addStat(ModItems.cherryGrass.get(), new ItemStat.MutableItemStat(750, 330, 14));
        this.addStat(ModItems.cherryGrassGiant.get(), new ItemStat.MutableItemStat(0, 800, 31));
        this.addStat(ModItems.pomPomGrass.get(), new ItemStat.MutableItemStat(1500, 550, 19));
        this.addStat(ModItems.pomPomGrassGiant.get(), new ItemStat.MutableItemStat(0, 1300, 36));
        this.addStat(ModItems.autumnGrass.get(), new ItemStat.MutableItemStat(3800, 1250, 20));
        this.addStat(ModItems.autumnGrassGiant.get(), new ItemStat.MutableItemStat(0, 2400, 39));
        this.addStat(ModItems.noelGrass.get(), new ItemStat.MutableItemStat(4500, 1550, 28));
        this.addStat(ModItems.noelGrassGiant.get(), new ItemStat.MutableItemStat(0, 3000, 42));
        this.addStat(ModItems.fireflower.get(), new ItemStat.MutableItemStat(4600, 1750, 26));
        this.addStat(ModItems.fireflowerGiant.get(), new ItemStat.MutableItemStat(0, 2800, 48));
        this.addStat(ModItems.fourLeafClover.get(), new ItemStat.MutableItemStat(3330, 1000, 15));
        this.addStat(ModItems.fourLeafCloverGiant.get(), new ItemStat.MutableItemStat(0, 2400, 29));
        this.addStat(ModItems.ironleaf.get(), new ItemStat.MutableItemStat(1500, 980, 23));
        this.addStat(ModItems.ironleafGiant.get(), new ItemStat.MutableItemStat(0, 1600, 48));
        this.addStat(ModItems.whiteCrystal.get(), new ItemStat.MutableItemStat(70000, 23000, 77));
        this.addStat(ModItems.whiteCrystalGiant.get(), new ItemStat.MutableItemStat(0, 85000, 80));
        this.addStat(ModItems.redCrystal.get(), new ItemStat.MutableItemStat(65000, 20000, 69));
        this.addStat(ModItems.redCrystalGiant.get(), new ItemStat.MutableItemStat(0, 68000, 83));
        this.addStat(ModItems.greenCrystal.get(), new ItemStat.MutableItemStat(47500, 16600, 72));
        this.addStat(ModItems.greenCrystalGiant.get(), new ItemStat.MutableItemStat(0, 59000, 84));
        this.addStat(ModItems.blueCrystal.get(), new ItemStat.MutableItemStat(40000, 15000, 74));
        this.addStat(ModItems.blueCrystalGiant.get(), new ItemStat.MutableItemStat(0, 50000, 86));
        this.addStat(ModItems.emeryFlower.get(), new ItemStat.MutableItemStat(500000, 55000, 80));
        this.addStat(ModItems.emeryFlowerGiant.get(), new ItemStat.MutableItemStat(0, 150000, 95));
